...
def build_report() -> dict:
    ...
    return {
        ...
        "title_experiment_board_uri": to_uri(TITLE_EXPERIMENT_BOARD_MD),
...
def write_markdown(report: dict) -> None:
    ...
    lines.append(f"- title experiment board: `{report.get('title_experiment_board_md', '')}`")
...
def write_html(report: dict) -> None:
    ...
    title_experiment_board_uri = html.escape(report.get("title_experiment_board_uri", ""))
    ...
    <section class="content-grid">
      <div class="panel">
        ...
        <div class="link-row">
          ...
          <a class="main-link" href="{title_experiment_board_uri}" target="_blank" rel="noreferrer"><strong>Title Experiment Board</strong>검색 클릭률을 높이기 위한 제목 A/B 후보 보드</a>
