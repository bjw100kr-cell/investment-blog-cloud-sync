...
- generated_at: `2026-08-27T08:40:57.090764+00:00`
...
- search_intent_angle: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (5개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (mixed), 실제 급상승 검색어 반영 (fidelity bitcoin etf)
- pattern_must_have:
  - 무슨 일이 있었는지 1문단 요약
  - 왜 시장이 반응하는지 해석
  - 주식, 달러, 금리, 코인 중 최소 2개와 연결
...
- search_intent_angle: 복수 소스 교차 확인 가능 (7개), 섹터/세계 흐름 연결 해설 가능
- pattern_must_have:
...
- demand_signal_score: `300`
- trend_queries: fidelity bitcoin etf
- search_intent_angle: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (2개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (mixed), 실제 급상승 검색어 반영 (fidelity bitcoin etf)
- pattern_must_have:
  - 무슨 일이 있었는지 1문단 요약
  - 왜 시장이 반응하는지 해석
  - 주식, 달러, 금리, 코인 중 최소 2개와 연결
