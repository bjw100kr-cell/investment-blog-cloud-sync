...
- followup: `AI 반도체 주식 공급망 정리: 누가 수혜를 보나` / `seo_ai_semiconductors_9` / priority `107.5` / 체류시간과 페이지뷰 확대
- followup: `AI 반도체 주식 ETF·지수·대표 기업 정리` / `seo_ai_semiconductors_10` / priority `104.5` / 광고 노출과 장기 검색 유입 확보
...
- followup: `jobs: 지금 투자자가 확인할 체크포인트 5가지` / `seo_jobs_8` / priority `110.37` / 새 검색 수요를 빠르게 받아내고 내부링크로 기존 핵심 글과 연결
