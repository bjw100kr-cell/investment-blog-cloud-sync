...
- followup: `미국 빅테크 주식 관련 대표 종목 한눈에 보기` / `seo_us_big_tech_6` / priority `118.5` / 섹터형 검색 유입 누적
- followup: `미국 빅테크 주식 공급망 정리: 누가 수혜를 보나` / `seo_us_big_tech_8` / priority `115.5` / 체류시간과 페이지뷰 확대
...
- followup: `cpi: 지금 투자자가 확인할 체크포인트 5가지` / `seo_cpi_10` / priority `108.47` / 새 검색 수요를 빠르게 받아내고 내부링크로 기존 핵심 글과 연결
