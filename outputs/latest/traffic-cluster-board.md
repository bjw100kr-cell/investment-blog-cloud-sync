...
- main_html_path: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/04-달러-강세가-주식과-비트코인에-주는-영향-환율부터-보는-법.html`
- followup: `달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법이 주식과 코인에 미치는 영향` / `seo_dollar_8` / priority `103.5` / 검색 유입 누적과 첫 방문 독자 확보
- followup: `달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법에서 다음으로 봐야 할 체크포인트 5가지` / `seo_dollar_9` / priority `100.5` / 재방문과 내부링크 순환 강화
- followup: `달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법 초보자 가이드: 용어부터 시장 반응까지` / `seo_dollar_10` / priority `97.5` / 광범위한 초보 검색 수요 흡수
