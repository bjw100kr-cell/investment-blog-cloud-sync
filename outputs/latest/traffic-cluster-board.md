...
- followup: `미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유 초보자 가이드: 용어부터 시장 반응까지` / `seo_treasury_yields_3` / priority `123.5` / 광범위한 초보 검색 수요 흡수

## 2. 코인 해설 클러스터

- source_keyword: `bitcoin`
- revenue_priority_rank: `3`
- cluster_priority_score: `119.0`
...
- followup: `중국 변수와 시장 영향 관련 대표 종목 한눈에 보기` / `seo_china_9` / priority `102.5` / 섹터형 검색 유입 누적
- followup: `중국 변수와 시장 영향 공급망 정리: 누가 수혜를 보나` / `seo_china_11` / priority `99.5` / 체류시간과 페이지뷰 확대
- followup: `중국 변수와 시장 영향 ETF·지수·대표 기업 정리` / `seo_china_13` / priority `96.5` / 광고 노출과 장기 검색 유입 확보

## 4. 미국 빅테크 허브 클러스터

- source_keyword: `us_big_tech`
- revenue_priority_rank: `99`
- cluster_priority_score: `203.5`
...
- followup: `미국 빅테크 주식 관련 대표 종목 한눈에 보기` / `seo_us_big_tech_10` / priority `101.5` / 섹터형 검색 유입 누적
