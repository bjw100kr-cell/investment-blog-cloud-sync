...
- main_html_path: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/03-ai-성장주를-볼-때-놓치기-쉬운-리스크-매출-성장과-금리-부담.html`
- followup: `AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담 관련 대표 종목 한눈에 보기` / `seo_ai_growth_stocks_7` / priority `111.5` / 섹터형 검색 유입 누적
- followup: `AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담 공급망 정리: 누가 수혜를 보나` / `seo_ai_growth_stocks_9` / priority `108.5` / 체류시간과 페이지뷰 확대
- followup: `AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담 ETF·지수·대표 기업 정리` / `seo_ai_growth_stocks_10` / priority `105.5` / 광고 노출과 장기 검색 유입 확보

## 4. tariffs_trade 클러스터

- source_keyword: `tariffs_trade`
- revenue_priority_rank: `99`
- cluster_priority_score: `277.5`
...
- followup: `관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 관련 대표 종목 한눈에 보기` / `seo_tariffs_trade_11` / priority `71.5` / 섹터형 검색 유입 누적
- followup: `관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 공급망 정리: 누가 수혜를 보나` / `seo_tariffs_trade_12` / priority `68.5` / 체류시간과 페이지뷰 확대
- followup: `관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 ETF·지수·대표 기업 정리` / `seo_tariffs_trade_13` / priority `65.5` / 광고 노출과 장기 검색 유입 확보

## 5. treasury_yields 클러스터

- source_keyword: `treasury_yields`
- revenue_priority_rank: `99`
- cluster_priority_score: `110.6`
- main_title: ``
...
- followup: `미국채 금리 상승 이유: 지금 투자자가 확인할 체크포인트 5가지` / `seo_treasury_yields_8` / priority `110.57` / 새 검색 수요를 빠르게 받아내고 내부링크로 기존 핵심 글과 연결
