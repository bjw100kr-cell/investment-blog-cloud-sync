...
- followup: `관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 관련 대표 종목 한눈에 보기` / `seo_tariffs_trade_12` / priority `92.5` / 섹터형 검색 유입 누적
...
- followup: `ethereum: 지금 투자자가 확인할 체크포인트 5가지` / `seo_ethereum_8` / priority `108.27` / 새 검색 수요를 빠르게 받아내고 내부링크로 기존 핵심 글과 연결
