...
- cluster_priority_score: `509.5`
- main_title: `미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유`
...
- main_html_path: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/01-미국채-금리-상승이-나스닥과-코인에-부담이-되는-이유.html`
- followup: `미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유가 주식과 코인에 미치는 영향` / `seo_treasury_yields_1` / priority `129.5` / 검색 유입 누적과 첫 방문 독자 확보
- followup: `미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유에서 다음으로 봐야 할 체크포인트 5가지` / `seo_treasury_yields_2` / priority `126.5` / 재방문과 내부링크 순환 강화
- followup: `미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유 초보자 가이드: 용어부터 시장 반응까지` / `seo_treasury_yields_4` / priority `123.5` / 광범위한 초보 검색 수요 흡수
...
- followup: `미국 빅테크 주식 관련 대표 종목 한눈에 보기` / `seo_us_big_tech_7` / priority `110.5` / 섹터형 검색 유입 누적
- followup: `미국 빅테크 주식 공급망 정리: 누가 수혜를 보나` / `seo_us_big_tech_9` / priority `107.5` / 체류시간과 페이지뷰 확대

## 4. tariffs_trade 클러스터

- source_keyword: `tariffs_trade`
- revenue_priority_rank: `99`
- cluster_priority_score: `321.5`
...
- followup: `관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 관련 대표 종목 한눈에 보기` / `seo_tariffs_trade_12` / priority `82.5` / 섹터형 검색 유입 누적
- followup: `관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 공급망 정리: 누가 수혜를 보나` / `seo_tariffs_trade_13` / priority `79.5` / 체류시간과 페이지뷰 확대
- followup: `관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 ETF·지수·대표 기업 정리` / `seo_tariffs_trade_14` / priority `76.5` / 광고 노출과 장기 검색 유입 확보

## 5. 거시 이벤트 해설 클러스터

- source_keyword: `fomc`
- revenue_priority_rank: `99`
- cluster_priority_score: `108.9`
- main_title: ``
...
- followup: `FOMC 일정: 지금 투자자가 확인할 체크포인트 5가지` / `seo_fomc_8` / priority `108.87` / 새 검색 수요를 빠르게 받아내고 내부링크로 기존 핵심 글과 연결
