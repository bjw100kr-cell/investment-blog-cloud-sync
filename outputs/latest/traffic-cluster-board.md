...
- followup: `미국 빅테크 주식 관련 대표 종목 한눈에 보기` / `seo_us_big_tech_9` / priority `82.5` / 섹터형 검색 유입 누적

## 5. dollar 클러스터

- source_keyword: `dollar`
- revenue_priority_rank: `99`
- cluster_priority_score: `110.5`
- main_title: ``
...
- followup: `달러 인덱스 보는법: 지금 투자자가 확인할 체크포인트 5가지` / `seo_dollar_7` / priority `110.47` / 새 검색 수요를 빠르게 받아내고 내부링크로 기존 핵심 글과 연결
