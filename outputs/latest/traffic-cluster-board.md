...
- followup: `미국 빅테크 주식 관련 대표 종목 한눈에 보기` / `seo_us_big_tech_7` / priority `90.5` / 섹터형 검색 유입 누적
- followup: `미국 빅테크 주식 공급망 정리: 누가 수혜를 보나` / `seo_us_big_tech_8` / priority `87.5` / 체류시간과 페이지뷰 확대
- followup: `미국 빅테크 주식 ETF·지수·대표 기업 정리` / `seo_us_big_tech_9` / priority `84.5` / 광고 노출과 장기 검색 유입 확보
...
- main_html_path: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/04-미국-증시-지수-흐름-해설.html`
