...
- followup: `미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유가 주식과 코인에 미치는 영향` / `seo_treasury_yields_6` / priority `114.5` / 검색 유입 누적과 첫 방문 독자 확보
...
- followup: `cpi: 지금 투자자가 확인할 체크포인트 5가지` / `seo_cpi_11` / priority `105.67` / 새 검색 수요를 빠르게 받아내고 내부링크로 기존 핵심 글과 연결

## 5. ai_semiconductors 클러스터

- source_keyword: `ai_semiconductors`
- revenue_priority_rank: `99`
- cluster_priority_score: `81.0`
