...
- followup: `AI 반도체 주식 관련 대표 종목 한눈에 보기` / `seo_ai_semiconductors_8` / priority `109.5` / 섹터형 검색 유입 누적

## 3. oil 클러스터

- source_keyword: `oil`
- revenue_priority_rank: `99`
- cluster_priority_score: `332.0`
...
- followup: `국제유가 전망이 주식과 코인에 미치는 영향` / `seo_oil_7` / priority `111.5` / 검색 유입 누적과 첫 방문 독자 확보
- followup: `국제유가 전망에서 다음으로 봐야 할 체크포인트 5가지` / `seo_oil_9` / priority `108.5` / 재방문과 내부링크 순환 강화
