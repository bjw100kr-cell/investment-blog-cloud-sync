...
- followup: `AI 반도체 주식 관련 대표 종목 한눈에 보기` / `seo_ai_semiconductors_9` / priority `92.5` / 섹터형 검색 유입 누적
- followup: `AI 반도체 주식 공급망 정리: 누가 수혜를 보나` / `seo_ai_semiconductors_10` / priority `89.5` / 체류시간과 페이지뷰 확대
- followup: `AI 반도체 주식 ETF·지수·대표 기업 정리` / `seo_ai_semiconductors_12` / priority `86.5` / 광고 노출과 장기 검색 유입 확보
...
- followup: `중국 변수와 시장 영향 공급망 정리: 누가 수혜를 보나` / `seo_china_13` / priority `85.5` / 체류시간과 페이지뷰 확대
- followup: `중국 변수와 시장 영향 ETF·지수·대표 기업 정리` / `seo_china_14` / priority `82.5` / 광고 노출과 장기 검색 유입 확보

## 5. ethereum 클러스터

- source_keyword: `ethereum`
- revenue_priority_rank: `99`
- cluster_priority_score: `110.3`
- main_title: ``
...
- followup: `ethereum: 지금 투자자가 확인할 체크포인트 5가지` / `seo_ethereum_7` / priority `110.27` / 새 검색 수요를 빠르게 받아내고 내부링크로 기존 핵심 글과 연결
...
- next_action: 사용자 검토 후 승인 대기
- blocker: main_quality=unknown
- followup: `cpi: 지금 투자자가 확인할 체크포인트 5가지` / `seo_cpi_8` / priority `108.07` / 새 검색 수요를 빠르게 받아내고 내부링크로 기존 핵심 글과 연결
