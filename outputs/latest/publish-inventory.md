...
- 생성 시각: `2026-08-25T01:38:12.030106+00:00`
- 전체 발행 후보: `11`
- 업로드 가능 글 수: `11`
- 메인 글 수: `4`
- SEO 후속 글 수: `7`
...
- publish_date: 2026-08-26 / bucket: tomorrow
...
## 2. 관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기
...
- ready_to_upload: True
- publish_date: 2026-08-28 / bucket: this_week
...
- ready_to_upload: True
- publish_date: 2026-08-27 / bucket: this_week
...
- ready_to_upload: True
- publish_date: 2026-08-29 / bucket: later
...
- ready_to_upload: True
- publish_date: 2026-08-29 / bucket: seo_backlog
...
## 7. 관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 관련 대표 종목 한눈에 보기
...
- ready_to_upload: True
- publish_date: 2026-08-28 / bucket: seo_backlog
...
## 8. 미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유 초보자 가이드: 용어부터 시장 반응까지
...
## 9. FOMC 일정: 지금 투자자가 확인할 체크포인트 5가지
...
- ready_to_upload: True
- publish_date: 2026-08-25 / bucket: seo_backlog
- priority_score: 110.87
- revenue_objective: 새 검색 수요를 빠르게 받아내고 내부링크로 기존 핵심 글과 연결
- search_intent: `FOMC 일정`를 검색한 독자가 시장 영향과 확인 지표를 빠르게 이해하려는 의도
- cta_focus: 관련 허브, 기존 메인 해설, 다음 체크포인트 글로 연결

## 10. 관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 공급망 정리: 누가 수혜를 보나
...
## 11. 관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 ETF·지수·대표 기업 정리
