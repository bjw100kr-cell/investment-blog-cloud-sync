...
- 생성 시각: `2026-07-31T14:26:49.661737+00:00`
- 전체 발행 후보: `9`
- 업로드 가능 글 수: `9`
- 메인 글 수: `4`
- SEO 후속 글 수: `5`
...
- publish_date: 2026-07-31 / bucket: today_or_overdue
...
- ready_to_upload: True
- publish_date: 2026-08-01 / bucket: tomorrow
- priority_score: 126.0
- revenue_objective: 페이지뷰와 체류시간 균형 확보
- search_intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- cta_focus: ETF·규제·초보 가이드 글로 연결

## 3. CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유
...
- ready_to_upload: True
- publish_date: 2026-08-03 / bucket: this_week
...
- role/type: unplanned / breaking_explainer
- ready_to_upload: True
- publish_date: 미정 / bucket: later
- priority_score: 105.0
- revenue_objective: 페이지뷰와 체류시간 균형 확보
- cta_focus: 실적·공급망·대표 종목 글로 연결

## 5. CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유가 주식과 코인에 미치는 영향
...
## 6. CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유에서 다음으로 봐야 할 체크포인트 5가지
...
## 7. CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유 초보자 가이드: 용어부터 시장 반응까지
...
- ready_to_upload: True
- publish_date: 미정 / bucket: seo_backlog
- priority_score: 104.5
