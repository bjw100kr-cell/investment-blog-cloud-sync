...
- 생성 시각: `2026-08-16T12:53:29.032808+00:00`
- 전체 발행 후보: `8`
- 업로드 가능 글 수: `8`
- 메인 글 수: `4`
- SEO 후속 글 수: `4`

## 1. CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유
...
- publish_date: 2026-08-16 / bucket: today_or_overdue
...
- ready_to_upload: True
- publish_date: 2026-08-17 / bucket: tomorrow
...
- ready_to_upload: True
- publish_date: 2026-08-19 / bucket: this_week
...
- ready_to_upload: True
- publish_date: 2026-08-18 / bucket: this_week
- priority_score: 95.0
- revenue_objective: 페이지뷰와 체류시간 균형 확보
- search_intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- ready_to_upload: True
- publish_date: 2026-08-16 / bucket: seo_backlog
- priority_score: 107.67
...
## 6. CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유가 주식과 코인에 미치는 영향
...
## 7. CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유에서 다음으로 봐야 할 체크포인트 5가지
...
## 8. CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유 초보자 가이드: 용어부터 시장 반응까지
