...
- 생성 시각: `2026-08-26T13:06:37.009721+00:00`
- 전체 발행 후보: `10`
- 업로드 가능 글 수: `10`
- 메인 글 수: `4`
- SEO 후속 글 수: `6`
...
- publish_date: 2026-08-26 / bucket: today_or_overdue
...
- ready_to_upload: True
- publish_date: 2026-08-27 / bucket: tomorrow
...
- ready_to_upload: True
- publish_date: 2026-08-29 / bucket: this_week
- priority_score: 66.0
- revenue_objective: 페이지뷰와 체류시간 균형 확보
- search_intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- cta_focus: 실적·공급망·대표 종목 글로 연결

## 5. pce: 지금 투자자가 확인할 체크포인트 5가지
...
- search_intent: `pce`를 검색한 독자가 시장 영향과 확인 지표를 빠르게 이해하려는 의도
