...
- 생성 시각: `2026-08-03T15:08:34.835782+00:00`
- 전체 발행 후보: `7`
- 업로드 가능 글 수: `7`
- 메인 글 수: `4`
- SEO 후속 글 수: `3`
...
- publish_date: 2026-08-03 / bucket: today_or_overdue
...
- ready_to_upload: True
- publish_date: 2026-08-04 / bucket: tomorrow
- priority_score: 123.0
- revenue_objective: 페이지뷰와 체류시간 균형 확보
- search_intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- cta_focus: ETF·규제·초보 가이드 글로 연결

## 3. 달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법
...
## 5. 달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법이 주식과 코인에 미치는 영향
...
## 6. 달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법에서 다음으로 봐야 할 체크포인트 5가지
...
## 7. 달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법 초보자 가이드: 용어부터 시장 반응까지
