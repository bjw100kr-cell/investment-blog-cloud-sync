...
- 생성 시각: `2026-09-15T16:48:20.626596+00:00`
- 전체 발행 후보: `8`
- 업로드 가능 글 수: `8`
- 메인 글 수: `4`
- SEO 후속 글 수: `4`
...
- publish_date: 2026-09-15 / bucket: today_or_overdue
...
- ready_to_upload: True
- publish_date: 2026-09-16 / bucket: tomorrow
...
- ready_to_upload: True
- publish_date: 2026-09-17 / bucket: this_week
- priority_score: 90.0
- revenue_objective: 페이지뷰와 체류시간 균형 확보
- search_intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- ready_to_upload: True
- publish_date: 2026-09-18 / bucket: seo_backlog
- priority_score: 73.5
