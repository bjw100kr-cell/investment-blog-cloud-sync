...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Coldcard Bitcoin loss estimate rises to $70M after Galaxy analysis
...
- freshness: `aging` / newest evidence age `2.8` days
