...
- freshness: `stale` / newest evidence age `13.6` days
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Live markets: Bitcoin trades above $65,000 as Alphabet's bigger AI bill props up the chip trade
