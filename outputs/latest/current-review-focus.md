...
- freshness: `stale` / newest evidence age `10.6` days
...
- sources: Federal Reserve Monetary Policy Press, MarketWatch Breaking News, Reuters Markets via Google News RSS
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Trader maintains $67K BTC price target: Five things to know in Bitcoin this week
