...
- freshness: `stale` / newest evidence age `8.4` days
...
- sources: Federal Reserve Monetary Policy Press, Financial Times Home
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: MARA swings to Q2 loss as Bitcoin’s slump masks higher output
