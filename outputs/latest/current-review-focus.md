...
- freshness: `stale` / newest evidence age `20.3` days
...
- demand_signal_score: `7400`
- freshness: `fresh` / newest evidence age `0.2` days
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Bitcoin has gone quiet as traders chase ‘5x or 10x’ payoffs elsewhere
