...
- freshness: `stale` / newest evidence age `16.4` days
...
- sources: Federal Reserve Monetary Policy Press, Financial Times Home, Reuters Markets via Google News RSS
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Bitcoin advocacy group to join US State Department’s ‘digital freedom’ program
