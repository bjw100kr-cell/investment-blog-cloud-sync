...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: We are so back! Bitcoin’s 23% rally on US debt policy: Hodler’s Digest
- freshness_recommendation: 사용자 검토만 통과하면 바로 게시 후보로 유지해도 됩니다.
- sources: CoinDesk RSS, Cointelegraph, Google Trends KR
...
- freshness: `aging` / newest evidence age `4.3` days
