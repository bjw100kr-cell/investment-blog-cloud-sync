...
- freshness: `stale` / newest evidence age `17.3` days
...
- sources: Federal Reserve Monetary Policy Press, Reuters Markets via Google News RSS
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Swiss mega-bank UBS ramps up its Bitcoin exposure with a massive 24-fold surge in ETF call options
