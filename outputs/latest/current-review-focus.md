...
- freshness: `stale` / newest evidence age `8.2` days
...
- sources: CNBC Top News, Federal Reserve Monetary Policy Press, Reuters Markets via Google News RSS
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Grayscale says Zcash can challenge Bitcoin’s network effects as privacy demand grows
