...
- freshness: `stale` / newest evidence age `9.3` days
...
- sources: CNBC Top News, Cointelegraph, Federal Reserve Monetary Policy Press
...
- demand_signal_score: `6100`
- freshness: `fresh` / newest evidence age `0.2` days
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Trump-Backed American Bitcoin director Justin Mateen buys nearly $2 million of ABTC stock
- freshness_recommendation: 신선도는 괜찮습니다. 이미지나 품질 게이트만 보완하면 됩니다.
- sources: CoinDesk RSS, Cointelegraph, Financial Times Home
- advisory_checks: crypto_market_signal_present, canonical_url_present, newsletter_ready, ga4_ready
