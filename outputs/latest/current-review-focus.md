...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: BIP-110 Bitcoin branch stalls after two blocks as gap widens
...
- evidence: Investing.com Crypto News / 2026-08-09 08:51:48 / Bitcoin slips below $65,000 as ETF inflows offset fork concerns
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: The number of stocks beating the S&P 500 is the highest in 4 years. Why that number should rise.
- freshness_recommendation: 사용자 검토만 통과하면 바로 게시 후보로 유지해도 됩니다.
- sources: CNBC Top News, MarketWatch Breaking News, Reuters Markets via Google News RSS
- advisory_checks: canonical_url_present, newsletter_ready, ga4_ready
- next_action: 사용자 최종 확인 후 Blogger draft 업로드
...
- evidence: MarketWatch Breaking News / 2026-08-09T13:00:00+00:00 / The number of stocks beating the S&P 500 is the highest in 4 years. Why that number should rise.
