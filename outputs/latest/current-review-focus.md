...
- freshness: `aging` / newest evidence age `2.4` days
...
- sources: CNBC Top News, Federal Reserve Monetary Policy Press, Financial Times Home
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Bitcoin holds monthly gain, faces 'choppy' August as 'forced-selling' exhausted, analysts say
