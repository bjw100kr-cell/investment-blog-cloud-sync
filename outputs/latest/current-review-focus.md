...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Bitcoin hits an 8-month high — and sends a clear message about risk appetite right now
...
- freshness: `stale` / newest evidence age `5.4` days
