...
- 지금 1순위로 읽을 글: `유가 상승이 물가와 증시에 번지는 경로: 투자자가 볼 3가지` / keyword `oil`
...
- freshness: `fresh` / newest evidence age `1.3` days
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Can Kazakhstan’s oil boom survive Putin’s War? | FT Film
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Tim Draper denies moving Bitcoin, reiterates $250,000 BTC prediction
- freshness_recommendation: 사용자 검토만 통과하면 바로 게시 후보로 유지해도 됩니다.
...
- evidence: Cointelegraph / 2026-07-04T05:05:19+00:00 / Bitcoin profit and loss ratio falls to 43-month low
