...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Bitcoin cold-wallet attack spreads to 4,500 addresses as losses near $89 million
...
- freshness: `aging` / newest evidence age `3.4` days
...
- sources: Federal Reserve Monetary Policy Press, Financial Times World, Investing.com Crypto News
- advisory_checks: canonical_url_present, newsletter_ready, ga4_ready
- next_action: 사용자 최종 확인 후 Blogger draft 업로드
