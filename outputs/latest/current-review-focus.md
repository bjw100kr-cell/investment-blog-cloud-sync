...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: First bear-market trend line reclaim since 2025: Five things to know in Bitcoin this week
...
- freshness: `aging` / newest evidence age `4.8` days
...
- sources: Federal Reserve Monetary Policy Press, Financial Times Home, Financial Times World
- advisory_checks: canonical_url_present, newsletter_ready, ga4_ready
- next_action: 사용자 최종 확인 후 Blogger draft 업로드
