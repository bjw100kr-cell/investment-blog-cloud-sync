...
- freshness: `stale` / newest evidence age `23.9` days
...
- sources: CoinDesk RSS, Federal Reserve Monetary Policy Press, Investing.com Crypto News
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Bitcoin activity, passports exposed after Revolut falls for fake government request
