...
- freshness: `stale` / newest evidence age `15.9` days
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: We checked 6 years of bitcoin data. The NFP report isn't big price mover
