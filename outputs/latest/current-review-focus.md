...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Suspected 4th Coldcard attack wave sweeps 389 Bitcoin: Galaxy’s Thorn
...
- freshness: `fresh` / newest evidence age `0.6` days
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: S&P 500 profit growth is getting even wilder as Amazon makes its mark
- freshness_recommendation: 사용자 검토만 통과하면 바로 게시 후보로 유지해도 됩니다.
- sources: CoinDesk RSS, Financial Times World, MarketWatch Breaking News
- advisory_checks: canonical_url_present, newsletter_ready, ga4_ready
- next_action: 사용자 최종 확인 후 Blogger draft 업로드
