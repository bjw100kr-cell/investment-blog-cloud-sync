...
- freshness: `stale` / newest evidence age `11.3` days
...
- sources: Federal Reserve Monetary Policy Press, Investing.com Crypto News, Reuters Markets via Google News RSS
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Bitcoin investors pour $853 million into spot ETFs. BlackRock’s IBIT claims the bulk
