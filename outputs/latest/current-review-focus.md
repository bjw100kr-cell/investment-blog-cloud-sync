...
- freshness: `stale` / newest evidence age `17.4` days
...
- sources: Federal Reserve Monetary Policy Press, Investing.com Crypto News, MarketWatch Breaking News
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Bitcoin OG selling eases as dormant BTC movement hits 4-year low: Galaxy
