...
- freshness: `stale` / newest evidence age `7.4` days
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Bitcoin Red Team reports 5K findings in sweeping security audit
