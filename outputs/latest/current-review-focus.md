...
- freshness: `fresh` / newest evidence age `1.4` days
...
- sources: Cointelegraph, Federal Reserve Monetary Policy Press, Investing.com Crypto News
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Bank of Japan raises interest rates by 25 basis points. Bitcoin tops $77,000
- freshness_recommendation: 사용자 검토만 통과하면 바로 게시 후보로 유지해도 됩니다.
