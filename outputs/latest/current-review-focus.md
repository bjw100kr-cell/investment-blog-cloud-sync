...
- freshness: `stale` / newest evidence age `14.4` days
...
- sources: Federal Reserve Monetary Policy Press, Financial Times Home, Investing.com Crypto News
...
- freshness_summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: Goldman Sachs leaps into bitcoin income ETFs with $2.25 billion NEOS buyout
