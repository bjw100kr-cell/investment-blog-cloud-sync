...
- generated_at: `2026-09-20T04:26:54.363088+00:00`
- snapshot_generated_at: `2026-09-20T04:26:49.737874+00:00`
...
- newest_evidence_age_days: `1.2`
- newest_evidence_iso: `2026-09-19T00:05:00+00:00`
- quality_status: `pass` / ready_now `True`
...
- newest_evidence_iso: `2026-09-19T19:14:38+00:00`
- quality_status: `pass` / ready_now `True`
- summary: 최신 근거가 살아 있어 데일리 해설로 다루기 좋은 상태입니다. 대표 근거: REX launches 2x leveraged ETF tied to Bitcoin treasury firm Strive
- recommendation: 사용자 검토만 통과하면 바로 게시 후보로 유지해도 됩니다.
- recovery_mode: `publish_direct`
- recovery_summary: 현재 신선도가 살아 있어 데일리 해설형으로 바로 검토를 이어가도 됩니다.
