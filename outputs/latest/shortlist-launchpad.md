...
- why_now: 복수 소스 교차 확인 가능 (3개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (extreme_greed)
- sample_headlines:
...
- recent_evidence:
  ...
  - Cointelegraph | 2026-09-22T13:30:00+00:00 | Big Questions: Does Satoshi actually own 1.1 million Bitcoin?
...
- keyword `china` / publish `2026-09-25` / verdict `approve` / quality `pass`
- ready_now: `True` / hero_image_selected: `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  - NYT Business | 2026-09-22T14:15:14+00:00 | Trump and Xi to Discuss A.I. Risks and Competition at US-China Summit
...
- keyword `us_big_tech` / publish `2026-09-24` / verdict `approve` / quality `review_before_publish`
...
- recent_evidence:
  - MarketWatch Breaking News | 2026-09-22T16:24:00+00:00 | Could Meta’s viral Muse app be the company’s ChatGPT moment?
  - Reuters Markets via Google News RSS | 2026-09-22T13:40:59+00:00 | Wall Street expects Meta's AI agent to shape into a new revenue engine - Reuters
