...
- keyword `bitcoin` / publish `2026-08-16` / verdict `approve` / quality `pass`
...
- recent_evidence:
  - Investing.com Crypto News | 2026-08-15 10:12:51 | Bitcoin price holds below $63,000 as selling pressure offsets regulatory progress
  - Investing.com Crypto News | 2026-08-15 07:02:19 | Bitcoin bear flag 80% complete near $62,500: Live levels
...
- keyword `china` / publish `2026-08-18` / verdict `approve` / quality `pass`
- ready_now: `True` / hero_image_selected: `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  - CNBC Top News | 2026-08-15T06:11:11+00:00 | Beijing is said to move to clarify tax rules stoking confusion among China's ultra-wealthy
  - Financial Times Home | 2026-08-15T04:00:32+00:00 | China poised to lift travel ban on Manus founders
...
- keyword `us_big_tech` / publish `2026-08-17` / verdict `approve` / quality `review_before_publish`
