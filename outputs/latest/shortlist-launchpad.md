...
- recent_evidence:
  - CoinDesk RSS | 2026-09-24T15:26:34+00:00 | Bitcoin’s bear markets are getting milder. Bull markets may be next
  - CoinDesk RSS | 2026-09-24T14:49:28+00:00 | Crypto for Advisors:The hidden costs of holding your own bitcoin
  - Investing.com Crypto News | 2026-09-24 13:18:35 | Bitcoin retreats to $83.6k as yields, oil spike spook risk
...
- keyword `ai_semiconductors` / publish `2026-09-26` / verdict `approve` / quality `pass`
- ready_now: `True` / hero_image_selected: `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  - Financial Times YouTube | 63K views | Silicon shadows: inside the black market for AI chips | FT Film
  - CoinDesk RSS | 2026-09-24T13:00:00+00:00 | Cathie Wood's ARK teams with Securitize to tokenize venture fund with OpenAI, Anthropic stakes
...
- keyword `china` / publish `2026-09-27` / verdict `approve` / quality `pass`
- ready_now: `True` / hero_image_selected: `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  - Financial Times Home | 2026-09-24T11:48:36+00:00 | Xi says US-China competition should be ‘healthy’ at White House summit
