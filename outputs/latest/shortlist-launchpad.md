...
- keyword `bitcoin` / publish `2026-09-06` / verdict `approve` / quality `pass`
...
- recent_evidence:
  - Cointelegraph | 2026-09-04T20:30:47+00:00 | Surprise nonfarm payrolls print sends Bitcoin back below 80K
  - Cointelegraph | 2026-09-04T17:22:58+00:00 | Crypto Biz: AI took a back seat when Bitcoin started climbing
  - Cointelegraph | 2026-09-04T17:09:25+00:00 | QuFi launches post-quantum verification platform with Bitcoin testnet proof
...
- keyword `ai_semiconductors` / publish `2026-09-07` / verdict `approve` / quality `pass`
- ready_now: `True` / hero_image_selected: `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  ...
  - MarketWatch Breaking News | 2026-09-04T20:12:00+00:00 | Micron is doubling down on AI memory chips. That could pay off big time for investors.
  - Financial Times Home | 2026-09-04T19:46:21+00:00 | Anthropic close to awarding Morgan Stanley and Goldman top roles in $2tn IPO
...
- keyword `china` / publish `2026-09-08` / verdict `approve` / quality `pass`
- ready_now: `True` / hero_image_selected: `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  - Financial Times World | 2026-09-04T20:00:10+00:00 | Maga’s favourite combat sport takes off in China
