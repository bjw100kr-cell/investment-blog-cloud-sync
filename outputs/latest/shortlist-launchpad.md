...
- keyword `ai_semiconductors` / publish `2026-09-14` / verdict `approve` / quality `review_before_publish`
...
- recent_evidence:
  ...
  - Financial Times Home | 2026-09-11T09:02:54+00:00 | Houthis used Anthropic AI to try to build ballistic missiles
...
- keyword `china` / publish `2026-09-15` / verdict `approve` / quality `review_before_publish`
- ready_now: `False` / hero_image_selected: `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  - 무역킹 Trade King YouTube | 48K views | China Sent a Note and Got Absolutely Roasted
