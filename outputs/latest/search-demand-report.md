...
- `oil`: demand 3800 / trend_count 0 / traffic_sum 0 / regions unknown
  - confidence: `medium_low` / Google Trends 직접 매칭이 아니라 뉴스/소스 빈도 기반 추정입니다.
  - fallback: source snapshot score 26 / sources CNBC Top News, Financial Times Home, Financial Times World, Financial Times YouTube, NYT Business
- `ai_semiconductors`: demand 3400 / trend_count 0 / traffic_sum 0 / regions unknown
  - confidence: `medium_low` / Google Trends 직접 매칭이 아니라 뉴스/소스 빈도 기반 추정입니다.
  - fallback: source snapshot score 22 / sources CNBC Top News, CoinDesk RSS, Financial Times YouTube, Reuters Markets via Google News RSS
