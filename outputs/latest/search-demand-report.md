...
- `ai_semiconductors`: demand 3300 / trend_count 0 / traffic_sum 0 / regions unknown
  - confidence: `medium_low` / Google Trends 직접 매칭이 아니라 뉴스/소스 빈도 기반 추정입니다.
  - fallback: source snapshot score 21 / sources CNBC Top News, Cointelegraph, Financial Times World, Financial Times YouTube, MarketWatch Breaking News
- `treasury_yields`: demand 2100 / trend_count 0 / traffic_sum 0 / regions unknown
  - confidence: `medium_low` / Google Trends 직접 매칭이 아니라 뉴스/소스 빈도 기반 추정입니다.
  - fallback: source snapshot score 9 / sources Cointelegraph, Financial Times Home, Investing.com Crypto News
