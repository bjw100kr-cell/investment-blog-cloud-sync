...
- `bitcoin`: demand 6200 / trend_count 0 / traffic_sum 0 / regions unknown
  ...
  - fallback: source snapshot score 50 / sources CNBC Top News, CoinDesk RSS, Cointelegraph, Investing.com Crypto News
...
- `treasury_yields`: demand 2500 / trend_count 0 / traffic_sum 0 / regions unknown
  - confidence: `medium_low` / Google Trends 직접 매칭이 아니라 뉴스/소스 빈도 기반 추정입니다.
  - fallback: source snapshot score 13 / sources CNBC Top News, CoinDesk RSS, Cointelegraph, Reuters Markets via Google News RSS
