...
```json
{
  ...
  "summary_angle": "검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (4개), 검색량 높은 미국 증시 키워드를 시장 맥락으로 해설 가능, 실제 급상승 검색어 반영 (qqq stock, qqq)",
  "outline": [
    "지금 이 섹터가 왜 움직이는가",
    "핵심 뉴스와 시장 반응",
    "대표 종목과 자금 흐름",
  ...
  "reference_headlines": [
    ...
    "Mapping the Market: Nasdaq selloff breaks key support levels after Fed - Reuters"
  ],
