...
- pick: `CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유가 주식과 코인에 미치는 영향` / `seo_cpi_9` / `followup_pick_1` / ready `True` / 검색형 유입을 받기 좋은 주제
...
- pick: `CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유에서 다음으로 봐야 할 체크포인트 5가지` / `seo_cpi_10` / `followup_pick_2` / ready `True` / 재방문과 내부링크 순환에 유리한 주제
...
- pick: `비트코인 현물 ETF 자금 유입: 지금 투자자가 확인할 체크포인트 5가지` / `seo_crypto_etf_8` / `followup_pick_1` / ready `True` / 검색형 유입을 받기 좋은 주제
