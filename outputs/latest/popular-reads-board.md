...
- pick: `비트코인 핵심 흐름 해설` / `bitcoin` / `main_pick` / ready `True` / 지금 이 클러스터를 대표하는 메인 글
...
- pick: `비트코인 핵심 흐름 초보자 가이드: 지금 꼭 알아야 할 핵심 구조` / `seo_bitcoin_2` / `followup_pick_1` / ready `True` / 검색형 유입을 받기 좋은 주제
...
- pick: `비트코인 핵심 흐름 ETF·규제 이슈 정리` / `seo_bitcoin_4` / `followup_pick_2` / ready `True` / 검색형 유입을 받기 좋은 주제
...
- pick: `FOMC 이후 시장에서 다음으로 봐야 할 체크포인트 5가지` / `seo_fomc_3` / `followup_pick_2` / ready `True` / 재방문과 내부링크 순환에 유리한 주제
...
- pick: `중국 변수와 시장 영향 해설` / `china` / `main_pick` / ready `False` / 지금 이 클러스터를 대표하는 메인 글
