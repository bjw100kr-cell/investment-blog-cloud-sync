...
- pick: `관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 공급망 정리: 누가 수혜를 보나` / `seo_tariffs_trade_8` / `followup_pick_2` / ready `True` / 페이지 체류시간을 늘리기 좋은 주제
...
- cta_focus: 실적·공급망·대표 종목 글로 연결
- next_action: 메인 글 승인 후 후속 SEO 글 내부링크 흐름 준비
- pick: `미국 빅테크 주가가 흔들릴 때 확인할 것: 실적, 금리, AI 투자` / `us_big_tech` / `main_pick` / ready `True` / 지금 이 클러스터를 대표하는 메인 글
...
- pick: `미국 빅테크 주식 관련 대표 종목 한눈에 보기` / `seo_us_big_tech_11` / `followup_pick_1` / ready `True` / 검색형 유입을 받기 좋은 주제
...
- pick: `미국 빅테크 주식 공급망 정리: 누가 수혜를 보나` / `seo_us_big_tech_12` / `followup_pick_2` / ready `True` / 페이지 체류시간을 늘리기 좋은 주제
