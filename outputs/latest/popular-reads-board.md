...
- pick: `AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담 관련 대표 종목 한눈에 보기` / `seo_ai_growth_stocks_10` / `followup_pick_1` / ready `True` / 검색형 유입을 받기 좋은 주제
  - html_path: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/seo-publish-ready/05-ai-성장주를-볼-때-놓치기-쉬운-리스크-매출-성장과-금리-부담-관련-대표-종목-한눈에-보기.html`
- pick: `AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담 공급망 정리: 누가 수혜를 보나` / `seo_ai_growth_stocks_12` / `followup_pick_2` / ready `True` / 페이지 체류시간을 늘리기 좋은 주제
  - html_path: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/seo-publish-ready/06-ai-성장주를-볼-때-놓치기-쉬운-리스크-매출-성장과-금리-부담-공급망-정리-누가-수혜를-보나.html`
