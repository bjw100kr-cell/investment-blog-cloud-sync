...
- pick: `미국 빅테크 주가가 흔들릴 때 확인할 것: 실적, 금리, AI 투자` / `us_big_tech` / `main_pick` / ready `False` / 지금 이 클러스터를 대표하는 메인 글
  - html_path: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/04-미국-빅테크-주가가-흔들릴-때-확인할-것-실적-금리-ai-투자.html`
- pick: `미국 빅테크 주식 관련 대표 종목 한눈에 보기` / `seo_us_big_tech_9` / `followup_pick_1` / ready `False` / 검색형 유입을 받기 좋은 주제
...
- pick: `AI 반도체 주식 관련 대표 종목 한눈에 보기` / `seo_ai_semiconductors_7` / `followup_pick_1` / ready `True` / 검색형 유입을 받기 좋은 주제
...
- pick: `AI 반도체 주식 ETF·지수·대표 기업 정리` / `seo_ai_semiconductors_10` / `followup_pick_2` / ready `True` / 검색형 유입을 받기 좋은 주제
