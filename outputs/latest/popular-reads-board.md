...
- pick: `달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법` / `dollar` / `main_pick` / ready `False` / 지금 이 클러스터를 대표하는 메인 글
...
- pick: `달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법이 주식과 코인에 미치는 영향` / `seo_dollar_8` / `followup_pick_1` / ready `True` / 검색형 유입을 받기 좋은 주제
...
- pick: `달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법에서 다음으로 봐야 할 체크포인트 5가지` / `seo_dollar_9` / `followup_pick_2` / ready `True` / 재방문과 내부링크 순환에 유리한 주제
