...
- batch approval: `python3 /home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/scripts/set_review_approvals.py --keywords bitcoin cpi`
...
- html: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/04-cpi-발표-후-금리와-나스닥-비트코인이-같이-움직이는-이유.html`
- image review required: `True`
- image 대표 이미지: Unsplash / `inflation shopping finance data abstract` / Unsplash License
...
- image 본문 보조 이미지: Pexels / `macro economy market data abstract` / Pexels License
