...
- image review required: `True`
- image 대표 이미지: Unsplash / `technology stocks office city abstract` / Unsplash License
...
- image 본문 보조 이미지: Pexels / `semiconductor server data center abstract` / Pexels License
...
- html: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/04-관세와-무역-갈등이-증시에-미치는-영향-환율과-공급망까지-보기.html`
- image review required: `True`
