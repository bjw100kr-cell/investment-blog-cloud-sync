...
- html: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/02-비트코인-가격보다-먼저-봐야-할-것-etf-자금-달러-규제-체크포인트.html`
...
- html: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/03-미국-증시-지수-흐름-나스닥-금리-빅테크-실적을-같이-봐야-하는-이유.html`
- image review required: `True`
...
- html: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/04-중국-변수와-시장-영향-환율-경기부양-원자재를-같이-봐야-하는-이유.html`
- image review required: `True`
- image 대표 이미지: Unsplash / `technology stocks office finance abstract` / Unsplash License
