...
- lane: `us-stocks`
- current_title: AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담
- recommended_title: AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담: 지금 시장이 반응하는 이유
- recommended_angle: `macro-link`
...
- `ai_growth_stocks-v2` score `77` angle `macro-link`: AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담: 지금 시장이 반응하는 이유
  - why: 뉴스를 이미 본 독자가 시장 반응의 이유를 확인하려는 검색 의도에 맞습니다.
- `ai_growth_stocks-v4` score `77` angle `macro-link`: AI 성장주를 볼 때 놓치기 쉬운 리스크 체크포인트: 금리, 실적, 섹터 폭을 같이 봐야 하는 이유
  - why: 독자가 글에서 얻을 정보를 제목에서 바로 알 수 있습니다.
- `ai_growth_stocks-v3` score `65` angle `risk-check`: AI 성장주를 볼 때 놓치기 쉬운 리스크, 나스닥과 빅테크가 같이 움직이는 이유
  - why: 뉴스를 이미 본 독자가 시장 반응의 이유를 확인하려는 검색 의도에 맞습니다.
- `ai_growth_stocks-v1` score `62` angle `macro-link`: AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담
  - why: 현재 주제를 설명형 검색어로 받아내기 위한 후보입니다.
- `ai_growth_stocks-v5` score `58` angle `risk-check`: AI 성장주를 볼 때 놓치기 쉬운 리스크이 내 주식 계좌에 주는 신호 3가지
  - why: 독자가 글에서 얻을 정보를 제목에서 바로 알 수 있습니다.
