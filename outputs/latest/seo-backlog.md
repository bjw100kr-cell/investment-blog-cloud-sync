...
## 9. CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유가 주식과 코인에 미치는 영향

- 출발 글: cpi / CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유
- 카테고리: macro
- 역할: evergreen_seo / 타입: evergreen_explainer
- 우선순위 점수: 101.5
- 검색 의도: 뉴스를 봤지만 내 투자에 어떻게 연결되는지 쉽게 이해하고 싶은 독자
- 수익화 목표: 검색 유입 누적과 첫 방문 독자 확보
- CTA 초점: 거시 허브와 당일 해설 글로 연결
- 메인 연결 글: /home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/04-cpi-발표-후-금리와-나스닥-비트코인이-같이-움직이는-이유.html
- 보조 내부링크: site-foundation/hub-macro.md, site-foundation/about.md, site-foundation/disclosure.md
- 추천 라벨: 투자, 경제, 시장해설, CPI, 인플레이션, 거시경제

## 10. CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유에서 다음으로 봐야 할 체크포인트 5가지
...
## 11. CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유 초보자 가이드: 용어부터 시장 반응까지
...
## 12. 미국 증시 지수 흐름 관련 대표 종목 한눈에 보기
...
- 메인 연결 글: /home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/03-미국-증시-지수-흐름-해설.html
