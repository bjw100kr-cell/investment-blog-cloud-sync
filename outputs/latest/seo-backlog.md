...
## 1. 비트코인 핵심 흐름 초보자 가이드: 지금 꼭 알아야 할 핵심 구조
...
## 3. 비트코인 핵심 흐름 FAQ 10개: 많이 헷갈리는 질문 정리
...
## 4. 미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유가 주식과 코인에 미치는 영향

- 출발 글: treasury_yields / 미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유
- 카테고리: macro
- 역할: evergreen_seo / 타입: evergreen_explainer
- 우선순위 점수: 117.5
...
- 메인 연결 글: /home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/01-미국채-금리-상승이-나스닥과-코인에-부담이-되는-이유.html
- 보조 내부링크: site-foundation/hub-macro.md, site-foundation/about.md, site-foundation/disclosure.md
- 추천 라벨: 투자, 경제, 시장해설, 미국채금리, 거시경제, 금리

## 5. 미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유에서 다음으로 봐야 할 체크포인트 5가지
...
## 6. 관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 관련 대표 종목 한눈에 보기

- 출발 글: tariffs_trade / 관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기
- 카테고리: global-sector
...
- 메인 연결 글: /home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/04-관세와-무역-갈등이-증시에-미치는-영향-환율과-공급망까지-보기.html
- 보조 내부링크: site-foundation/hub-global-sector.md, site-foundation/about.md, site-foundation/disclosure.md
- 추천 라벨: 투자, 경제, 시장해설, 관세, 무역, 세계흐름
...
- 우선순위 점수: 110.87
- 검색 의도: `FOMC 일정`를 검색한 독자가 시장 영향과 확인 지표를 빠르게 이해하려는 의도
...
## 11. AI 반도체 주식 관련 대표 종목 한눈에 보기

- 출발 글: ai_semiconductors / AI 반도체 주가를 볼 때 실적보다 먼저 확인할 3가지
- 카테고리: global-sector
- 역할: evergreen_seo / 타입: evergreen_sector_guide
- 우선순위 점수: 101.5
- 검색 의도: 섹터 뉴스는 봤지만 실제 어떤 기업을 같이 봐야 하는지 알고 싶은 독자
- 수익화 목표: 섹터형 검색 유입 누적
- CTA 초점: 대표 종목 글과 허브 글 연결
- 메인 연결 글: /home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/03-ai-반도체-주가를-볼-때-실적보다-먼저-확인할-3가지.html
- 보조 내부링크: site-foundation/hub-global-sector.md, site-foundation/about.md, site-foundation/disclosure.md
- 추천 라벨: 투자, 경제, 시장해설, AI, 반도체, 섹터분석

## 12. AI 반도체 주식 공급망 정리: 누가 수혜를 보나
