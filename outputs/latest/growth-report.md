...
- `ai_semiconductors`: AI 반도체 주가를 볼 때 실적보다 먼저 확인할 3가지 / 점수 72.0 / 수익화 15
  - 이유: 복수 소스 교차 확인 가능 (3개), 섹터/세계 흐름 연결 해설 가능
  - 근거 소스: Cointelegraph, Financial Times Home, Reuters Markets via Google News RSS

## 브랜드 레인 우선순위

- `미국주식`: 평균 수익화 15.0 / 게시 예정 2개 / 키워드 ai_semiconductors, us_big_tech
