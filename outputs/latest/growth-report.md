...
- `fomc`: FOMC 이후 시장, 주식과 코인이 같이 흔들리는 이유와 확인할 3가지 / 점수 94.0 / 수익화 15
  ...
  - 근거 소스: Federal Reserve Monetary Policy Press, Investing.com Crypto News, MarketWatch Breaking News
...
- `us_big_tech`: 미국 빅테크 주가가 흔들릴 때 확인할 것: 실적, 금리, AI 투자 / 점수 75.0 / 수익화 15
  ...
  - 근거 소스: CNBC Top News, Financial Times Home, MarketWatch Breaking News, Reuters Markets via Google News RSS

## 브랜드 레인 우선순위

- `미국주식`: 평균 수익화 15.0 / 게시 예정 2개 / 키워드 us_big_tech, us_index_flow
...
- 다음 7일은 `미국주식` 레인을 메인 허브로 밀고, 다른 레인은 보조 내부링크와 후속 글로 연결합니다.
