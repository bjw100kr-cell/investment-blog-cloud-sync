...
- `fomc`: FOMC 이후 시장, 주식과 코인이 같이 흔들리는 이유와 확인할 3가지 / 점수 94.0 / 수익화 15
  ...
  - 근거 소스: CNBC Top News, CoinDesk RSS, Federal Reserve Monetary Policy Press, Financial Times World
...
- `거시경제`: 평균 수익화 15.0 / 게시 예정 2개 / 키워드 fomc, oil
...
- `oil`: trend_count 1, traffic_sum 1000, regions KR / 쿼리 유조선
