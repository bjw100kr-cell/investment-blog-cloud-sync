...
- `fomc`: FOMC 이후 시장, 주식과 코인이 같이 흔들리는 이유와 확인할 3가지 / 점수 96.0 / 수익화 15
  ...
  - 근거 소스: Cointelegraph, Federal Reserve Monetary Policy Press, Investing.com Crypto News, MarketWatch Breaking News, NYT Business, Reuters Markets via Google News RSS
...
- `us_index_flow`: 미국 증시 지수 흐름: 나스닥, 금리, 빅테크 실적을 같이 봐야 하는 이유 / 점수 74.0 / 수익화 15
  ...
  - 근거 소스: CNBC Top News, Financial Times Home, Reuters Markets via Google News RSS

## 브랜드 레인 우선순위

- `코인`: 평균 수익화 15.0 / 게시 예정 1개 / 키워드 bitcoin
- `미국주식`: 평균 수익화 15.0 / 게시 예정 1개 / 키워드 us_index_flow
- `거시경제`: 평균 수익화 14.5 / 게시 예정 2개 / 키워드 fomc, treasury_yields
