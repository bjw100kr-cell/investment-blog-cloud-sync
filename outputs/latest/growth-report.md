...
- `ai_semiconductors`: AI 반도체 주가를 볼 때 실적보다 먼저 확인할 3가지 / 점수 62.0 / 수익화 15
  - 이유: 복수 소스 교차 확인 가능 (3개), 섹터/세계 흐름 연결 해설 가능
  - 근거 소스: CNBC Top News, Financial Times YouTube, 무역킹 Trade King YouTube
...
- `cpi`: trend_count 1, traffic_sum 500, regions KR / 쿼리 cpi 발표
