...
- `fomc`: FOMC 이후 시장, 주식과 코인이 같이 흔들리는 이유와 확인할 3가지 / 점수 94.0 / 수익화 15
  ...
  - 근거 소스: CNBC Top News, Federal Reserve Monetary Policy Press, MarketWatch Breaking News, Reuters Markets via Google News RSS
...
- `us_index_flow`: 미국 증시 지수 흐름: 나스닥, 금리, 빅테크 실적을 같이 봐야 하는 이유 / 점수 75.0 / 수익화 15
  ...
  - 근거 소스: CoinDesk RSS, Cointelegraph, MarketWatch Breaking News, Reuters Markets via Google News RSS
...
- `us_big_tech`: trend_count 1, traffic_sum 1000, regions US / 쿼리 apple lawsuit claim
