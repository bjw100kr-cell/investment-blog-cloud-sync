...
- `bitcoin`: 비트코인 가격보다 먼저 봐야 할 것: ETF 자금, 달러, 규제 체크포인트 / 점수 89.0 / 수익화 15
  - 이유: 복수 소스 교차 확인 가능 (5개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (extreme_fear)
  - 근거 소스: CNBC Top News, CoinDesk RSS, Cointelegraph, Investing.com Crypto News, NYT Business
- `ai_semiconductors`: AI 반도체 주가를 볼 때 실적보다 먼저 확인할 3가지 / 점수 83.0 / 수익화 15
  - 이유: 복수 소스 교차 확인 가능 (7개), 섹터/세계 흐름 연결 해설 가능
  - 근거 소스: CNBC Top News, CoinDesk RSS, Cointelegraph, Financial Times Home, Financial Times World, MarketWatch Breaking News, NYT Business
...
- `ethereum`: trend_count 1, traffic_sum 500, regions KR / 쿼리 이더리움
