...
- `fomc`: FOMC 이후 시장, 주식과 코인이 같이 흔들리는 이유와 확인할 3가지 / 점수 91.0 / 수익화 15
  ...
  - 근거 소스: Federal Reserve Monetary Policy Press, Financial Times Home
...
- `ai_semiconductors`: AI 반도체 주가를 볼 때 실적보다 먼저 확인할 3가지 / 점수 64.0 / 수익화 15
  ...
  - 근거 소스: Financial Times Home, Financial Times YouTube, Reuters Markets via Google News RSS
...
- `tariffs_trade`: trend_count 1, traffic_sum 200, regions KR / 쿼리 무역
