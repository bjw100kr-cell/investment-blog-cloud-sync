...
- `treasury_yields`: 미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유 / 점수 86.0 / 수익화 15
  - 이유: 복수 소스 교차 확인 가능 (7개), 거시 해설형 글로 전환 가치 높음
  - 근거 소스: CNBC Top News, CoinDesk RSS, Cointelegraph, Financial Times Home, MarketWatch Breaking News, NYT Business, Reuters Markets via Google News RSS
...
- `ai_semiconductors`: AI 반도체 주가를 볼 때 실적보다 먼저 확인할 3가지 / 점수 75.0 / 수익화 15
  ...
  - 근거 소스: CoinDesk RSS, Cointelegraph, Financial Times YouTube, MarketWatch Breaking News
