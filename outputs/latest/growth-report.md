...
- `fomc`: FOMC 이후 시장, 주식과 코인이 같이 흔들리는 이유와 확인할 3가지 / 점수 94.0 / 수익화 15
  ...
  - 근거 소스: Federal Reserve Monetary Policy Press, Financial Times World, Reuters Markets via Google News RSS
- `bitcoin`: 비트코인 가격보다 먼저 봐야 할 것: ETF 자금, 달러, 규제 체크포인트 / 점수 85.0 / 수익화 15
  - 이유: 복수 소스 교차 확인 가능 (3개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (risk_on)
  - 근거 소스: CoinDesk RSS, Cointelegraph, Investing.com Crypto News
- `us_big_tech`: 미국 빅테크 주가가 흔들릴 때 확인할 것: 실적, 금리, AI 투자 / 점수 84.0 / 수익화 15
  - 이유: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (3개), 검색량 높은 미국 증시 키워드를 시장 맥락으로 해설 가능, 실제 급상승 검색어 반영 (meta stock)
  - 근거 소스: CoinDesk RSS, Google Trends US, MarketWatch Breaking News
...
- `us_big_tech`: trend_count 1, traffic_sum 1000, regions US / 쿼리 meta stock
