...
- `fomc`: FOMC 이후 시장, 주식과 코인이 같이 흔들리는 이유와 확인할 3가지 / 점수 94.0 / 수익화 15
  ...
  - 근거 소스: CoinDesk RSS, Federal Reserve Monetary Policy Press, Financial Times Home, NYT Business, Reuters Markets via Google News RSS
...
- `ai_semiconductors`: AI 반도체 주가를 볼 때 실적보다 먼저 확인할 3가지 / 점수 81.0 / 수익화 15
  - 이유: 복수 소스 교차 확인 가능 (5개), 섹터/세계 흐름 연결 해설 가능
  - 근거 소스: CNBC Top News, Cointelegraph, Financial Times Home, Financial Times YouTube, NYT Business
