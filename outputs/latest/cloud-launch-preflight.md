...
- ready_to_click_run_workflow: `False`
- blocker_count: `2`
- repo_connected: `True`
...
- `review_state_safe_before_first_cloud_run`: `False`
  - why: 첫 클라우드 실행 전에는 승인 목록이 비어 있어야 의도치 않은 게시가 나가지 않습니다.
  - next_action: `python3 scripts/set_review_approvals.py --clear`
- `first_cloud_safety_checks_green`: `False`
  - why: 현재 업로드 차단/승인 게이트/보고서 정합성이 초록 상태여야 첫 GitHub Actions 검증이 안전합니다.
  - next_action: `python3 scripts/prepare_first_cloud_run_verification.py --allow-approved-state`
