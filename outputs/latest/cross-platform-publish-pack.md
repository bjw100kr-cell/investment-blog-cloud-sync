...
- generated_at: `2026-06-30T21:51:42.955689+00:00`
- selected_count: `4`
...
#### 후보 글
- [2] 비트코인 가격보다 먼저 봐야 할 것: ETF 자금, 달러, 규제 체크포인트 | keyword=bitcoin | score=128.0 | quality=unknown | date=2026-07-01
...
- [8] 비트코인 핵심 흐름 초보자 가이드: 지금 꼭 알아야 할 핵심 구조 | keyword=seo_bitcoin_4 | score=127.5 | quality=unknown | date=2026-07-01
...
- [9] 비트코인 핵심 흐름 ETF·규제 이슈 정리 | keyword=seo_bitcoin_5 | score=124.5 | quality=unknown | date=2026-07-01
...
#### 후보 글 (복사 대상)
- [2] 비트코인 가격보다 먼저 봐야 할 것: ETF 자금, 달러, 규제 체크포인트 | keyword=bitcoin | score=128.0 | quality=pass | date=2026-07-01
  - html_path: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/02-비트코인-핵심-흐름-해설.html`
- [8] 비트코인 핵심 흐름 초보자 가이드: 지금 꼭 알아야 할 핵심 구조 | keyword=seo_bitcoin_4 | score=127.5 | quality=pass | date=2026-07-01
  - html_path: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/seo-publish-ready/04-비트코인-핵심-흐름-초보자-가이드-지금-꼭-알아야-할-핵심-구조.html`
- [9] 비트코인 핵심 흐름 ETF·규제 이슈 정리 | keyword=seo_bitcoin_5 | score=124.5 | quality=pass | date=2026-07-01
  - html_path: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/seo-publish-ready/05-비트코인-핵심-흐름-etf-규제-이슈-정리.html`
