...
- `fomc` / FOMC 이후 시장 해설 / lane `macro` / publish 2026-06-30 / priority 140.0 / freshness `` / quality `pass` / hero_image_selected `True`
- `bitcoin` / 비트코인 핵심 흐름 해설 / lane `crypto` / publish 2026-07-01 / priority 125.0 / freshness `fresh` / quality `review_before_publish` / hero_image_selected `True`
...
- why_not_other_topics:
  ...
  - `bitcoin`는 freshness는 괜찮아도 quality `review_before_publish` 상태라 바로 올리기보다 추가 검토가 먼저입니다.
