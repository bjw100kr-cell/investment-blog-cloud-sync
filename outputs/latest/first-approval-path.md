...
- `bitcoin` / 비트코인 가격보다 먼저 봐야 할 것: ETF 자금, 달러, 규제 체크포인트 / lane `crypto` / publish 2026-09-07 / priority 122.0 / freshness `fresh` / quality `pass` / hero_image_selected `True`
- `oil` / 유가 상승이 물가와 증시에 번지는 경로: 투자자가 볼 3가지 / lane `macro` / publish 2026-09-06 / priority 102.0 / freshness `` / quality `review_before_publish` / hero_image_selected `True`
