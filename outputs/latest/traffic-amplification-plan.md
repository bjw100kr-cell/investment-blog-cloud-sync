...
```text
미국 빅테크 주가가 흔들릴 때 확인할 것: 실적, 금리, AI 투자 읽은 뒤 바로 이어볼 글: 관련 허브 글과 최신 검색수요 글 2개
```
...
```text
us_big_tech 후속 글 후보: us_big_tech 후속 글 1개를 먼저 생성하거나, 관련 메인 글 1개를 내부링크로 연결
```
