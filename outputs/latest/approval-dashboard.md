...
- `bitcoin` / 비트코인 가격보다 먼저 봐야 할 것: ETF 자금, 달러, 규제 체크포인트 / main_post / lane_focus_crypto / publish 2026-09-10 / priority 121.0 / freshness `fresh` / quality `pass` / hero_image_selected `True` / ready_now `True`
- `fomc` / FOMC 이후 시장, 주식과 코인이 같이 흔들리는 이유와 확인할 3가지 / main_post / lane_focus_macro / publish 2026-09-09 / priority 139.0 / freshness `unknown` / quality `pass` / hero_image_selected `True` / ready_now `True`
...
- `us_big_tech` / 미국 빅테크 주가가 흔들릴 때 확인할 것: 실적, 금리, AI 투자 / main_post / lane_focus_us-stocks / publish 2026-09-11 / priority 105.0 / freshness `unknown` / quality `review_before_publish` / hero_image_selected `True` / ready_now `False`
