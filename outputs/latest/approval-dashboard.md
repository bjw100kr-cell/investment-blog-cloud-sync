...
- `bitcoin` / 비트코인 핵심 흐름 해설 / main_post / lane_focus_crypto / publish 2026-07-01 / priority 125.0 / freshness `fresh` / quality `review_before_publish` / hero_image_selected `True` / ready_now `False`
...
- `bitcoin` / 비트코인 핵심 흐름 해설 / main_post / lane_focus_crypto / publish 2026-07-01 / priority 125.0 / freshness `fresh` / quality `review_before_publish` / hero_image_selected `True` / ready_now `False`
- `seo_bitcoin_4` / 비트코인 핵심 흐름 초보자 가이드: 지금 꼭 알아야 할 핵심 구조 / seo_followup / evergreen_seo / publish 2026-07-01 / priority 124.5 / freshness `unknown` / quality `review_before_publish` / hero_image_selected `True` / ready_now `False`
- `seo_bitcoin_5` / 비트코인 핵심 흐름 ETF·규제 이슈 정리 / seo_followup / follow_up / publish 2026-07-01 / priority 121.5 / freshness `unknown` / quality `review_before_publish` / hero_image_selected `True` / ready_now `False`
- `seo_bitcoin_6` / 비트코인 핵심 흐름 FAQ 10개: 많이 헷갈리는 질문 정리 / seo_followup / evergreen_seo / publish 2026-07-01 / priority 118.5 / freshness `unknown` / quality `review_before_publish` / hero_image_selected `True` / ready_now `False`
