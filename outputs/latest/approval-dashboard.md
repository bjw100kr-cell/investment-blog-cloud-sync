...
- `bitcoin` / 비트코인 가격보다 먼저 봐야 할 것: ETF 자금, 달러, 규제 체크포인트 / main_post / lane_focus_crypto / publish 2026-09-08 / priority 121.0 / freshness `fresh` / quality `pass` / hero_image_selected `True` / ready_now `True`
- `fomc` / FOMC 이후 시장, 주식과 코인이 같이 흔들리는 이유와 확인할 3가지 / main_post / lane_focus_macro / publish 2026-09-07 / priority 139.0 / freshness `unknown` / quality `pass` / hero_image_selected `True` / ready_now `True`
