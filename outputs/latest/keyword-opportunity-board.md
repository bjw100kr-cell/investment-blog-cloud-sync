...
- queue_publish: 2026-08-29 (today_or_overdue)
...
- keyword: dollar
- urgency: watch
- score: 75.0 / search 19 / demand 2800
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 4400 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `달러 인덱스 보는법`: type mapped_keyword_demand / mapped dollar / demand 2800 / regions unknown
