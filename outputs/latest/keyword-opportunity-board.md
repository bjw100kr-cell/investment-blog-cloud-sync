...
- score: 97.0 / search 29 / demand 6300
- ready_to_upload: True
- queue_publish: 2026-08-02 (later)
...
- keyword: bitcoin
- urgency: prep_today
- score: 83.0 / search 29 / demand 5800
- ready_to_upload: True
- queue_publish: 2026-07-30 (tomorrow)
...
- urgency: watch
- score: 79.0 / search 19 / demand 2800
- ready_to_upload: True
...
- ready_to_upload: True
- queue_publish: 2026-08-01 (this_week)
- reason: 복수 소스 교차 확인 가능 (4개), 섹터/세계 흐름 연결 해설 가능
- action: 카테고리 보강용 후보로 계속 추적합니다.
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 6300 / regions unknown
...
- `AI 반도체 주식`: type mapped_keyword_demand / mapped ai_semiconductors / demand 2800 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `ford stock`: type unmatched_market_trend / mapped none / demand 2000 / regions US
  - suggested_title: ford stock 왜 검색이 급증했나: 투자자 관점 핵심 정리
