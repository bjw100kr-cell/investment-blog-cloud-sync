...
- keyword: fomc
- urgency: publish_now
- score: 94.0 / search 26 / demand 4100
- ready_to_upload: True
- queue_publish: 2026-08-13 (today_or_overdue)
...
- keyword: bitcoin
- urgency: prep_today
- score: 83.0 / search 29 / demand 5500
- ready_to_upload: True
- queue_publish: 2026-08-14 (tomorrow)
...
- urgency: watch
- score: 65.0 / search 13 / demand 2000
- ready_to_upload: True
- queue_publish: 2026-08-15 (this_week)
...
- ready_to_upload: True
- queue_publish: 2026-08-16 (this_week)
...
- keyword: oil
- urgency: watch
- score: 88.0 / search 28 / demand 700
- ready_to_upload: False
- queue_publish: 미정 (queue 없음)
- trend_queries: brent headrick
- reason: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (6개), 거시 해설형 글로 전환 가치 높음, 실제 급상승 검색어 반영 (brent headrick)
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 5500 / regions unknown
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 4100 / regions unknown
  - reader_search_queries: FOMC 일정, FOMC 발표 시간, FOMC 이후 주식 영향, 연준 금리 발표 비트코인 영향
  - suggested_title: FOMC 일정 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `cpi`: type mapped_keyword_demand / mapped cpi / demand 3300 / regions unknown
  - reader_search_queries: cpi
  - suggested_title: cpi 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `AI 반도체 주식`: type mapped_keyword_demand / mapped ai_semiconductors / demand 2000 / regions unknown
  - reader_search_queries: AI 반도체 주식, 엔비디아 주가 영향, 반도체 사이클 전망, AI 데이터센터 수혜주
  - suggested_title: AI 반도체 주식 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `국제유가 전망`: type mapped_keyword_demand / mapped oil / demand 700 / regions US
  - reader_search_queries: 국제유가 전망, 유가 상승 주식 영향, WTI 유가 보는법, 원유 가격 인플레이션 영향, brent headrick
