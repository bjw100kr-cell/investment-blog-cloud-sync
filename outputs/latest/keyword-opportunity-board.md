...
- score: 92.0 / search 24 / demand 3600
- ready_to_upload: True
- queue_publish: 2026-08-22 (later)
...
- keyword: bitcoin
- urgency: prep_today
- score: 83.0 / search 29 / demand 6600
- ready_to_upload: True
- queue_publish: 2026-08-19 (tomorrow)
...
- ready_to_upload: True
- queue_publish: 2026-08-20 (this_week)
...
- ready_to_upload: True
- queue_publish: 2026-08-21 (this_week)
- reason: 복수 소스 교차 확인 가능 (2개), 섹터/세계 흐름 연결 해설 가능
- action: 카테고리 보강용 후보로 계속 추적합니다.
...
- urgency: watch
- score: 87.0 / search 26 / demand 4400
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 6600 / regions unknown
...
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 4400 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 3600 / regions unknown
  - reader_search_queries: FOMC 일정, FOMC 발표 시간, FOMC 이후 주식 영향, 연준 금리 발표 비트코인 영향
  - suggested_title: FOMC 일정 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `cpi`: type mapped_keyword_demand / mapped cpi / demand 2400 / regions unknown
  - reader_search_queries: cpi
  - suggested_title: cpi 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `국제유가 전망`: type mapped_keyword_demand / mapped oil / demand 400 / regions US
  - reader_search_queries: 국제유가 전망, 유가 상승 주식 영향, WTI 유가 보는법, 원유 가격 인플레이션 영향, brent jindra
