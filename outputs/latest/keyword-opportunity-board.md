...
- queue_publish: 2026-09-14 (today_or_overdue)
...
- ready_to_upload: True
- queue_publish: 2026-09-15 (tomorrow)
...
- ready_to_upload: True
- queue_publish: 2026-09-16 (this_week)
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 5300 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 3900 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `AI 반도체 주식`: type mapped_keyword_demand / mapped ai_semiconductors / demand 3200 / regions unknown
