...
- keyword: fomc
- urgency: publish_now
- score: 98.0 / search 30 / demand 7500
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 7500 / regions unknown
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 6500 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `미국 빅테크 주식`: type mapped_keyword_demand / mapped us_big_tech / demand 3600 / regions unknown
  - reader_search_queries: 미국 빅테크 주식, 애플 주가 영향, 테슬라 주가 전망, 마이크로소프트 AI 투자
  - suggested_title: 미국 빅테크 주식 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `cpi`: type mapped_keyword_demand / mapped cpi / demand 2800 / regions unknown
