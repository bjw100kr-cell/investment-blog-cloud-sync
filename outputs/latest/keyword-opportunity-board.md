...
- queue_publish: 2026-09-26 (later)
...
- ready_to_upload: True
- queue_publish: 2026-09-23 (tomorrow)
- reason: 복수 소스 교차 확인 가능 (3개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (extreme_greed)
...
- keyword: us_big_tech
- urgency: watch
- score: 56.0 / search 8 / demand 0
- ready_to_upload: True
- queue_publish: 2026-09-24 (this_week)
