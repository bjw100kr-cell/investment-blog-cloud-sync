...
- keyword: bitcoin
- urgency: prep_today
- score: 91.0 / search 30 / demand 8500
- ready_to_upload: True
- queue_publish: 2026-07-01 (tomorrow)
- reason: 복수 소스 교차 확인 가능 (7개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (extreme_fear)
...
- keyword: us_big_tech
- urgency: watch
- score: 64.0 / search 15 / demand 400
- ready_to_upload: False
- queue_publish: 미정 (queue 없음)
- trend_queries: apple iphone 18 pro
- reason: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (2개), 검색량 높은 미국 증시 키워드를 시장 맥락으로 해설 가능, 실제 급상승 검색어 반영 (apple iphone 18 pro)
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 8500 / regions unknown
...
- `미국 빅테크 주식`: type mapped_keyword_demand / mapped us_big_tech / demand 400 / regions US
  - reader_search_queries: 미국 빅테크 주식, 애플 주가 영향, 테슬라 주가 전망, 마이크로소프트 AI 투자, apple iphone 18 pro
