...
- queue_publish: 2026-08-14 (later)
...
- keyword: bitcoin
- urgency: prep_today
- score: 84.0 / search 30 / demand 8200
- ready_to_upload: True
...
- keyword: cpi
- urgency: watch
- score: 74.0 / search 17 / demand 2500
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 8200 / regions unknown
...
- `AI 반도체 주식`: type mapped_keyword_demand / mapped ai_semiconductors / demand 2800 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `cpi`: type mapped_keyword_demand / mapped cpi / demand 2500 / regions unknown
