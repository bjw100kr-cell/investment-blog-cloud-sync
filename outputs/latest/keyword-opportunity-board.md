...
- keyword: fomc
- urgency: publish_now
- score: 97.0 / search 29 / demand 6800
- ready_to_upload: True
- queue_publish: 2026-07-30 (today_or_overdue)
...
- keyword: bitcoin
- urgency: prep_today
- score: 83.0 / search 29 / demand 7100
- ready_to_upload: True
- queue_publish: 2026-07-31 (tomorrow)
...
- urgency: watch
- score: 91.0 / search 30 / demand 2900
- ready_to_upload: True
- queue_publish: 미정 (later)
- trend_queries: qqq stock, qqq
...
- keyword: china
- urgency: watch
- score: 62.0 / search 12 / demand 0
- ready_to_upload: True
- queue_publish: 2026-08-02 (this_week)
...
- keyword: us_big_tech
- urgency: watch
- score: 80.0 / search 21 / demand 3000
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 7100 / regions unknown
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 6800 / regions unknown
  - reader_search_queries: FOMC 일정, FOMC 발표 시간, FOMC 이후 주식 영향, 연준 금리 발표 비트코인 영향
  - suggested_title: FOMC 일정 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `미국 빅테크 주식`: type mapped_keyword_demand / mapped us_big_tech / demand 3000 / regions unknown
  - reader_search_queries: 미국 빅테크 주식, 애플 주가 영향, 테슬라 주가 전망, 마이크로소프트 AI 투자
  - suggested_title: 미국 빅테크 주식 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `미국 증시 오늘`: type mapped_keyword_demand / mapped us_index_flow / demand 2900 / regions US
  - reader_search_queries: 미국 증시 오늘, 나스닥 하락 이유, S&P500 전망, 미국 주식 금리 영향, qqq stock
  - suggested_title: 미국 증시 오늘 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 2600 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `sandisk stock`: type unmatched_market_trend / mapped none / demand 2000 / regions US
  - suggested_title: sandisk stock 왜 검색이 급증했나: 투자자 관점 핵심 정리
