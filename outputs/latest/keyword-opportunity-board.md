...
- queue_publish: 2026-08-08 (later)
...
- keyword: bitcoin
- urgency: prep_today
- score: 86.0 / search 30 / demand 7200
- ready_to_upload: True
- queue_publish: 2026-08-05 (tomorrow)
...
- ready_to_upload: True
- queue_publish: 2026-08-07 (this_week)
...
- keyword: oil
- urgency: watch
- score: 85.0 / search 26 / demand 3600
...
- `AI 반도체 주식`: type mapped_keyword_demand / mapped ai_semiconductors / demand 2300 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `고용노동부`: type mapped_keyword_demand / mapped jobs / demand 700 / regions KR
