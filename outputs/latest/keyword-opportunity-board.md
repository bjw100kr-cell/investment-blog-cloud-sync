...
- queue_publish: 2026-08-10 (later)
...
- keyword: bitcoin
- urgency: prep_today
- score: 85.0 / search 29 / demand 6300
- ready_to_upload: True
- queue_publish: 2026-08-07 (tomorrow)
...
- ready_to_upload: True
- queue_publish: 2026-08-08 (this_week)
...
- urgency: watch
- score: 56.0 / search 11 / demand 400
- ready_to_upload: True
- queue_publish: 2026-08-09 (this_week)
- trend_queries: 무역
...
- keyword: oil
- urgency: watch
- score: 79.0 / search 21 / demand 3000
...
### 4. FOMC 이후 시장에서 다음으로 봐야 할 체크포인트 5가지
...
### 5. 비트코인 핵심 흐름 FAQ 10개: 많이 헷갈리는 질문 정리
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 6300 / regions unknown
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 3500 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `국제유가 전망`: type mapped_keyword_demand / mapped oil / demand 3000 / regions unknown
  - reader_search_queries: 국제유가 전망, 유가 상승 주식 영향, WTI 유가 보는법, 원유 가격 인플레이션 영향
  - suggested_title: 국제유가 전망 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 2300 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `무역`: type mapped_keyword_demand / mapped tariffs_trade / demand 400 / regions KR
  - reader_search_queries: 무역
  - suggested_title: tariffs_trade 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `app stock`: type unmatched_market_trend / mapped none / demand 5000 / regions US
  - suggested_title: app stock 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 시장/투자 관련 가능성이 있지만 현재 키워드 묶음에 직접 매핑되지 않음
- `wdc stock`: type unmatched_market_trend / mapped none / demand 5000 / regions US
  - suggested_title: wdc stock 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 시장/투자 관련 가능성이 있지만 현재 키워드 묶음에 직접 매핑되지 않음
