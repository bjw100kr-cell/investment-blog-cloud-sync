...
- queue_publish: 2026-08-03 (today_or_overdue)
...
- keyword: bitcoin
- urgency: prep_today
- score: 84.0 / search 30 / demand 7200
- ready_to_upload: True
- queue_publish: 2026-08-04 (tomorrow)
...
- urgency: watch
- score: 61.0 / search 11 / demand 0
- ready_to_upload: True
- queue_publish: 미정 (later)
- reason: 복수 소스 교차 확인 가능 (3개), 섹터/세계 흐름 연결 해설 가능
- action: 카테고리 보강용 후보로 계속 추적합니다.

### 4. 달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법

- keyword: dollar
- urgency: watch
- score: 71.0 / search 17 / demand 2500
- ready_to_upload: True
- queue_publish: 2026-08-06 (this_week)
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 3200 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `달러 인덱스 보는법`: type mapped_keyword_demand / mapped dollar / demand 2500 / regions unknown
