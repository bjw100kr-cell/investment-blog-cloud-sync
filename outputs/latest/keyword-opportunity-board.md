...
- queue_publish: 2026-09-07 (later)
...
- ready_to_upload: True
- queue_publish: 2026-09-04 (tomorrow)
...
- keyword: us_big_tech
- urgency: watch
- score: 67.0 / search 13 / demand 2200
- ready_to_upload: True
- queue_publish: 2026-09-05 (this_week)
...
- keyword: china
- urgency: watch
- score: 57.0 / search 14 / demand 700
- ready_to_upload: True
- queue_publish: 2026-09-06 (this_week)
- trend_queries: 중국공산당
- reason: 검색 트렌드 반응 존재, 섹터/세계 흐름 연결 해설 가능, 실제 급상승 검색어 반영 (중국공산당)
...
- urgency: watch
- score: 81.0 / search 21 / demand 3000
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 3200 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 3000 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `미국 빅테크 주식`: type mapped_keyword_demand / mapped us_big_tech / demand 2200 / regions unknown
  - reader_search_queries: 미국 빅테크 주식, 애플 주가 영향, 테슬라 주가 전망, 마이크로소프트 AI 투자
  - suggested_title: 미국 빅테크 주식 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `중국 경기부양 수혜주`: type mapped_keyword_demand / mapped china / demand 700 / regions KR
  - reader_search_queries: 중국 경기부양 수혜주, 중국 증시 영향, 위안화 환율 시장 영향, 중국 부동산 리스크, 중국공산당
