...
- queue_publish: 2026-08-16 (later)
...
- keyword: bitcoin
- urgency: prep_today
- score: 80.0 / search 26 / demand 4800
- ready_to_upload: True
...
- keyword: china
- urgency: watch
- score: 72.0 / search 16 / demand 2400
- ready_to_upload: True
...
- keyword: cpi
- urgency: watch
- score: 90.0 / search 28 / demand 700
- ready_to_upload: False
- queue_publish: 미정 (queue 없음)
- trend_queries: cpi 발표
- reason: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (8개), 거시 해설형 글로 전환 가치 높음, 실제 급상승 검색어 반영 (cpi 발표)
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 4800 / regions unknown
...
- `중국 경기부양 수혜주`: type mapped_keyword_demand / mapped china / demand 2400 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `cpi 발표`: type mapped_keyword_demand / mapped cpi / demand 700 / regions KR
  - reader_search_queries: cpi 발표
