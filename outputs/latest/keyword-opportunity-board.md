...
- queue_publish: 2026-07-06 (later)
...
- ready_to_upload: True
- queue_publish: 2026-07-03 (tomorrow)
...
- urgency: watch
- score: 76.0 / search 17 / demand 2500
- ready_to_upload: True
...
### 5. 고용지표 발표 후 시장이 흔들리는 이유: 금리, 달러, 성장주 체크포인트

- keyword: jobs
- urgency: watch
- score: 71.0 / search 17 / demand 2700
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 3400 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `jobs`: type mapped_keyword_demand / mapped jobs / demand 2700 / regions unknown
  - reader_search_queries: jobs
