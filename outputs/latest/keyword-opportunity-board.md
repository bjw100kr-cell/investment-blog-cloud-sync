...
- queue_publish: 2026-09-17 (today_or_overdue)
...
- keyword: bitcoin
- urgency: prep_today
- score: 85.0 / search 29 / demand 5800
- ready_to_upload: True
- queue_publish: 2026-09-18 (tomorrow)
...
- urgency: watch
- score: 91.0 / search 30 / demand 5200
- ready_to_upload: True
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 6000 / regions unknown
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 5800 / regions unknown
...
- `미국 증시 오늘`: type mapped_keyword_demand / mapped us_index_flow / demand 5200 / regions US
  - reader_search_queries: 미국 증시 오늘, 나스닥 하락 이유, S&P500 전망, 미국 주식 금리 영향, dow jones stock market
  - suggested_title: 미국 증시 오늘 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `국제유가 전망`: type mapped_keyword_demand / mapped oil / demand 2000 / regions unknown
