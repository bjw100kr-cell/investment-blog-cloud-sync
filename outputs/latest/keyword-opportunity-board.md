...
- keyword: bitcoin
- urgency: prep_today
- score: 85.0 / search 29 / demand 6200
- ready_to_upload: True
...
- trend_queries: 일본 금리
- reason: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (7개), 거시 해설형 글로 전환 가치 높음, 실제 급상승 검색어 반영 (일본 금리)
...
- `국제유가 전망`: type mapped_keyword_demand / mapped oil / demand 2900 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `cpi`: type mapped_keyword_demand / mapped cpi / demand 2300 / regions unknown
  - reader_search_queries: cpi
  - suggested_title: cpi 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 400 / regions KR
  - reader_search_queries: 미국채 금리 상승 이유, 10년물 국채금리 주식 영향, 국채금리 비트코인 영향, 금리 상승 성장주 영향, 일본 금리
