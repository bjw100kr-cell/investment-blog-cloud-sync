...
- queue_publish: 2026-08-11 (today_or_overdue)
...
- keyword: bitcoin
- urgency: prep_today
- score: 86.0 / search 29 / demand 6400
- ready_to_upload: True
- queue_publish: 2026-08-12 (tomorrow)
...
- `AI 반도체 주식`: type mapped_keyword_demand / mapped ai_semiconductors / demand 3100 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `달러 인덱스 보는법`: type mapped_keyword_demand / mapped dollar / demand 2300 / regions unknown
