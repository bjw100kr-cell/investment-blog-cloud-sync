...
- ready_to_upload: True
- queue_publish: 2026-08-17 (tomorrow)
...
- urgency: watch
- score: 68.0 / search 12 / demand 0
- ready_to_upload: True
- queue_publish: 2026-08-18 (this_week)
- reason: 복수 소스 교차 확인 가능 (3개), 검색량 높은 미국 증시 키워드를 시장 맥락으로 해설 가능
- action: 카테고리 보강용 후보로 계속 추적합니다.

### 4. CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유

- keyword: cpi
- urgency: publish_now
- score: 67.0 / search 11 / demand 0
- ready_to_upload: True
- queue_publish: 2026-08-16 (today_or_overdue)
...
- keyword: crypto_etf
- urgency: watch
- score: 56.0 / search 9 / demand 2000
- ready_to_upload: False
- queue_publish: 미정 (queue 없음)
- reason: 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (mixed)
- action: 카테고리 보강용 후보로 계속 추적합니다.
...
- `국제유가 전망`: type mapped_keyword_demand / mapped oil / demand 2100 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `비트코인 현물 ETF 자금 유입`: type mapped_keyword_demand / mapped crypto_etf / demand 2000 / regions unknown
