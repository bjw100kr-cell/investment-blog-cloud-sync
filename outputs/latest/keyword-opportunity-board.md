...
- queue_publish: 2026-09-14 (later)
...
- keyword: bitcoin
- urgency: prep_today
- score: 83.0 / search 26 / demand 4900
- ready_to_upload: True
- queue_publish: 2026-09-11 (tomorrow)
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 4900 / regions unknown
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 4300 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `국제유가 전망`: type mapped_keyword_demand / mapped oil / demand 4300 / regions unknown
  - reader_search_queries: 국제유가 전망, 유가 상승 주식 영향, WTI 유가 보는법, 원유 가격 인플레이션 영향
  - suggested_title: 국제유가 전망 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 3200 / regions unknown
