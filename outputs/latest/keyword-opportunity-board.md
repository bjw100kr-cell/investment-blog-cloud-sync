...
- queue_publish: 2026-08-13 (later)
...
- keyword: bitcoin
- urgency: prep_today
- score: 84.0 / search 30 / demand 8000
- ready_to_upload: True
...
- keyword: oil
- urgency: watch
- score: 60.0 / search 13 / demand 2000
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 4400 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `미국 증시 오늘`: type mapped_keyword_demand / mapped us_index_flow / demand 2300 / regions unknown
