...
- score: 94.0 / search 26 / demand 4600
- ready_to_upload: True
- queue_publish: 2026-08-17 (later)
...
- urgency: watch
- score: 83.0 / search 23 / demand 3200
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 4600 / regions unknown
...
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 3200 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `cpi`: type mapped_keyword_demand / mapped cpi / demand 3000 / regions unknown
