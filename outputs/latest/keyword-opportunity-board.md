...
- queue_publish: 2026-09-13 (later)
...
- keyword: oil
- urgency: watch
- score: 83.0 / search 26 / demand 4000
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 4400 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `국제유가 전망`: type mapped_keyword_demand / mapped oil / demand 4000 / regions unknown
  - reader_search_queries: 국제유가 전망, 유가 상승 주식 영향, WTI 유가 보는법, 원유 가격 인플레이션 영향
  - suggested_title: 국제유가 전망 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `ethereum`: type mapped_keyword_demand / mapped ethereum / demand 2600 / regions unknown
  - reader_search_queries: ethereum
  - suggested_title: ethereum 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
