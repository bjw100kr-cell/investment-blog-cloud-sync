...
- keyword: fomc
- urgency: publish_now
- score: 94.0 / search 26 / demand 4300
- ready_to_upload: True
- queue_publish: 2026-08-27 (today_or_overdue)
...
- keyword: bitcoin
- urgency: prep_today
- score: 86.0 / search 28 / demand 300
- ready_to_upload: True
- queue_publish: 2026-08-28 (tomorrow)
- trend_queries: fidelity bitcoin etf
...
- urgency: watch
- score: 86.0 / search 26 / demand 4900
- ready_to_upload: True
- queue_publish: 2026-08-29 (this_week)
...
- keyword: china
- urgency: watch
- score: 65.0 / search 14 / demand 2100
- ready_to_upload: True
- queue_publish: 2026-08-30 (this_week)
- reason: 복수 소스 교차 확인 가능 (3개), 섹터/세계 흐름 연결 해설 가능
- action: 카테고리 보강용 후보로 계속 추적합니다.

### 5. 코인 ETF 자금 흐름이 중요한 이유: 비트코인과 알트코인 영향 정리

- keyword: crypto_etf
- urgency: watch
- score: 70.0 / search 15 / demand 300
- ready_to_upload: False
- queue_publish: 미정 (queue 없음)
- trend_queries: fidelity bitcoin etf
- reason: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (2개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (mixed), 실제 급상승 검색어 반영 (fidelity bitcoin etf)
...
### 6. 비트코인 핵심 흐름 초보자 가이드: 지금 꼭 알아야 할 핵심 구조
...
- `AI 반도체 주식`: type mapped_keyword_demand / mapped ai_semiconductors / demand 4900 / regions unknown
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 4300 / regions unknown
...
- `국제유가 전망`: type mapped_keyword_demand / mapped oil / demand 2100 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 300 / regions US
  - reader_search_queries: 비트코인 전망, 비트코인 ETF 자금 흐름, 비트코인 하락 이유, 비트코인 오늘 시세 보는법, fidelity bitcoin etf
  - suggested_title: 비트코인 전망 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `비트코인 현물 ETF 자금 유입`: type mapped_keyword_demand / mapped crypto_etf / demand 300 / regions US
  - reader_search_queries: 비트코인 현물 ETF 자금 유입, 이더리움 ETF 승인 영향, 코인 ETF란, ETF 자금 유출 비트코인 영향, fidelity bitcoin etf
  - suggested_title: 비트코인 현물 ETF 자금 유입 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
