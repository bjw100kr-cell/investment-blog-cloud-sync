...
- score: 96.0 / search 28 / demand 5300
- ready_to_upload: True
- queue_publish: 2026-08-11 (this_week)
...
- keyword: bitcoin
- urgency: prep_today
- score: 87.0 / search 30 / demand 7900
- ready_to_upload: True
- queue_publish: 2026-08-09 (tomorrow)
...
- ready_to_upload: True
- queue_publish: 2026-08-10 (this_week)
...
- urgency: publish_now
- score: 70.0 / search 16 / demand 2600
- ready_to_upload: True
- queue_publish: 2026-08-08 (today_or_overdue)
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 7900 / regions unknown
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 5300 / regions unknown
...
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 2600 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `달러 인덱스 보는법`: type mapped_keyword_demand / mapped dollar / demand 2400 / regions unknown
