...
- keyword: oil
- urgency: publish_now
- score: 61.0 / search 12 / demand 2100
- ready_to_upload: True
- queue_publish: 2026-09-06 (today_or_overdue)
...
- keyword: crypto_etf
- urgency: watch
- score: 60.0 / search 8 / demand 0
- ready_to_upload: False
- queue_publish: 미정 (queue 없음)
- reason: 복수 소스 교차 확인 가능 (2개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (risk_on)
- action: 카테고리 보강용 후보로 계속 추적합니다.
