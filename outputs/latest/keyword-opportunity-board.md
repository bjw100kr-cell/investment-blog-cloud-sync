...
- keyword: bitcoin
- urgency: prep_today
- score: 88.0 / search 28 / demand 400
- ready_to_upload: True
...
- urgency: watch
- score: 87.0 / search 26 / demand 4200
...
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 4200 / regions unknown
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 3500 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `달러 인덱스 보는법`: type mapped_keyword_demand / mapped dollar / demand 2700 / regions unknown
  - reader_search_queries: 달러 인덱스 보는법, 달러 강세 주식 영향, 환율 상승 코인 영향, 원달러 환율 전망
  - suggested_title: 달러 인덱스 보는법 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 400 / regions US
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `비트코인 현물 ETF 자금 유입`: type mapped_keyword_demand / mapped crypto_etf / demand 400 / regions US
