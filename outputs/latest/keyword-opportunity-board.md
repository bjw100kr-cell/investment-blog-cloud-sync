...
- queue_publish: 2026-08-18 (later)
...
- keyword: bitcoin
- urgency: prep_today
- score: 82.0 / search 28 / demand 5300
- ready_to_upload: True
- queue_publish: 2026-08-15 (tomorrow)
...
- ready_to_upload: True
- queue_publish: 2026-08-17 (this_week)
...
- urgency: watch
- score: 82.0 / search 21 / demand 3000
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 5300 / regions unknown
...
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 3000 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `cpi`: type mapped_keyword_demand / mapped cpi / demand 2600 / regions unknown
