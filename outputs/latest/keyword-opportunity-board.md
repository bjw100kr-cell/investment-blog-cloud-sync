...
- queue_publish: 2026-08-12 (today_or_overdue)
...
- keyword: bitcoin
- urgency: prep_today
- score: 83.0 / search 29 / demand 6300
- ready_to_upload: True
- queue_publish: 2026-08-13 (tomorrow)
...
- ready_to_upload: True
- queue_publish: 2026-08-14 (this_week)
...
- urgency: watch
- score: 74.0 / search 22 / demand 1200
- ready_to_upload: False
- queue_publish: 미정 (queue 없음)
- trend_queries: 국채
- reason: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (2개), 거시 해설형 글로 전환 가치 높음, 실제 급상승 검색어 반영 (국채)
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 3200 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `중국 경기부양 수혜주`: type mapped_keyword_demand / mapped china / demand 2600 / regions unknown
...
- `국제유가 전망`: type mapped_keyword_demand / mapped oil / demand 2300 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 1200 / regions KR
  - reader_search_queries: 미국채 금리 상승 이유, 10년물 국채금리 주식 영향, 국채금리 비트코인 영향, 금리 상승 성장주 영향, 국채
