...
- keyword: fomc
- urgency: publish_now
- score: 94.0 / search 26 / demand 4700
- ready_to_upload: True
- queue_publish: 2026-09-18 (today_or_overdue)
...
- keyword: bitcoin
- urgency: prep_today
- score: 87.0 / search 28 / demand 300
- ready_to_upload: True
- queue_publish: 2026-09-19 (tomorrow)
- trend_queries: 비트코인 시세
...
- ready_to_upload: True
- queue_publish: 2026-09-20 (this_week)
- reason: 복수 소스 교차 확인 가능 (2개), 섹터/세계 흐름 연결 해설 가능
- action: 카테고리 보강용 후보로 계속 추적합니다.

### 4. 미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유

- keyword: treasury_yields
- urgency: watch
- score: 80.0 / search 19 / demand 2700
- ready_to_upload: True
- queue_publish: 2026-09-21 (this_week)
...
- reason: 검색량 높은 미국 증시 키워드를 시장 맥락으로 해설 가능
- action: 카테고리 보강용 후보로 계속 추적합니다.
...
### 6. 미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유가 주식과 코인에 미치는 영향
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 4700 / regions unknown
...
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 2700 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `국제유가 전망`: type mapped_keyword_demand / mapped oil / demand 2500 / regions unknown
  - reader_search_queries: 국제유가 전망, 유가 상승 주식 영향, WTI 유가 보는법, 원유 가격 인플레이션 영향
  - suggested_title: 국제유가 전망 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `cpi`: type mapped_keyword_demand / mapped cpi / demand 2000 / regions unknown
  - reader_search_queries: cpi
  - suggested_title: cpi 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 300 / regions KR
  - reader_search_queries: 비트코인 전망, 비트코인 ETF 자금 흐름, 비트코인 하락 이유, 비트코인 오늘 시세 보는법, 비트코인 시세
