...
- score: 98.0 / search 30 / demand 9100
- ready_to_upload: True
- queue_publish: 2026-09-21 (later)
- reason: 공식 소스 기반 확인 가능, 복수 소스 교차 확인 가능 (10개), 거시 해설형 글로 전환 가치 높음
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 9100 / regions unknown
