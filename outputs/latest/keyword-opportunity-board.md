...
- score: 97.0 / search 29 / demand 5500
- ready_to_upload: True
- queue_publish: 2026-09-02 (later)
...
- ready_to_upload: True
- queue_publish: 2026-08-30 (tomorrow)
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 5500 / regions unknown
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 5100 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `cpi`: type mapped_keyword_demand / mapped cpi / demand 3800 / regions unknown
