...
- keyword: fomc
- urgency: publish_now
- score: 86.0 / search 19 / demand 3200
- ready_to_upload: True
- queue_publish: 2026-07-21 (today_or_overdue)
...
- keyword: bitcoin
- urgency: prep_today
- score: 92.0 / search 30 / demand 2500
- ready_to_upload: True
- queue_publish: 2026-07-22 (tomorrow)
- trend_queries: 비트코인, fidelity bitcoin
...
- ready_to_upload: True
- queue_publish: 2026-07-23 (this_week)
...
- keyword: china
- urgency: watch
- score: 72.0 / search 15 / demand 2200
- ready_to_upload: True
- queue_publish: 2026-07-24 (this_week)
...
- keyword: oil
- urgency: watch
- score: 82.0 / search 24 / demand 3400
...
### 5. FOMC 이후 시장에서 다음으로 봐야 할 체크포인트 5가지
...
### 6. FOMC 이후 시장 초보자 가이드: 용어부터 시장 반응까지
...
- `국제유가 전망`: type mapped_keyword_demand / mapped oil / demand 3400 / regions unknown
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 3200 / regions unknown
  - reader_search_queries: FOMC 일정, FOMC 발표 시간, FOMC 이후 주식 영향, 연준 금리 발표 비트코인 영향
  - suggested_title: FOMC 일정 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 2500 / regions KR, US
  - reader_search_queries: 비트코인 전망, 비트코인 ETF 자금 흐름, 비트코인 하락 이유, 비트코인 오늘 시세 보는법, 비트코인
  - suggested_title: 비트코인 전망 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `비트코인 현물 ETF 자금 유입`: type mapped_keyword_demand / mapped crypto_etf / demand 2200 / regions unknown
  - reader_search_queries: 비트코인 현물 ETF 자금 유입, 이더리움 ETF 승인 영향, 코인 ETF란, ETF 자금 유출 비트코인 영향
