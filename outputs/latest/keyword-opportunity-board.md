...
- keyword: bitcoin
- urgency: prep_today
- score: 90.0 / search 29 / demand 5900
- ready_to_upload: True
...
- keyword: crypto_etf
- urgency: watch
- score: 86.0 / search 21 / demand 3000
...
- `bitcoin`: type mapped_keyword_demand / mapped bitcoin / demand 5900 / regions unknown
...
- `us_index_flow`: type mapped_keyword_demand / mapped us_index_flow / demand 3400 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결되어 있어 검색형 후속 글로 전환하기 좋습니다.
- `crypto_etf`: type mapped_keyword_demand / mapped crypto_etf / demand 3000 / regions unknown
  - suggested_title: crypto_etf 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결되어 있어 검색형 후속 글로 전환하기 좋습니다.
