...
- queue_publish: 2026-09-03 (today_or_overdue)
...
- keyword: bitcoin
- urgency: prep_today
- score: 85.0 / search 29 / demand 6100
- ready_to_upload: True
...
### 5. 달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법

- keyword: dollar
- urgency: watch
- score: 76.0 / search 20 / demand 2900
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 6100 / regions unknown
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 4700 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `AI 반도체 주식`: type mapped_keyword_demand / mapped ai_semiconductors / demand 3000 / regions unknown
  - reader_search_queries: AI 반도체 주식, 엔비디아 주가 영향, 반도체 사이클 전망, AI 데이터센터 수혜주
  - suggested_title: AI 반도체 주식 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `달러 인덱스 보는법`: type mapped_keyword_demand / mapped dollar / demand 2900 / regions unknown
