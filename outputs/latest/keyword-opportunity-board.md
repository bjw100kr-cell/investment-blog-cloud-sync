...
- queue_publish: 2026-07-10 (later)
...
- ready_to_upload: True
- queue_publish: 2026-07-07 (tomorrow)
...
- urgency: watch
- score: 74.0 / search 15 / demand 2300
- ready_to_upload: True
- queue_publish: 2026-07-08 (this_week)
...
- ready_to_upload: True
- queue_publish: 2026-07-09 (this_week)
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 3200 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `국제유가 전망`: type mapped_keyword_demand / mapped oil / demand 2600 / regions unknown
