...
- 생성 시각: `2026-08-25T01:38:08.916997+00:00`
- 당일 브레이킹 후보: `5`
- SEO 후속 후보: `6`
- 검색어 워치리스트: `4`
...
- score: 86.0 / search 25 / demand 3500
- ready_to_upload: True
- queue_publish: 2026-08-29 (later)
...
- keyword: bitcoin
- urgency: prep_today
- score: 87.0 / search 29 / demand 6700
- ready_to_upload: True
- queue_publish: 2026-08-26 (tomorrow)
...
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 3500 / regions unknown
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 3200 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `tariffs_trade`: type mapped_keyword_demand / mapped tariffs_trade / demand 2600 / regions unknown
