...
- queue_publish: 2026-08-26 (today_or_overdue)
...
- keyword: cpi
- urgency: watch
- score: 88.0 / search 26 / demand 3900
...
- `cpi`: type mapped_keyword_demand / mapped cpi / demand 3900 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 2900 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `pce`: type mapped_keyword_demand / mapped pce / demand 2200 / regions US
  - reader_search_queries: pce
  - suggested_title: pce 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
