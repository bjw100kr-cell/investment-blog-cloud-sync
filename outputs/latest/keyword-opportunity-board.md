...
- queue_publish: 2026-07-05 (today_or_overdue)
...
- keyword: bitcoin
- urgency: prep_today
- score: 87.0 / search 29 / demand 5700
- ready_to_upload: True
- queue_publish: 2026-07-06 (tomorrow)
...
- urgency: watch
- score: 85.0 / search 30 / demand 20200
- ready_to_upload: True
- queue_publish: 2026-07-07 (this_week)
- trend_queries: 반도체
...
- `AI 반도체 주식`: type mapped_keyword_demand / mapped ai_semiconductors / demand 20200 / regions KR
  - reader_search_queries: AI 반도체 주식, 엔비디아 주가 영향, 반도체 사이클 전망, AI 데이터센터 수혜주, 반도체
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 3800 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `주식 투자`: type unmatched_market_trend / mapped none / demand 1000 / regions KR
