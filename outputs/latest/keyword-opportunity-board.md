...
- queue_publish: 2026-07-25 (later)
...
- keyword: bitcoin
- urgency: prep_today
- score: 85.0 / search 29 / demand 6000
- ready_to_upload: True
...
- urgency: watch
- score: 76.0 / search 18 / demand 2600
- ready_to_upload: True
...
- urgency: watch
- score: 79.0 / search 20 / demand 2900
- ready_to_upload: True
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 6000 / regions unknown
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 3200 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `tariffs_trade`: type mapped_keyword_demand / mapped tariffs_trade / demand 2900 / regions unknown
  - reader_search_queries: tariffs_trade
