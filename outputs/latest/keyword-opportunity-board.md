...
- keyword: fomc
- urgency: publish_now
- score: 90.0 / search 22 / demand 3400
- ready_to_upload: True
- queue_publish: 2026-09-20 (today_or_overdue)
...
- keyword: bitcoin
- urgency: prep_today
- score: 84.0 / search 28 / demand 5200
- ready_to_upload: True
- queue_publish: 2026-09-21 (tomorrow)
...
- ready_to_upload: True
- queue_publish: 2026-09-22 (this_week)
...
- score: 70.0 / search 14 / demand 0
- ready_to_upload: True
- queue_publish: 2026-09-23 (this_week)
...
- keyword: crypto_etf
- urgency: watch
- score: 76.0 / search 16 / demand 2400
...
- `비트코인 전망`: type mapped_keyword_demand / mapped bitcoin / demand 5200 / regions unknown
...
- `FOMC 일정`: type mapped_keyword_demand / mapped fomc / demand 3400 / regions unknown
  - reader_search_queries: FOMC 일정, FOMC 발표 시간, FOMC 이후 주식 영향, 연준 금리 발표 비트코인 영향
  - suggested_title: FOMC 일정 왜 검색이 급증했나: 투자자 관점 핵심 정리
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `미국채 금리 상승 이유`: type mapped_keyword_demand / mapped treasury_yields / demand 2400 / regions unknown
  ...
  - note: 기존 핵심 키워드와 연결된 사람 검색형 문구입니다. 제목, 소제목, 배포문구, 내부링크 앵커에 우선 사용합니다.
- `비트코인 현물 ETF 자금 유입`: type mapped_keyword_demand / mapped crypto_etf / demand 2400 / regions unknown
