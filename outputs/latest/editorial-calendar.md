...
- lane `macro` / keyword `seo_fomc_1` / mode `recovery` / freshness `stale` / target_share `0.3`
...
## Day 1 · 2026-07-01 · lane_focus_macro
...
- 타깃 키워드: seo_fomc_1
- 작업 제목: FOMC 이후 시장이 주식과 코인에 미치는 영향
- 글 각도: 뉴스형 본문 대신 evergreen 후속 글로 전환하는 편이 더 안전하고 검색형 수익화에도 유리합니다.
- 검색 의도: 당일 이슈를 따라가되 날짜가 지난 뉴스보다 구조를 이해하고 싶은 독자
- 수익화 경로: 검색형 후속 글로 전환해 시의성 하락 리스크를 줄이고 누적 유입 확보
- 내부링크 대상: fomc
- 근거 소스/연결 키워드: fomc
- 발행 메모: 직접 뉴스 발행 대신 evergreen salvage 경로로 전환

## Day 2 · 2026-07-02 · lane_focus_crypto
...
- 글 각도: 복수 소스 교차 확인 가능 (5개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (extreme_fear)
...
## Day 3 · 2026-07-03 · lane_focus_us-stocks
...
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: CNBC Top News, CoinDesk RSS, Cointelegraph, Financial Times Home, Financial Times World, MarketWatch Breaking News, NYT Business
- 근거 소스/연결 키워드: CNBC Top News, CoinDesk RSS, Cointelegraph, Financial Times Home, Financial Times World, MarketWatch Breaking News, NYT Business
- 발행 메모: 당일 이슈 해설형 글

## Day 4 · 2026-07-04 · lane_focus_world-flow
...
## Day 5 · 2026-07-05 · evergreen_support
...
## Day 6 · 2026-07-06 · secondary_lane_support
...
## Day 7 · 2026-07-07 · weekly_recap

- 브랜드 레인: 거시경제
- planning_mode: recap
- freshness_status: mixed
- 포스트 유형: weekly_macro_recap
- 타깃 키워드: seo_fomc_1, bitcoin, ai_semiconductors
...
- 내부링크 대상: seo_fomc_1, bitcoin, ai_semiconductors
- 근거 소스/연결 키워드: seo_fomc_1, bitcoin, ai_semiconductors
