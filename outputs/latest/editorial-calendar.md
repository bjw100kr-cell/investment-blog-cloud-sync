...
- lane `us-stocks` / keyword `ai_growth_stocks` / mode `direct` / freshness `unknown` / target_share `0.2`
...
- 내부링크 대상: CNBC Top News, Federal Reserve Monetary Policy Press, Reuters Markets via Google News RSS
- 근거 소스/연결 키워드: CNBC Top News, Federal Reserve Monetary Policy Press, Reuters Markets via Google News RSS
- 발행 메모: 당일 이슈 해설형 글
...
- 글 각도: 복수 소스 교차 확인 가능 (3개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (extreme_fear)
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
...
- freshness_status: unknown
- 포스트 유형: breaking_explainer
- 타깃 키워드: ai_growth_stocks
- 작업 제목: AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담
- 글 각도: 복수 소스 교차 확인 가능 (3개), 검색량 높은 미국 증시 키워드를 시장 맥락으로 해설 가능
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: Financial Times Home, Financial Times YouTube, 무역킹 Trade King YouTube
- 근거 소스/연결 키워드: Financial Times Home, Financial Times YouTube, 무역킹 Trade King YouTube
- 발행 메모: 당일 이슈 해설형 글
...
- 타깃 키워드: fomc, bitcoin, ai_growth_stocks
...
- 내부링크 대상: fomc, bitcoin, ai_growth_stocks
- 근거 소스/연결 키워드: fomc, bitcoin, ai_growth_stocks
