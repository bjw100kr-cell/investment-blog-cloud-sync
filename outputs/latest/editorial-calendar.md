...
## Day 1 · 2026-07-28 · lane_focus_macro
...
- 내부링크 대상: CoinDesk RSS, Federal Reserve Monetary Policy Press, Investing.com Crypto News, Reuters Markets via Google News RSS
- 근거 소스/연결 키워드: CoinDesk RSS, Federal Reserve Monetary Policy Press, Investing.com Crypto News, Reuters Markets via Google News RSS
- 발행 메모: 지금 상태로는 데일리 뉴스형 게시보다 refresh 후 재작성 또는 evergreen 해설형 전환이 더 안전합니다.

## Day 2 · 2026-07-29 · lane_focus_crypto
...
## Day 3 · 2026-07-30 · lane_focus_us-stocks
...
- 글 각도: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (4개), 검색량 높은 미국 증시 키워드를 시장 맥락으로 해설 가능, 실제 급상승 검색어 반영 (stock market)
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: Financial Times Home, Financial Times World, Google Trends US, Reuters Markets via Google News RSS
- 근거 소스/연결 키워드: Financial Times Home, Financial Times World, Google Trends US, Reuters Markets via Google News RSS
- 발행 메모: 당일 이슈 해설형 글

## Day 4 · 2026-07-31 · lane_focus_world-flow
...
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: MarketWatch Breaking News, NYT Business
- 근거 소스/연결 키워드: MarketWatch Breaking News, NYT Business
- 발행 메모: 당일 이슈 해설형 글

## Day 5 · 2026-08-01 · evergreen_support
...
## Day 6 · 2026-08-02 · secondary_lane_support
