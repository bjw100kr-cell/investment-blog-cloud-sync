...
- lane `macro` / keyword `dollar` / mode `direct` / freshness `unknown` / target_share `0.3`
...
## Day 1 · 2026-07-18 · lane_focus_macro
...
- 타깃 키워드: dollar
- 작업 제목: 달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법
...
## Day 2 · 2026-07-19 · lane_focus_crypto
...
## Day 3 · 2026-07-20 · lane_focus_us-stocks
...
## Day 4 · 2026-07-21 · lane_focus_world-flow
...
## Day 5 · 2026-07-22 · evergreen_support
...
## Day 6 · 2026-07-23 · secondary_lane_support
...
## Day 7 · 2026-07-24 · weekly_recap

- 브랜드 레인: 거시경제
- planning_mode: recap
- freshness_status: mixed
- 포스트 유형: weekly_macro_recap
- 타깃 키워드: dollar, bitcoin, ai_semiconductors
...
- 내부링크 대상: dollar, bitcoin, ai_semiconductors
- 근거 소스/연결 키워드: dollar, bitcoin, ai_semiconductors
