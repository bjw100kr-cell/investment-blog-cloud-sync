...
## Day 1 · 2026-09-09 · lane_focus_macro
...
- 내부링크 대상: Federal Reserve Monetary Policy Press, Financial Times Home, Investing.com Crypto News, MarketWatch Breaking News, Reuters Markets via Google News RSS
- 근거 소스/연결 키워드: Federal Reserve Monetary Policy Press, Financial Times Home, Investing.com Crypto News, MarketWatch Breaking News, Reuters Markets via Google News RSS
- 발행 메모: 당일 이슈 해설형 글

## Day 2 · 2026-09-10 · lane_focus_crypto
...
## Day 3 · 2026-09-11 · lane_focus_us-stocks
...
- 글 각도: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (3개), 검색량 높은 미국 증시 키워드를 시장 맥락으로 해설 가능, 실제 급상승 검색어 반영 (apple)
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: Financial Times World, Google Trends KR, Reuters Markets via Google News RSS
- 근거 소스/연결 키워드: Financial Times World, Google Trends KR, Reuters Markets via Google News RSS
- 발행 메모: 당일 이슈 해설형 글

## Day 4 · 2026-09-12 · lane_focus_world-flow
...
- 글 각도: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (2개), 섹터/세계 흐름 연결 해설 가능, 실제 급상승 검색어 반영 (puerto rico vs china)
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: Google Trends US, 무역킹 Trade King YouTube
- 근거 소스/연결 키워드: Google Trends US, 무역킹 Trade King YouTube
- 발행 메모: 당일 이슈 해설형 글

## Day 5 · 2026-09-13 · evergreen_support
...
## Day 6 · 2026-09-14 · secondary_lane_support
