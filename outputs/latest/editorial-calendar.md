...
## Day 1 · 2026-07-08 · lane_focus_macro
...
- 내부링크 대상: CNBC Top News, CoinDesk RSS, Financial Times Home, Financial Times YouTube, NYT Business, Reuters Markets via Google News RSS
- 근거 소스/연결 키워드: CNBC Top News, CoinDesk RSS, Financial Times Home, Financial Times YouTube, NYT Business, Reuters Markets via Google News RSS
- 발행 메모: 당일 이슈 해설형 글

## Day 2 · 2026-07-09 · lane_focus_crypto
...
- 글 각도: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (4개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (extreme_fear), 실제 급상승 검색어 반영 (bitcoin)
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: CoinDesk RSS, Cointelegraph, Google Trends US, Investing.com Crypto News
- 근거 소스/연결 키워드: CoinDesk RSS, Cointelegraph, Google Trends US, Investing.com Crypto News
- 발행 메모: 사용자 검토만 통과하면 바로 게시 후보로 유지해도 됩니다.

## Day 3 · 2026-07-10 · lane_focus_us-stocks
...
- 글 각도: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (3개), 검색량 높은 미국 증시 키워드를 시장 맥락으로 해설 가능, 실제 급상승 검색어 반영 (stock market today)
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: Google Trends US, MarketWatch Breaking News, Reuters Markets via Google News RSS
- 근거 소스/연결 키워드: Google Trends US, MarketWatch Breaking News, Reuters Markets via Google News RSS
- 발행 메모: 당일 이슈 해설형 글

## Day 4 · 2026-07-11 · lane_focus_world-flow
...
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: CNBC Top News, MarketWatch Breaking News
- 근거 소스/연결 키워드: CNBC Top News, MarketWatch Breaking News
- 발행 메모: 당일 이슈 해설형 글

## Day 5 · 2026-07-12 · evergreen_support
...
## Day 6 · 2026-07-13 · secondary_lane_support
...
## Day 7 · 2026-07-14 · weekly_recap

- 브랜드 레인: 거시경제
- planning_mode: recap
- freshness_status: mixed
- 포스트 유형: weekly_macro_recap
- 타깃 키워드: oil, bitcoin, us_index_flow
...
- 내부링크 대상: oil, bitcoin, us_index_flow
- 근거 소스/연결 키워드: oil, bitcoin, us_index_flow
