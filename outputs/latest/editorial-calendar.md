...
## Day 1 · 2026-08-26 · lane_focus_macro
...
- 내부링크 대상: Cointelegraph, NYT Business, Reuters Markets via Google News RSS
- 근거 소스/연결 키워드: Cointelegraph, NYT Business, Reuters Markets via Google News RSS
- 발행 메모: 당일 이슈 해설형 글

## Day 2 · 2026-08-27 · lane_focus_crypto
...
- 글 각도: 복수 소스 교차 확인 가능 (3개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (risk_off)
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
...
## Day 3 · 2026-08-28 · lane_focus_us-stocks
...
- 글 각도: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (4개), 섹터/세계 흐름 연결 해설 가능, 실제 급상승 검색어 반영 (엔비디아 실적)
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: Financial Times World, Financial Times YouTube, Google Trends KR, Reuters Markets via Google News RSS
- 근거 소스/연결 키워드: Financial Times World, Financial Times YouTube, Google Trends KR, Reuters Markets via Google News RSS
- 발행 메모: 당일 이슈 해설형 글

## Day 4 · 2026-08-29 · lane_focus_world-flow
...
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: Financial Times Home, Financial Times World, NYT Business, 무역킹 Trade King YouTube
- 근거 소스/연결 키워드: Financial Times Home, Financial Times World, NYT Business, 무역킹 Trade King YouTube
- 발행 메모: 당일 이슈 해설형 글

## Day 5 · 2026-08-30 · evergreen_support
...
## Day 6 · 2026-08-31 · secondary_lane_support
