...
## Day 1 · 2026-08-16 · lane_focus_macro
...
- 내부링크 대상: MarketWatch Breaking News, NYT Business, Reuters Markets via Google News RSS
- 근거 소스/연결 키워드: MarketWatch Breaking News, NYT Business, Reuters Markets via Google News RSS
- 발행 메모: 당일 이슈 해설형 글

## Day 2 · 2026-08-17 · lane_focus_crypto
...
## Day 3 · 2026-08-18 · lane_focus_us-stocks
...
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: CNBC Top News, MarketWatch Breaking News, Reuters Markets via Google News RSS
- 근거 소스/연결 키워드: CNBC Top News, MarketWatch Breaking News, Reuters Markets via Google News RSS
- 발행 메모: 당일 이슈 해설형 글

## Day 4 · 2026-08-19 · support
...
## Day 5 · 2026-08-20 · evergreen_support
...
## Day 6 · 2026-08-21 · secondary_lane_support
...
## Day 7 · 2026-08-22 · weekly_recap

- 브랜드 레인: 거시경제
- planning_mode: recap
- freshness_status: mixed
- 포스트 유형: weekly_macro_recap
- 타깃 키워드: cpi, bitcoin, us_index_flow
...
- 내부링크 대상: cpi, bitcoin, us_index_flow
- 근거 소스/연결 키워드: cpi, bitcoin, us_index_flow
