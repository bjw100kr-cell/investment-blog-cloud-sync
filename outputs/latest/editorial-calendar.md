...
## Day 1 · 2026-08-20 · lane_focus_macro
...
- 내부링크 대상: CNBC Top News, Federal Reserve Monetary Policy Press, Financial Times Home, Financial Times World, NYT Business
- 근거 소스/연결 키워드: CNBC Top News, Federal Reserve Monetary Policy Press, Financial Times Home, Financial Times World, NYT Business
- 발행 메모: 당일 이슈 해설형 글

## Day 2 · 2026-08-21 · lane_focus_crypto
...
- 글 각도: 복수 소스 교차 확인 가능 (4개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (risk_on)
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
...
## Day 3 · 2026-08-22 · lane_focus_us-stocks
...
## Day 4 · 2026-08-23 · lane_focus_world-flow
...
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: Cointelegraph, Financial Times World, MarketWatch Breaking News, NYT Business
- 근거 소스/연결 키워드: Cointelegraph, Financial Times World, MarketWatch Breaking News, NYT Business
- 발행 메모: 사용자 검토만 통과하면 바로 게시 후보로 유지해도 됩니다.

## Day 5 · 2026-08-24 · evergreen_support
...
## Day 6 · 2026-08-25 · secondary_lane_support
