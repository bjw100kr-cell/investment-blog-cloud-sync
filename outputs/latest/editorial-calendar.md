...
- 생성 시각: `2026-08-08T02:00:40.178612+00:00`
...
## Day 1 · 2026-08-08 · lane_focus_macro
...
- 글 각도: 공식 소스 기반 확인 가능, 복수 소스 교차 확인 가능 (9개), 거시 해설형 글로 전환 가치 높음
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: CNBC Top News, Cointelegraph, Federal Reserve Monetary Policy Press, Financial Times Home, Financial Times World, Investing.com Crypto News, MarketWatch Breaking News, NYT Business, Reuters Markets via Google News RSS
- 근거 소스/연결 키워드: CNBC Top News, Cointelegraph, Federal Reserve Monetary Policy Press, Financial Times Home, Financial Times World, Investing.com Crypto News, MarketWatch Breaking News, NYT Business, Reuters Markets via Google News RSS
- 발행 메모: 당일 이슈 해설형 글

## Day 2 · 2026-08-09 · lane_focus_crypto
...
- 글 각도: 복수 소스 교차 확인 가능 (4개), 코인 독자 유입과 재방문 가능성
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: CoinDesk RSS, Cointelegraph, Financial Times Home, Investing.com Crypto News
- 근거 소스/연결 키워드: CoinDesk RSS, Cointelegraph, Financial Times Home, Investing.com Crypto News
- 발행 메모: 사용자 검토만 통과하면 바로 게시 후보로 유지해도 됩니다.

## Day 3 · 2026-08-10 · lane_focus_us-stocks
...
- 검색 의도: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- 수익화 경로: 시의성 유입 확보 후 설명형 글과 내부링크로 체류 확대
- 내부링크 대상: Financial Times Home, Financial Times World, NYT Business, Reuters Markets via Google News RSS
- 근거 소스/연결 키워드: Financial Times Home, Financial Times World, NYT Business, Reuters Markets via Google News RSS
- 발행 메모: 당일 이슈 해설형 글

## Day 4 · 2026-08-11 · lane_focus_world-flow
...
## Day 5 · 2026-08-12 · evergreen_support
...
## Day 6 · 2026-08-13 · secondary_lane_support
