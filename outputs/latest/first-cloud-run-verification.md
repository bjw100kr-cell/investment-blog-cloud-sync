...
- blogger_summary: `{"processed_count": 1, "auto_publish": true, "publish_due_only": false, "max_posts_per_run": 3, "allow_reupload_same_content": false, "review_required": false, "only_keywords": [], "approval_file_present": true, "user_final_confirmation_required": false, "user_confirmed_all": false, "user_confirmed_keywords": ["bitcoin"], "approved_all": false, "approved_keywords": ["bitcoin"], "quality_gate_blocked": []}`
