...
- 생성 시각: `2026-08-21T13:02:27.427223+00:00`
- 목표: 하루 `200`명
...
- supporting_queries: 비트코인 ETF 자금 흐름, 비트코인 하락 이유, 비트코인 오늘 시세 보는법, fidelity bitcoin etf
- use_in: title, first_h2, meta_description, internal_link_anchor, social_share_copy

### 비트코인 현물 ETF 자금 유입

- mapped_keyword: `crypto_etf`
- suggested_title: 비트코인 현물 ETF 자금 유입 왜 검색이 급증했나: 투자자 관점 핵심 정리
- supporting_queries: 이더리움 ETF 승인 영향, 코인 ETF란, ETF 자금 유출 비트코인 영향, fidelity bitcoin etf
- use_in: title, first_h2, meta_description, internal_link_anchor, social_share_copy
...
- `tariffs_trade`: 0개 체크 / 예상 0명 / 첫 채널  / 
