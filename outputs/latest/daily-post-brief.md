...
- 소스: CNBC Top News, Federal Reserve Monetary Policy Press, MarketWatch Breaking News, Reuters Markets via Google News RSS
- 제목 후보:
...
- 브랜드 레인: `crypto` (코인)
- 총점: `84.0`
- 점수 구성: 검색성 28 / 시의성 20 / 설명가치 17 / 수익성 15 / 리스크역점수 3 / 성과보너스 0.0 / 트렌드보너스 2 / 코인시장신호 1
...
- 총점: `71.0`
- 점수 구성: 검색성 15 / 시의성 17 / 설명가치 19 / 수익성 15 / 리스크역점수 5 / 성과보너스 0.0 / 트렌드보너스 1 / 코인시장신호 0
- 추천 이유: 복수 소스 교차 확인 가능 (4개), 섹터/세계 흐름 연결 해설 가능
- 소스: CoinDesk RSS, Financial Times YouTube, MarketWatch Breaking News, Reuters Markets via Google News RSS
- 제목 후보:
...
- 소스: CNBC Top News, Financial Times Home, Financial Times YouTube, MarketWatch Breaking News, NYT Business, Reuters Markets via Google News RSS
- 제목 후보:
...
- 참고 헤드라인:
  ...
  - Rising oil prices weigh on US futures ahead of Big Tech results - Reuters
