...
- 소스: CNBC Top News, CoinDesk RSS, Federal Reserve Monetary Policy Press, Financial Times Home, Financial Times World, MarketWatch Breaking News, NYT Business
- 제목 후보:
...
- 총점: `69.0`
- 점수 구성: 검색성 14 / 시의성 15 / 설명가치 18 / 수익성 15 / 리스크역점수 7 / 성과보너스 0.0 / 트렌드보너스 0 / 코인시장신호 0
...
- 총점: `42.0`
- 점수 구성: 검색성 4 / 시의성 2 / 설명가치 17 / 수익성 12 / 리스크역점수 7 / 성과보너스 0.0 / 트렌드보너스 0 / 코인시장신호 0
- 추천 이유: 섹터/세계 흐름 연결 해설 가능
- 소스: 무역킹 Trade King YouTube
- 제목 후보:
...
- 브랜드 레인: `macro` (거시경제)
- 총점: `88.0`
- 점수 구성: 검색성 26 / 시의성 21 / 설명가치 18 / 수익성 15 / 리스크역점수 8 / 성과보너스 0.0 / 트렌드보너스 2 / 코인시장신호 0
- 추천 이유: 복수 소스 교차 확인 가능 (6개), 거시 해설형 글로 전환 가치 높음
- 소스: CNBC Top News, Financial Times Home, Investing.com Crypto News, MarketWatch Breaking News, NYT Business, Reuters Markets via Google News RSS
- 제목 후보:
...
- 참고 헤드라인:
  ...
  - Bitcoin falls to $79k as rebound rally cools ahead of U.S. inflation data
  - Bessent’s bond intervention puts US Treasury on collision course with Fed
  - Australia inflation runs hot in July, markets reprice rate hike risk - Reuters
  - Dollar nudges higher ahead of US inflation data; Aussie gains on rate bets - Reuters
