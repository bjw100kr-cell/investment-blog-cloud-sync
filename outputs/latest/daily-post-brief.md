...
- 소스: Cointelegraph, Federal Reserve Monetary Policy Press, Financial Times World, Reuters Markets via Google News RSS
- 제목 후보:
...
- 총점: `77.0`
- 점수 구성: 검색성 17 / 시의성 20 / 설명가치 18 / 수익성 15 / 리스크역점수 7 / 성과보너스 0.0 / 트렌드보너스 0 / 코인시장신호 0
...
- 총점: `77.0`
- 점수 구성: 검색성 19 / 시의성 20 / 설명가치 17 / 수익성 14 / 리스크역점수 7 / 성과보너스 0.0 / 트렌드보너스 1 / 코인시장신호 0
- 추천 이유: 복수 소스 교차 확인 가능 (4개), 섹터/세계 흐름 연결 해설 가능
...
- 브랜드 레인: `macro` (거시경제)
- 총점: `81.0`
- 점수 구성: 검색성 23 / 시의성 20 / 설명가치 17 / 수익성 14 / 리스크역점수 7 / 성과보너스 0.0 / 트렌드보너스 1 / 코인시장신호 0
- 추천 이유: 복수 소스 교차 확인 가능 (4개), 거시 해설형 글로 전환 가치 높음
- 소스: Financial Times Home, Financial Times World, Financial Times YouTube, Reuters Markets via Google News RSS
- 제목 후보:
...
- 참고 헤드라인:
  ...
  - Stocks edge back up as oil prices pause climb but yields hover near highs - Reuters
  - Oil down more than 4% on profit taking, report of China-backed push to end US-Iran fighting - Reuters
