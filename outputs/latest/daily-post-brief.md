...
- 소스: Cointelegraph, Financial Times Home, Financial Times World
- 제목 후보:
...
- 브랜드 레인: `macro` (거시경제)
- 총점: `84.0`
- 점수 구성: 검색성 22 / 시의성 21 / 설명가치 18 / 수익성 15 / 리스크역점수 8 / 성과보너스 0.0 / 트렌드보너스 1 / 코인시장신호 0
...
- 참고 헤드라인:
  ...
  - Japan's bond 'falling knife' stalls repatriation rush - Reuters
