...
- 브랜드 레인: `crypto` (코인)
- 총점: `86.0`
- 점수 구성: 검색성 29 / 시의성 21 / 설명가치 17 / 수익성 15 / 리스크역점수 3 / 성과보너스 0.0 / 트렌드보너스 3 / 코인시장신호 1
...
- 소스: CNBC Top News, Financial Times Home, Financial Times YouTube, MarketWatch Breaking News, NYT Business
- 제목 후보:
...
- 브랜드 레인: `us-stocks` (미국주식)
- 총점: `64.0`
- 점수 구성: 검색성 11 / 시의성 15 / 설명가치 16 / 수익성 15 / 리스크역점수 7 / 성과보너스 0.0 / 트렌드보너스 0 / 코인시장신호 0
- 추천 이유: 복수 소스 교차 확인 가능 (3개), 검색량 높은 미국 증시 키워드를 시장 맥락으로 해설 가능
- 소스: Financial Times Home, MarketWatch Breaking News, NYT Business
- 제목 후보:
