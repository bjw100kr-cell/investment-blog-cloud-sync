...
- 브랜드 레인: `crypto` (코인)
- 총점: `86.0`
- 점수 구성: 검색성 26 / 시의성 20 / 설명가치 17 / 수익성 15 / 리스크역점수 3 / 성과보너스 0.0 / 트렌드보너스 2 / 코인시장신호 5
- 추천 이유: 복수 소스 교차 확인 가능 (4개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (extreme_greed)
- 코인 시장 신호: BTCUSDT 24h change 5.23%; Fear/Greed 78: Extreme Greed zone
...
- 총점: `71.0`
- 점수 구성: 검색성 16 / 시의성 18 / 설명가치 18 / 수익성 14 / 리스크역점수 5 / 성과보너스 0.0 / 트렌드보너스 1 / 코인시장신호 0
- 추천 이유: 복수 소스 교차 확인 가능 (3개), 섹터/세계 흐름 연결 해설 가능
- 소스: Cointelegraph, Financial Times World, NYT Business
- 제목 후보:
...
- 브랜드 레인: `macro` (거시경제)
- 총점: `65.0`
- 점수 구성: 검색성 13 / 시의성 13 / 설명가치 19 / 수익성 14 / 리스크역점수 6 / 성과보너스 0.0 / 트렌드보너스 1 / 코인시장신호 0
