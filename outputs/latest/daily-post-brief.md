...
- 소스: CoinDesk RSS, Federal Reserve Monetary Policy Press, Investing.com Crypto News, Reuters Markets via Google News RSS
- 제목 후보:
...
- 추천 이유: 복수 소스 교차 확인 가능 (4개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (risk_off)
- 코인 시장 신호: BTCUSDT 24h change -3.10%
...
- 총점: `92.0`
- 점수 구성: 검색성 30 / 시의성 20 / 설명가치 19 / 수익성 15 / 리스크역점수 8 / 성과보너스 0.0 / 트렌드보너스 2 / 코인시장신호 0
- 추천 이유: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (4개), 검색량 높은 미국 증시 키워드를 시장 맥락으로 해설 가능, 실제 급상승 검색어 반영 (stock market)
- 소스: Financial Times Home, Financial Times World, Google Trends US, Reuters Markets via Google News RSS
- 트렌드 쿼리: stock market
- 제목 후보:
...
- 브랜드 레인: `us-stocks` (미국주식)
- 총점: `88.0`
- 점수 구성: 검색성 30 / 시의성 20 / 설명가치 18 / 수익성 15 / 리스크역점수 5 / 성과보너스 0.0 / 트렌드보너스 1 / 코인시장신호 0
- 추천 이유: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (4개), 검색량 높은 미국 증시 키워드를 시장 맥락으로 해설 가능, 실제 급상승 검색어 반영 (apple stock, apple upgrade)
- 소스: CNBC Top News, CoinDesk RSS, Google Trends US, MarketWatch Breaking News
- 트렌드 쿼리: apple stock, apple upgrade
- 제목 후보:
