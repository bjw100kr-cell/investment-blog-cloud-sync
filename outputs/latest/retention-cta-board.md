...
- newsletter_subject_seed: [오늘의 투자 브리핑] CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유
- newsletter_preview_seed: 페이지뷰와 체류시간 균형 확보 관점에서 꼭 봐야 할 포인트를 짧게 정리했습니다.
- followup_title: CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유가 주식과 코인에 미치는 영향
- followup_title: CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유에서 다음으로 봐야 할 체크포인트 5가지
...
- followup_title: 비트코인 현물 ETF 자금 유입: 지금 투자자가 확인할 체크포인트 5가지
- next_action: 사용자 검토 후 승인 대기
