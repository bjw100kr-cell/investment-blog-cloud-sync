...
- keyword `fomc` / publish `2026-07-10` / priority `137.0`
...
- source_names: CNBC Top News, Federal Reserve Monetary Policy Press, Financial Times World
- sample_headlines:
...
- recent_evidence:
  ...
  - CoinDesk RSS | 2026-07-10T09:08:20+00:00 | Metaplanet explores bringing bitcoin-backed digital credit to Japan
- image_slots:
...
예를 들어 `Crypto defies equity weakness as altcoin optimism builds into the weekend` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Crypto defies equity weakness as altcoin optimism builds into the weekend`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `us_big_tech` / publish `2026-07-12` / priority `108.0`
...
예를 들어 `Meta found to breach EU laws with 'addictive' Instagram, Facebook designs` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Meta found to breach EU laws with 'addictive' Instagram, Facebook designs`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
