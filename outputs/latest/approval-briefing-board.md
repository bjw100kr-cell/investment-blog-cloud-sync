...
- keyword `bitcoin` / publish `2026-07-10` / priority `124.0`
...
- recent_evidence:
  ...
  - Investing.com Crypto News | 2026-07-09 11:00:45 | Bitcoin muted at $62k as US-Iran conflict re-escalates
- image_slots:
...
예를 들어 `Latin America’s biggest stock exchange now offers options on bitcoin, ether and solana futures` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Latin America’s biggest stock exchange now offers options on bitcoin, ether and solana futures`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `us_index_flow` / publish `2026-07-11` / priority `104.0`
...
예를 들어 `Crypto remains resilient in face of renewed Middle East tensions` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Crypto remains resilient in face of renewed Middle East tensions`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `china` / publish `2026-07-12` / priority `74.0`
- review `approve` score `100` / quality `review_before_publish` / ready_now `False`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: 실적·공급망·대표 종목 글로 연결
...
예를 들어 `China could be the US tech hedge` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `China could be the US tech hedge`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
