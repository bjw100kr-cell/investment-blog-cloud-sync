...
- keyword `fomc` / publish `2026-08-05` / priority `128.0`
...
예를 들어 `SpaceX tops Wall Street revenue forecast, posts $540 million loss on bitcoin holdings` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `SpaceX tops Wall Street revenue forecast, posts $540 million loss on bitcoin holdings`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `us_index_flow` / publish `` / priority `110.0`
...
- source_names: Cointelegraph, Financial Times Home, MarketWatch Breaking News, NYT Business, Reuters Markets via Google News RSS
- sample_headlines:
...
예를 들어 `Bitcoin coils at $64K as Hormuz reopening timeline sends S&P 500 to $70T record` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Bitcoin coils at $64K as Hormuz reopening timeline sends S&P 500 to $70T record`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: Cointelegraph, Financial Times Home, MarketWatch Breaking News, NYT Business, Reuters Markets via Google News RSS
