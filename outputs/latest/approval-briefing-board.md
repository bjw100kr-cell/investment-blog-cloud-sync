...
- keyword `fomc` / publish `2026-07-20` / priority `127.0`
...
- source_names: Federal Reserve Monetary Policy Press, MarketWatch Breaking News, Reuters Markets via Google News RSS
- sample_headlines:
...
2026년 7월 20일 기준, 이 이슈를 그냥 뉴스 하나로 넘기기엔 아깝습니다.
...
- 주요 참고 소스: Federal Reserve Monetary Policy Press, MarketWatch Breaking News, Reuters Markets via Google News RSS
...
- keyword `bitcoin` / publish `2026-07-21` / priority `109.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: ETF·규제·초보 가이드 글로 연결
- reason: 복수 소스 교차 확인 가능 (3개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (mixed)
- evidence score: demand `0` / fallback `mapped_candidate` / format `crypto_analysis`
...
- recent_evidence:
  - Cointelegraph | 2026-07-20T10:26:36+00:00 | Trader maintains $67K BTC price target: Five things to know in Bitcoin this week
  - Cointelegraph | 2026-07-20T09:33:19+00:00 | Bitcoin ETF inflows extend to second week, but recovery lacks momentum
  - CoinDesk RSS | 2026-07-20T07:15:47+00:00 | Live markets: Oil bounce and lingering AI selloff pushes bitcoin under $64,000
  - CoinDesk RSS | 2026-07-20T07:08:07+00:00 | Moonshot AI IPO push follows Kimi, Alibaba AI releases that shook bitcoin
- image_slots:
...
예를 들어 `Crypto market slips even as equities advance. Pump surges on social-media chatter` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Crypto market slips even as equities advance. Pump surges on social-media chatter`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `ai_semiconductors` / publish `2026-07-22` / priority `109.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- source_names: CNBC Top News, CoinDesk RSS, Financial Times YouTube, MarketWatch Breaking News, Reuters Markets via Google News RSS
- sample_headlines:
  - Live markets: Oil bounce and lingering AI selloff pushes bitcoin under $64,000
  - Moonshot AI IPO push follows Kimi, Alibaba AI releases that shook bitcoin
...
- recent_evidence:
  ...
  - CNBC Top News | 2026-07-20T09:58:05+00:00 | Bezos backs CuspAI as startup teams up with Nvidia to hunt for chipmaking materials
  - MarketWatch Breaking News | 2026-07-20T09:35:00+00:00 | Is an opportunity to buy chip stocks nearing? These two big Wall Street banks are divided.
  - CNBC Top News | 2026-07-20T05:55:54+00:00 | TSMC is accelerating Arizona factory buildout to capitalize on AI 'megatrend,' CFO says
- image_slots:
...
예를 들어 `Live markets: Oil bounce and lingering AI selloff pushes bitcoin under $64,000` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Live markets: Oil bounce and lingering AI selloff pushes bitcoin under $64,000`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: CNBC Top News, CoinDesk RSS, Financial Times YouTube, MarketWatch Breaking News, Reuters Markets via Google News RSS
