...
- keyword `bitcoin` / publish `2026-08-05` / priority `125.0`
...
- recent_evidence:
  ...
  - Cointelegraph | 2026-08-04T10:53:00+00:00 | Jim Cramer plans to sell his Bitcoin over quantum fears as BTC rises 1.6%
- image_slots:
...
예를 들어 `Intesa Sanpaolo slashed IBIT stake by 94% in 2Q, tripled ether ETF holding as crypto prices slumped` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Intesa Sanpaolo slashed IBIT stake by 94% in 2Q, tripled ether ETF holding as crypto prices slumped`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `ai_semiconductors` / publish `2026-08-06` / priority `105.0`
...
- source_names: CNBC Top News, Financial Times Home, Financial Times YouTube, 무역킹 Trade King YouTube
- sample_headlines:
...
- recent_evidence:
  ...
  - 무역킹 Trade King YouTube | 11K | Why has the NVIDIA stock been so quiet lately?
- image_slots:
...
예를 들어 `AMD earnings are a key test for chips and momentum stocks. Here's what the options market is saying` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `AMD earnings are a key test for chips and momentum stocks. Here's what the options market is saying`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: CNBC Top News, Financial Times Home, Financial Times YouTube, 무역킹 Trade King YouTube
...
예를 들어 `China's EV export boom is starting to show up in the gasoline market - Reuters` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `China's EV export boom is starting to show up in the gasoline market - Reuters`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: Reuters Markets via Google News RSS
