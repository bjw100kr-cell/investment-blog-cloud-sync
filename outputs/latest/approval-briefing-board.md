...
- keyword `bitcoin` / publish `2026-09-02` / priority `122.0`
...
- recent_evidence:
  ...
  - Investing.com Crypto News | 2026-08-31 21:48:13 | Bitcoin set for huge August gain despite Iran escalation and rate jitters
- image_slots:
...
- keyword `us_big_tech` / publish `2026-09-03` / priority `97.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  ...
  - MarketWatch Breaking News | 2026-08-31T21:01:00+00:00 | Tesla’s stock among S&P 500’s top gainers as investors prepare for a Cybercab launch
- image_slots:
...
- keyword `tariffs_trade` / publish `2026-09-04` / priority `72.0`
