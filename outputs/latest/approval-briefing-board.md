...
- keyword `bitcoin` / publish `2026-07-18` / priority `122.0`
...
- recent_evidence:
  ...
  - CoinDesk RSS | 2026-07-17T10:43:57+00:00 | Live markets: Bitcoin returns to $63,000 as Nasdaq trims large early loss
- image_slots:
...
- keyword `ai_semiconductors` / publish `2026-07-19` / priority `121.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: 실적·공급망·대표 종목 글로 연결
- reason: 복수 소스 교차 확인 가능 (6개), 섹터/세계 흐름 연결 해설 가능
- evidence score: demand `3900` / fallback `source_snapshot_rank` / format `sector_analysis`
- source_names: CNBC Top News, CoinDesk RSS, Financial Times Home, Financial Times World, Financial Times YouTube, Reuters Markets via Google News RSS
- sample_headlines:
  - Bitcoin faces fresh headwinds as China’s Kimi beats Claude, GPT in coding benchmark
...
- recent_evidence:
  ...
  - CNBC Top News | 2026-07-17T14:43:28+00:00 | Apple, Nvidia vie for title of world's most valuable company
- image_slots:
...
- 주요 참고 소스: CNBC Top News, CoinDesk RSS, Financial Times Home, Financial Times World, Financial Times YouTube, Reuters Markets via Google News RSS
...
- keyword `china` / publish `2026-07-20` / priority `105.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: 실적·공급망·대표 종목 글로 연결
- reason: 복수 소스 교차 확인 가능 (3개), 섹터/세계 흐름 연결 해설 가능
- evidence score: demand `2400` / fallback `source_snapshot_rank` / format `macro_explainer`
...
- 주요 참고 소스: CNBC Top News, CoinDesk RSS, MarketWatch Breaking News
