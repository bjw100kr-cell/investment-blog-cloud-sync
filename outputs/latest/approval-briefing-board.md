...
- keyword `fomc` / publish `2026-09-09` / priority `139.0`
...
- 주요 참고 소스: Federal Reserve Monetary Policy Press, Financial Times Home, Investing.com Crypto News, MarketWatch Breaking News, Reuters Markets via Google News RSS
...
- keyword `bitcoin` / publish `2026-09-10` / priority `121.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: ETF·규제·초보 가이드 글로 연결
- reason: 복수 소스 교차 확인 가능 (3개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (mixed)
- evidence score: demand `5100` / fallback `source_snapshot_rank` / format `crypto_analysis`
...
- recent_evidence:
  ...
  - Investing.com Crypto News | 2026-09-09 13:48:40 | Bitcoin recovers to $79.4k on Zcash ETF inflows; Fed, oil pressures limit rise
  - Investing.com Crypto News | 2026-09-09 07:10:45 | Bitcoin coils near $79,300 in tight range: Live levels
...
- keyword `us_big_tech` / publish `2026-09-11` / priority `105.0`
...
- evidence score: demand `700` / fallback `trend_match` / format `sector_analysis`
...
- recent_evidence:
  - Google Trends KR | 2026-09-09T07:20:00-07:00 | apple
  - Reuters Markets via Google News RSS | 2026-09-09T15:46:55+00:00 | Amazon raises almost $6 billion in first sterling bond sale, lead manager says - Reuters
  - Financial Times World | 2026-09-09T15:43:32+00:00 | New Apple CEO to unveil $2,000 folding iPhone
  - CoinDesk RSS | 2026-09-09T15:24:01+00:00 | Consensys to split MetaMask into its own firm while staying silent on IPO
- image_slots:
...
예를 들어 `apple` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `apple`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: Financial Times World, Google Trends KR, Reuters Markets via Google News RSS
