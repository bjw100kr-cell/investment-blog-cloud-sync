...
- keyword `fomc` / publish `2026-09-11` / priority `140.0`
...
- evidence score: demand `6600` / fallback `source_snapshot_rank` / format `macro_explainer`
- source_names: CNBC Top News, CoinDesk RSS, Federal Reserve Monetary Policy Press, Financial Times Home, Financial Times World, Investing.com Crypto News, MarketWatch Breaking News, NYT Business, Reuters Markets via Google News RSS
- sample_headlines:
...
- 주요 참고 소스: CNBC Top News, CoinDesk RSS, Federal Reserve Monetary Policy Press, Financial Times Home, Financial Times World, Investing.com Crypto News, MarketWatch Breaking News, NYT Business, Reuters Markets via Google News RSS
...
- keyword `bitcoin` / publish `2026-09-12` / priority `122.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: ETF·규제·초보 가이드 글로 연결
- reason: 복수 소스 교차 확인 가능 (3개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (mixed)
- evidence score: demand `6100` / fallback `source_snapshot_rank` / format `crypto_analysis`
...
- sample_headlines:
  ...
  - Live updates: Bitcoin gives up early gains as markets fully price in Fed rate hike
  - Bitcoin recovers toward $77,300 as zcash leverage unwinds
- recent_evidence:
  - Cointelegraph | 2026-09-11T16:03:37+00:00 | Bitcoin spikes toward $80K as US CPI data delivers new 22-year high in bond yields
  - Cointelegraph | 2026-09-11T12:33:38+00:00 | Bitcoin ETF outflows accelerate as investors pull $449M in three days
  - CoinDesk RSS | 2026-09-11T11:20:26+00:00 | Rising yields, oil prices leave bitcoin vulnerable ahead of U.S. inflation report
  - CoinDesk RSS | 2026-09-11T11:04:12+00:00 | Live updates: Bitcoin gives up early gains as markets fully price in Fed rate hike
- image_slots:
...
예를 들어 `Metaplanet cuts executive reward pool by 41%, extinguishes $220 million in value` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Metaplanet cuts executive reward pool by 41%, extinguishes $220 million in value`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `us_index_flow` / publish `2026-09-13` / priority `85.0`
...
- source_names: Cointelegraph, NYT Business
- sample_headlines:
...
쉽게 말해 관련 해설 글과 핵심 키워드를 같이 보면 headline 뒤에 있는 자금 흐름과 심리 변화를 더 빨리 잡을 수 있습니다.
예를 들어 `Bitcoin spikes toward $80K as US CPI data delivers new 22-year high in bond yields` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Bitcoin spikes toward $80K as US CPI data delivers new 22-year high in bond yields`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: Cointelegraph, NYT Business
