...
- keyword `fomc` / publish `2026-07-28` / priority `137.0`
...
- evidence score: demand `4400` / fallback `source_snapshot_rank` / format `macro_explainer`
- source_names: CNBC Top News, CoinDesk RSS, Federal Reserve Monetary Policy Press, NYT Business, Reuters Markets via Google News RSS
- sample_headlines:
...
2026년 7월 28일 기준, 이 이슈를 그냥 뉴스 하나로 넘기기엔 아깝습니다.
...
- 주요 참고 소스: CNBC Top News, CoinDesk RSS, Federal Reserve Monetary Policy Press, NYT Business, Reuters Markets via Google News RSS
...
- keyword `bitcoin` / publish `2026-07-29` / priority `124.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  - CoinDesk RSS | 2026-07-27T19:55:45+00:00 | Bitcoin shrugs off AI selloff but high-stakes Fed meeting could determine what's next
  - Cointelegraph | 2026-07-27T19:22:59+00:00 | Bitmine keeps buying Ether as ETH outperforms Bitcoin
  - Investing.com Crypto News | 2026-07-27 21:24:41 | Bitcoin rises about 1% as U.S. and Iran pause fighting, lifting risk appetite
  - Investing.com Crypto News | 2026-07-27 19:07:18 | Bitcoin trapped in Ichimoku cloud at $64,828: Live levels
- image_slots:
...
예를 들어 `U.S. Senate puts off crypto Clarity Act for now as it focuses limited bandwidth elsewhere` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `U.S. Senate puts off crypto Clarity Act for now as it focuses limited bandwidth elsewhere`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `ai_semiconductors` / publish `2026-07-30` / priority `120.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: 실적·공급망·대표 종목 글로 연결
- reason: 복수 소스 교차 확인 가능 (6개), 섹터/세계 흐름 연결 해설 가능
- evidence score: demand `3500` / fallback `source_snapshot_rank` / format `sector_analysis`
- source_names: CNBC Top News, CoinDesk RSS, Financial Times World, Financial Times YouTube, MarketWatch Breaking News, Reuters Markets via Google News RSS
- sample_headlines:
  - Bitcoin shrugs off AI selloff but high-stakes Fed meeting could determine what's next
...
- recent_evidence:
  ...
  - CNBC Top News | 2026-07-28T02:41:03+00:00 | Shares of SK Hynix plunge 10% in Seoul as semiconductor sell-off deepens
  - Financial Times Home | 2026-07-28T02:21:14+00:00 | AI stock sell-off deepens as investors dump chipmakers
  - MarketWatch Breaking News | 2026-07-28T01:19:00+00:00 | Nvidia’s potential new deal with OpenAI would revive a spooky tech-bubble habit, analyst warns
- image_slots:
...
예를 들어 `Bitcoin shrugs off AI selloff but high-stakes Fed meeting could determine what's next` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Bitcoin shrugs off AI selloff but high-stakes Fed meeting could determine what's next`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: CNBC Top News, CoinDesk RSS, Financial Times World, Financial Times YouTube, MarketWatch Breaking News, Reuters Markets via Google News RSS
