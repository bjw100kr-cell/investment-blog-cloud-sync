...
- keyword `bitcoin` / publish `2026-08-03` / priority `122.0`
...
예를 들어 `Bitcoin cold-wallet attack spreads to 4,500 addresses as losses near $89 million` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Bitcoin cold-wallet attack spreads to 4,500 addresses as losses near $89 million`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `fomc` / publish `2026-08-02` / priority `137.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- source_names: Federal Reserve Monetary Policy Press, Financial Times World, Investing.com Crypto News
- sample_headlines:
  - Federal Reserve issues FOMC statement
  - Federal Reserve announces the leadership and objectives of its task forces to advance the conduct of monetary policy
  - Federal Reserve Board and Federal Open Market Committee release economic projections from the June 16-17 FOMC meeting
  - Bitcoin slips amid Fed uncertainty & Iran tensions, but set for solid July rebound
- recent_evidence:
...
- 주요 참고 소스: Federal Reserve Monetary Policy Press, Financial Times World, Investing.com Crypto News
...
- keyword `us_index_flow` / publish `2026-08-04` / priority `101.0`
...
- source_names: CNBC Top News, CoinDesk RSS
- sample_headlines:
...
예를 들어 `Tokenized stock trading surged 288% in July, but one QQQ token drove most of it` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Tokenized stock trading surged 288% in July, but one QQQ token drove most of it`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: CNBC Top News, CoinDesk RSS
