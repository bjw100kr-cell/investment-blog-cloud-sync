...
- keyword `bitcoin` / publish `2026-08-18` / priority `124.0`
...
- recent_evidence:
  ...
  - CoinDesk RSS | 2026-08-17T11:28:41+00:00 | Bitcoin's biggest holders, Strategy and Metaplanet, are betting on math, not price
- image_slots:
...
2026년 8월 17일 기준, 이 이슈를 그냥 뉴스 하나로 넘기기엔 아깝습니다.
...
예를 들어 `No change in bitcoin holdings as Strategy boosted dollar reserve, bought back more STRC last week` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `No change in bitcoin holdings as Strategy boosted dollar reserve, bought back more STRC last week`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `china` / publish `2026-08-20` / priority `107.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  ...
  - Reuters Markets via Google News RSS | 2026-08-17T00:16:12+00:00 | China surprises oil markets again with a return to stockpiling in July - reuters.com
- image_slots:
...
예를 들어 `The next China shock will come from open-source AI` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `The next China shock will come from open-source AI`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `us_index_flow` / publish `2026-08-19` / priority `86.0`
...
쉽게 말해 해외 주요 매체 보도를 같이 보면 headline 뒤에 있는 자금 흐름과 심리 변화를 더 빨리 잡을 수 있습니다.
예를 들어 `Santoli: Earnings bonanza that lifted market to record may not be all that it appears to be` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Santoli: Earnings bonanza that lifted market to record may not be all that it appears to be`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
