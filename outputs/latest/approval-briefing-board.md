...
- keyword `fomc` / publish `2026-09-08` / priority `135.0`
...
- source_names: Federal Reserve Monetary Policy Press, Investing.com Crypto News
- sample_headlines:
...
- keyword `bitcoin` / publish `2026-09-09` / priority `122.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: ETF·규제·초보 가이드 글로 연결
- reason: 복수 소스 교차 확인 가능 (3개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (mixed)
- evidence score: demand `5800` / fallback `source_snapshot_rank` / format `crypto_analysis`
...
- recent_evidence:
  ...
  - Cointelegraph | 2026-09-08T13:30:00+00:00 | Is Bitcoin too volatile to risk your retirement on?
  - CoinDesk RSS | 2026-09-08T13:18:21+00:00 | Bitcoin rally has more room as volatility shorts unwind, Two Prime CEO says
  - Cointelegraph | 2026-09-08T12:51:00+00:00 | Strategy skips Bitcoin buy to repurchase $176M of STRC preferred shares
- image_slots:
...
예를 들어 `Copper CEO Amar Kuchinad departs as search for a buyer enters a fourth month` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Copper CEO Amar Kuchinad departs as search for a buyer enters a fourth month`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `ai_semiconductors` / publish `2026-09-10` / priority `104.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- source_names: CNBC Top News, Financial Times Home, Financial Times YouTube, MarketWatch Breaking News, Reuters Markets via Google News RSS
- sample_headlines:
...
- recent_evidence:
  ...
  - CNBC Top News | 2026-09-08T15:56:46+00:00 | Qualcomm issues Amazon warrants to acquire $4 billion worth of chipmaker's stock as part of AI infrastructure deal
  - Financial Times Home | 2026-09-08T04:00:17+00:00 | Anthropic and OpenAI bankers push for top-tier credit ratings post-IPO
  - Reuters Markets via Google News RSS | 2026-09-08T01:41:43+00:00 | Nvidia-backed Firmus signs deal with OpenAI for Malaysia data centre capacity - Reuters
- image_slots:
...
예를 들어 `Qualcomm issues Amazon warrants to acquire $4 billion worth of chipmaker's stock as part of AI infrastructure deal` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Qualcomm issues Amazon warrants to acquire $4 billion worth of chipmaker's stock as part of AI infrastructure deal`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: CNBC Top News, Financial Times Home, Financial Times YouTube, MarketWatch Breaking News, Reuters Markets via Google News RSS
