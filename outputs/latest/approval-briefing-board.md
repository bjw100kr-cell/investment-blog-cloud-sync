...
- keyword `fomc` / publish `2026-09-04` / priority `137.0`
...
- source_names: CNBC Top News, CoinDesk RSS, Federal Reserve Monetary Policy Press, Financial Times Home, Financial Times World, NYT Business
- sample_headlines:
...
2026년 9월 4일 기준, 이 이슈를 그냥 뉴스 하나로 넘기기엔 아깝습니다.
...
- 주요 참고 소스: CNBC Top News, CoinDesk RSS, Federal Reserve Monetary Policy Press, Financial Times Home, Financial Times World, NYT Business
...
- keyword `bitcoin` / publish `2026-09-05` / priority `122.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  - CoinDesk RSS | 2026-09-04T11:29:05+00:00 | We checked 6 years of bitcoin data. The NFP report isn't big price mover
  - CoinDesk RSS | 2026-09-04T09:57:01+00:00 | Bitcoin clears $81,000 as privacy coins lead a broad crypto rally
  - CoinDesk RSS | 2026-09-04T09:47:15+00:00 | IMF confirms El Salvador’s bitcoin growth was funded by private donations, not public money
  - Cointelegraph | 2026-09-04T07:37:13+00:00 | Bitcoin ETF inflows hit $731M, highest since January as BTC reclaims $80K
- image_slots:
...
예를 들어 `From warning to listing: UK’s largest retail investment platform opens access to crypto ETNs` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `From warning to listing: UK’s largest retail investment platform opens access to crypto ETNs`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `ai_semiconductors` / publish `2026-09-06` / priority `87.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- source_names: Financial Times Home, Financial Times YouTube
- sample_headlines:
...
- recent_evidence:
  ...
  - Financial Times Home | 2026-09-04T04:00:19+00:00 | Anthropic’s $2tn IPO puts powerful external trustees in spotlight
...
예를 들어 `Anthropic’s $2tn IPO puts powerful external trustees in spotlight` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Anthropic’s $2tn IPO puts powerful external trustees in spotlight`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: Financial Times Home, Financial Times YouTube
