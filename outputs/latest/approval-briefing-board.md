...
- keyword `bitcoin` / publish `2026-08-25` / priority `118.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: ETF·규제·초보 가이드 글로 연결
- reason: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (5개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (mixed), 실제 급상승 검색어 반영 (빗썸)
- evidence score: demand `300` / fallback `trend_match` / format `crypto_analysis`
- source_names: CoinDesk RSS, Cointelegraph, Google Trends KR, Investing.com Crypto News, NYT Business
- sample_headlines:
  - 빗썸
...
- recent_evidence:
  - Cointelegraph | 2026-08-23T23:56:00+00:00 | We are so back! Bitcoin’s 23% rally on US debt policy: Hodler’s Digest
  - Investing.com Crypto News | 2026-08-23 19:02:13 | Bitcoin coils in bull flag near $77K: Live levels
  - Investing.com Crypto News | 2026-08-23 15:17:37 | Bitcoin pares losses as recent rally finds fresh momentum
...
예를 들어 `빗썸` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `빗썸`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: CoinDesk RSS, Cointelegraph, Google Trends KR, Investing.com Crypto News, NYT Business
...
- keyword `fomc` / publish `2026-08-28` / priority `126.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
...
- source_names: CNBC Top News, Cointelegraph, Federal Reserve Monetary Policy Press, Financial Times Home, Financial Times World
- sample_headlines:
...
- 주요 참고 소스: CNBC Top News, Cointelegraph, Federal Reserve Monetary Policy Press, Financial Times Home, Financial Times World
