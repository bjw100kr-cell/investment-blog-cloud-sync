...
- keyword `ai_semiconductors` / publish `2026-09-14` / priority `100.0`
...
- source_names: Financial Times Home, Financial Times YouTube, MarketWatch Breaking News
- sample_headlines:
...
예를 들어 `Houthis used Anthropic AI to try to build ballistic missiles` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Houthis used Anthropic AI to try to build ballistic missiles`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: Financial Times Home, Financial Times YouTube, MarketWatch Breaking News
...
예를 들어 `China Sent a Note and Got Absolutely Roasted` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `China Sent a Note and Got Absolutely Roasted`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: NYT Business, 무역킹 Trade King YouTube
