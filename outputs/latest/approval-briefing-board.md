...
- keyword `bitcoin` / publish `2026-09-23` / priority `124.0`
...
- recent_evidence:
  ...
  - CoinDesk RSS | 2026-09-22T11:35:43+00:00 | A $3.2 million 'bitcoin butterfly' option trade bets on $95,000 by the end of October
- image_slots:
...
예를 들어 `Next for the U.S. SEC: Agency's chief crypto counsel illuminates path for custody` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Next for the U.S. SEC: Agency's chief crypto counsel illuminates path for custody`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `china` / publish `2026-09-25` / priority `80.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
예를 들어 `Trump, Xi seek trade stability and deals, but AI, tariffs and Iran loom large. What to watch` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Trump, Xi seek trade stability and deals, but AI, tariffs and Iran loom large. What to watch`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `us_big_tech` / publish `2026-09-24` / priority `83.0`
...
쉽게 말해 해외 주요 매체 보도를 같이 보면 headline 뒤에 있는 자금 흐름과 심리 변화를 더 빨리 잡을 수 있습니다.
예를 들어 `Wall Street expects Meta's AI agent to shape into a new revenue engine - Reuters` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Wall Street expects Meta's AI agent to shape into a new revenue engine - Reuters`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
