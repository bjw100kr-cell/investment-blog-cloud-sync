...
- keyword `fomc` / publish `2026-07-25` / priority `134.0`
...
2026년 7월 25일 기준, 이 이슈를 그냥 뉴스 하나로 넘기기엔 아깝습니다.
...
- keyword `bitcoin` / publish `2026-07-26` / priority `124.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: ETF·규제·초보 가이드 글로 연결
- reason: 복수 소스 교차 확인 가능 (3개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (mixed)
- evidence score: demand `6300` / fallback `source_snapshot_rank` / format `crypto_analysis`
...
- recent_evidence:
  ...
  - Investing.com Crypto News | 2026-07-24 19:09:59 | Bitcoin tests $63,457 support amid bearish signals: Live levels
  - Investing.com Crypto News | 2026-07-23 22:06:50 | Bitcoin slips 1% as risk sentiment takes a hit; Clarity Act progress in focus
- image_slots:
...
예를 들어 `Senate Dems should accept the victory they won on Trump's crypto limits: White House` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Senate Dems should accept the victory they won on Trump's crypto limits: White House`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `us_index_flow` / publish `2026-07-27` / priority `100.0`
...
- recent_evidence:
  ...
  - MarketWatch Breaking News | 2026-07-24T21:38:00+00:00 | The stock market is completely unprepared for a 6% yield on the 30-year Treasury
  - Reuters Markets via Google News RSS | 2026-07-24T20:16:10+00:00 | Wall St Week Ahead US stocks face tests from Fed decision, tech-led earnings deluge - Reuters
- image_slots:
...
예를 들어 `Nasdaq lags on angst over AI spending ahead of earnings reports - Reuters` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Nasdaq lags on angst over AI spending ahead of earnings reports - Reuters`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
