...
- keyword `fomc` / publish `2026-07-27` / priority `137.0`
...
- source_names: Federal Reserve Monetary Policy Press, Investing.com Crypto News, MarketWatch Breaking News
- sample_headlines:
...
2026년 7월 27일 기준, 이 이슈를 그냥 뉴스 하나로 넘기기엔 아깝습니다.
...
- keyword `bitcoin` / publish `2026-07-28` / priority `124.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: ETF·규제·초보 가이드 글로 연결
- reason: 복수 소스 교차 확인 가능 (4개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (mixed)
- evidence score: demand `5900` / fallback `source_snapshot_rank` / format `crypto_analysis`
- source_names: CoinDesk RSS, Cointelegraph, Financial Times Home, Investing.com Crypto News
- sample_headlines:
...
- recent_evidence:
  - Cointelegraph | 2026-07-26T13:06:00+00:00 | Bitcoin OG selling eases as dormant BTC movement hits 4-year low: Galaxy
  - Investing.com Crypto News | 2026-07-26 19:02:07 | Bitcoin squeezed at $64,730 in volatility coil: Live levels
  - Investing.com Crypto News | 2026-07-26 18:52:47 | Bitcoin price holds above $64,000 as traders brace for upcoming Fed decision
  - Investing.com Crypto News | 2026-07-25 21:12:25 | Bitcoin price hovers at $64,000 as stablecoin inflows weaken
- image_slots:
...
예를 들어 `2 weeks left for Clarity: State of Crypto` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `2 weeks left for Clarity: State of Crypto`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: CoinDesk RSS, Cointelegraph, Financial Times Home, Investing.com Crypto News
...
- keyword `ai_semiconductors` / publish `2026-07-29` / priority `90.0`
...
- recent_evidence:
  - Financial Times YouTube | 45K views | Silicon shadows: inside the black market for AI chips | FT Film
  - CNBC Top News | 2026-07-27T03:29:54+00:00 | China memory chipmaker CXMT skyrockets 500% in blockbuster Shanghai debut
  - Financial Times Home | 2026-07-27T03:08:27+00:00 | Chinese chipmaker CXMT soars almost 500% in market debut
  - Reuters Markets via Google News RSS | 2026-07-26T23:39:00+00:00 | Nvidia in talks with OpenAI to guarantee $250 billion financing for data center, WSJ reports - Reuters
- image_slots:
...
예를 들어 `Nvidia in talks with OpenAI to guarantee $250 billion financing for data center, WSJ reports - Reuters` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Nvidia in talks with OpenAI to guarantee $250 billion financing for data center, WSJ reports - Reuters`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
