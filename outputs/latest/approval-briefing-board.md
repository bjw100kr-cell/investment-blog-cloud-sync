...
- keyword `bitcoin` / publish `2026-08-02` / priority `123.0`
...
- recent_evidence:
  ...
  - Investing.com Crypto News | 2026-08-01 09:01:53 | Bitcoin slips to trade above $63,000 but records 7.5% July gain
- image_slots:
...
예를 들어 `Solana Foundation's new CISO warns AI is making crypto scams more convincing` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Solana Foundation's new CISO warns AI is making crypto scams more convincing`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `fomc` / publish `2026-08-01` / priority `137.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- source_names: CNBC Top News, Federal Reserve Monetary Policy Press, Financial Times Home, Investing.com Crypto News, NYT Business, Reuters Markets via Google News RSS
- sample_headlines:
...
- 주요 참고 소스: CNBC Top News, Federal Reserve Monetary Policy Press, Financial Times Home, Investing.com Crypto News, NYT Business, Reuters Markets via Google News RSS
