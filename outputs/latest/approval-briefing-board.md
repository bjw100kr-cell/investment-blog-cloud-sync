...
- keyword `bitcoin` / publish `2026-07-23` / priority `123.0`
...
- recent_evidence:
  ...
  - Investing.com Crypto News | 2026-07-22 13:30:38 | Hashi Testnet Is Live, Bringing Native Bitcoin Finance One Step Closer to Global Adoption
- image_slots:
...
- keyword `ai_semiconductors` / publish `2026-07-24` / priority `106.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- source_names: CoinDesk RSS, Financial Times YouTube, MarketWatch Breaking News, Reuters Markets via Google News RSS
- sample_headlines:
  - Forget Nvidia: The next big AI trade could be crypto and blockchain
...
예를 들어 `Forget Nvidia: The next big AI trade could be crypto and blockchain` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Forget Nvidia: The next big AI trade could be crypto and blockchain`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: CoinDesk RSS, Financial Times YouTube, MarketWatch Breaking News, Reuters Markets via Google News RSS
...
- keyword `china` / publish `2026-07-25` / priority `69.0`
...
- source_names: Financial Times Home
- sample_headlines:
...
예를 들어 `Mercedes risks US sales ban under Senate China bill` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Mercedes risks US sales ban under Senate China bill`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
