...
- keyword `fomc` / publish `2026-08-17` / priority `133.0`
...
- keyword `bitcoin` / publish `2026-08-18` / priority `122.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  ...
  - Investing.com Crypto News | 2026-08-16 22:20:48 | Bitcoin hovers around $63k as Strategy’s Saylor calls it ‘digital monetary energy’
  - Investing.com Crypto News | 2026-08-16 19:01:25 | Bitcoin coils below $64K resistance: Live levels
...
예를 들어 `The SEC meeting that wasn't: State of Crypto` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `The SEC meeting that wasn't: State of Crypto`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `us_big_tech` / publish `` / priority `97.0`
...
- source_names: CNBC Top News, Cointelegraph, NYT Business
- sample_headlines:
...
- recent_evidence:
  - Cointelegraph | 2026-08-16T12:48:09+00:00 | DefiLlama delayed mobile launch over phishing apps on Apple Store, founder says
...
예를 들어 `DefiLlama delayed mobile launch over phishing apps on Apple Store, founder says` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `DefiLlama delayed mobile launch over phishing apps on Apple Store, founder says`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: CNBC Top News, Cointelegraph, NYT Business
