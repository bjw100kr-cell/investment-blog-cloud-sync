...
- keyword `bitcoin` / publish `2026-09-21` / priority `124.0`
...
- recent_evidence:
  - Cointelegraph | 2026-09-19T19:14:38+00:00 | REX launches 2x leveraged ETF tied to Bitcoin treasury firm Strive
  ...
  - Investing.com Crypto News | 2026-09-19 19:01:46 | Bitcoin tests $82,178 resistance with RSI overbought: Live levels
...
예를 들어 `Clarity Act, we hardly knew ye: We look at what was in the bill and what's replacing it` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Clarity Act, we hardly knew ye: We look at what was in the bill and what's replacing it`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `ai_semiconductors` / publish `2026-09-22` / priority `105.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  ...
  - Reuters Markets via Google News RSS | 2026-09-18T21:41:08+00:00 | Nvidia-backed AI cloud firm Nscale reveals revenue surge in US IPO filing - Reuters
  - CNBC Top News | 2026-09-18T17:02:32+00:00 | Anthropic and OpenAI need truly independent safety evaluators, experts say in public letter
- image_slots:
...
예를 들어 `Anthropic and OpenAI need truly independent safety evaluators, experts say in public letter` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Anthropic and OpenAI need truly independent safety evaluators, experts say in public letter`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `fomc` / publish `2026-09-20` / priority `128.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
