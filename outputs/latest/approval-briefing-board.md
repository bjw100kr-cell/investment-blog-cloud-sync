...
- keyword `fomc` / publish `2026-07-26` / priority `137.0`
...
- source_names: Federal Reserve Monetary Policy Press, Financial Times Home, Reuters Markets via Google News RSS
- sample_headlines:
...
2026년 7월 26일 기준, 이 이슈를 그냥 뉴스 하나로 넘기기엔 아깝습니다.
...
- 주요 참고 소스: Federal Reserve Monetary Policy Press, Financial Times Home, Reuters Markets via Google News RSS
...
- keyword `bitcoin` / publish `2026-07-27` / priority `119.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: ETF·규제·초보 가이드 글로 연결
- reason: 검색 트렌드 반응 존재, 복수 소스 교차 확인 가능 (5개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (mixed), 실제 급상승 검색어 반영 (비트코인)
- evidence score: demand `700` / fallback `trend_match` / format `crypto_analysis`
- source_names: CNBC Top News, CoinDesk RSS, Cointelegraph, Google Trends KR, Investing.com Crypto News
- sample_headlines:
  - 비트코인
...
- recent_evidence:
  - Cointelegraph | 2026-07-25T18:15:44+00:00 | Bitcoin advocacy group to join US State Department’s ‘digital freedom’ program
  - Investing.com Crypto News | 2026-07-25 21:12:25 | Bitcoin price hovers at $64,000 as stablecoin inflows weaken
  - Investing.com Crypto News | 2026-07-25 19:04:18 | Bitcoin coils in $63,800-$65,500 range: Live levels
...
예를 들어 `비트코인` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `비트코인`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: CNBC Top News, CoinDesk RSS, Cointelegraph, Google Trends KR, Investing.com Crypto News
...
- keyword `ai_semiconductors` / publish `2026-07-28` / priority `115.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: 실적·공급망·대표 종목 글로 연결
- reason: 복수 소스 교차 확인 가능 (5개), 섹터/세계 흐름 연결 해설 가능
- evidence score: demand `2800` / fallback `source_snapshot_rank` / format `sector_analysis`
- source_names: CNBC Top News, Financial Times Home, Financial Times World, Financial Times YouTube, NYT Business
- sample_headlines:
...
- recent_evidence:
  ...
  - Financial Times Home | 2026-07-25T19:33:15+00:00 | Top Democrat says Trump administration is worsening chip shortage
  - CNBC Top News | 2026-07-25T08:49:00+00:00 | Nvidia locks down memory supply from SK Hynix as part of $500 billion AI deal
...
예를 들어 `Nvidia locks down memory supply from SK Hynix as part of $500 billion AI deal` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Nvidia locks down memory supply from SK Hynix as part of $500 billion AI deal`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: CNBC Top News, Financial Times Home, Financial Times World, Financial Times YouTube, NYT Business
