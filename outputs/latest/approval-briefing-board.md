...
- keyword `fomc` / publish `2026-09-10` / priority `134.0`
...
- keyword `bitcoin` / publish `2026-09-11` / priority `121.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: ETF·규제·초보 가이드 글로 연결
- reason: 복수 소스 교차 확인 가능 (3개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (risk_off)
- evidence score: demand `4000` / fallback `source_snapshot_rank` / format `crypto_analysis`
...
- recent_evidence:
  ...
  - CoinDesk RSS | 2026-09-10T13:00:00+00:00 | Crypto researchers cut Bitcoin and Ethereum quantum attack estimate by 50%
  - Investing.com Crypto News | 2026-09-10 13:46:49 | Bitcoin drops to $77.1k on Iran jitters, higher yields
- image_slots:
...
예를 들어 `Bitcoin Bancorp snaps up thousands of defunct Bitcoin Depot ATMs for $620,000` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Bitcoin Bancorp snaps up thousands of defunct Bitcoin Depot ATMs for $620,000`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `us_big_tech` / publish `2026-09-12` / priority `96.0`
...
- recent_evidence:
  - CoinDesk RSS | 2026-09-10T16:10:03+00:00 | Polymarket names former Amazon finance chief Warren Jenson as its first CFO
  - MarketWatch Breaking News | 2026-09-10T15:23:00+00:00 | Meta is winning over Wall Street with its new Muse AI agent
  - CNBC Top News | 2026-09-10T14:45:52+00:00 | Apple makes biggest change to iPhone release cadence in 7 years in Ternus' first showcase as CEO
  - Google Trends US | 2026-09-10T08:30:00-07:00 | wolverine metacritic
- image_slots:
...
예를 들어 `Polymarket names former Amazon finance chief Warren Jenson as its first CFO` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Polymarket names former Amazon finance chief Warren Jenson as its first CFO`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: CNBC Top News, CoinDesk RSS, Investing.com Crypto News, MarketWatch Breaking News
