...
- keyword `bitcoin` / publish `2026-09-07` / priority `122.0`
...
- recent_evidence:
  - CoinDesk RSS | 2026-09-06T14:00:00+00:00 | Better and Coinbase’s bitcoin-backed mortgages can reuse borrowers’ collateral
  - Cointelegraph | 2026-09-06T13:03:00+00:00 | Satoshi-era Bitcoin wakes after 16 years of dormancy as 600 BTC moves
  - Investing.com Crypto News | 2026-09-06 14:35:55 | Bitcoin down but holds near $80,000 as corporate buying, U.S. crypto vote in focus
  - Investing.com Crypto News | 2026-09-06 07:02:22 | Bitcoin bull flag 80% done, trapped in range: Hourly
- image_slots:
...
2026년 9월 6일 기준, 이 이슈를 그냥 뉴스 하나로 넘기기엔 아깝습니다.
...
예를 들어 `Better and Coinbase’s bitcoin-backed mortgages can reuse borrowers’ collateral` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Better and Coinbase’s bitcoin-backed mortgages can reuse borrowers’ collateral`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `ai_semiconductors` / publish `2026-09-08` / priority `90.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- source_names: CNBC Top News, Financial Times YouTube, NYT Business
- sample_headlines:
...
- recent_evidence:
  ...
  - NYT Business | 2026-09-06T10:45:11+00:00 | How a Blacklisted Chinese Tech Giant Kept Buying America’s Best A.I. Chips
- image_slots:
...
예를 들어 `‘Model fatigue’ sets in as AI labs race to roll out new versions at frenetic pace` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `‘Model fatigue’ sets in as AI labs race to roll out new versions at frenetic pace`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: CNBC Top News, Financial Times YouTube, NYT Business
...
- keyword `fomc` / publish `2026-09-10` / priority `128.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
...
- source_names: CNBC Top News, Cointelegraph, Federal Reserve Monetary Policy Press, Investing.com Crypto News, Reuters Markets via Google News RSS
- sample_headlines:
...
- 주요 참고 소스: CNBC Top News, Cointelegraph, Federal Reserve Monetary Policy Press, Investing.com Crypto News, Reuters Markets via Google News RSS
