...
- keyword `bitcoin` / publish `2026-07-01` / priority `129.0`
...
- source_names: CNBC Top News, CoinDesk RSS, Cointelegraph, Investing.com Crypto News, MarketWatch Breaking News
- sample_headlines:
