...
- keyword `fomc` / publish `2026-09-18` / priority `137.0`
...
- source_names: Cointelegraph, Federal Reserve Monetary Policy Press, Investing.com Crypto News, NYT Business
- sample_headlines:
...
2026년 9월 18일 기준, 이 이슈를 그냥 뉴스 하나로 넘기기엔 아깝습니다.
...
- 주요 참고 소스: Cointelegraph, Federal Reserve Monetary Policy Press, Investing.com Crypto News, NYT Business
...
- keyword `bitcoin` / publish `2026-09-19` / priority `124.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: ETF·규제·초보 가이드 글로 연결
- reason: 복수 소스 교차 확인 가능 (4개), 코인 독자 유입과 재방문 가능성, 코인 시장 신호 반영 (mixed)
- evidence score: demand `6200` / fallback `source_snapshot_rank` / format `crypto_analysis`
...
- recent_evidence:
  ...
  - CoinDesk RSS | 2026-09-17T14:57:11+00:00 | Crypto for Advisors: Beyond bitcoin and ether
- image_slots:
...
예를 들어 `Bank of Japan raises interest rates by 25 basis points. Bitcoin tops $77,000` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Bank of Japan raises interest rates by 25 basis points. Bitcoin tops $77,000`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `ai_semiconductors` / publish `2026-09-20` / priority `96.0`
...
- source_names: CNBC Top News, Financial Times Home, Financial Times YouTube
- sample_headlines:
...
- recent_evidence:
  ...
  - CNBC Top News | 2026-09-17T09:00:01+00:00 | OpenAI and Anthropic are making 10 times more revenue than all Chinese AI models combined, research group Rhodium says
- image_slots:
...
예를 들어 `Anthropic shares 3 metrics to help AI companies monitor pace of development` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Anthropic shares 3 metrics to help AI companies monitor pace of development`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: CNBC Top News, Financial Times Home, Financial Times YouTube
