...
- keyword `fomc` / publish `2026-07-12` / priority `128.0`
...
- keyword `bitcoin` / publish `2026-07-13` / priority `122.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  ...
  - Cointelegraph | 2026-07-12T01:00:54+00:00 | Empery Digital shares rise after selling Bitcoin to fund AI data center project
- image_slots:
...
예를 들어 `Bitcoin, ether little changed as U.S. launches fresh Iran strikes` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Bitcoin, ether little changed as U.S. launches fresh Iran strikes`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `us_index_flow` / publish `2026-07-14` / priority `86.0`
...
예를 들어 `Berkshire Hathaway gains ground, but still trails the S&P 500 as '26 enters second half` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Berkshire Hathaway gains ground, but still trails the S&P 500 as '26 enters second half`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
