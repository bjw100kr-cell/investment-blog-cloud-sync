...
- keyword `fomc` / publish `2026-07-23` / priority `137.0`
...
- source_names: Federal Reserve Monetary Policy Press, Financial Times World, MarketWatch Breaking News
- sample_headlines:
...
2026년 7월 23일 기준, 이 이슈를 그냥 뉴스 하나로 넘기기엔 아깝습니다.
...
- 주요 참고 소스: Federal Reserve Monetary Policy Press, Financial Times World, MarketWatch Breaking News
...
- keyword `bitcoin` / publish `2026-07-24` / priority `124.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
...
- recent_evidence:
  - CoinDesk RSS | 2026-07-23T09:03:33+00:00 | Live markets: Bitcoin trades above $65,000 as Alphabet's bigger AI bill props up the chip trade
  - Cointelegraph | 2026-07-23T09:03:20+00:00 | Bitcoin may have bottomed before its traditional cycle low: Grayscale’s Pandl
  - Cointelegraph | 2026-07-23T07:08:25+00:00 | Bitcoin ETFs approach $1B in 7-session inflow run
  - CoinDesk RSS | 2026-07-23T06:38:18+00:00 | Bitcoin, Ethereum-linked protocols lose $35 million in multiple attacks hours apart
- image_slots:
...
예를 들어 `Live markets: Bitcoin trades above $65,000 as Alphabet's bigger AI bill props up the chip trade` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Live markets: Bitcoin trades above $65,000 as Alphabet's bigger AI bill props up the chip trade`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `ai_semiconductors` / publish `2026-07-25` / priority `100.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: 실적·공급망·대표 종목 글로 연결
- reason: 복수 소스 교차 확인 가능 (3개), 섹터/세계 흐름 연결 해설 가능
- evidence score: demand `2100` / fallback `source_snapshot_rank` / format `sector_analysis`
- source_names: CoinDesk RSS, Financial Times YouTube, Reuters Markets via Google News RSS
- sample_headlines:
  - Live markets: Bitcoin trades above $65,000 as Alphabet's bigger AI bill props up the chip trade
...
- recent_evidence:
  ...
  - CoinDesk RSS | 2026-07-23T09:03:33+00:00 | Live markets: Bitcoin trades above $65,000 as Alphabet's bigger AI bill props up the chip trade
  - MarketWatch Breaking News | 2026-07-23T08:36:00+00:00 | Texas Instruments shares are sliding, and its rival is doing even worse. What’s going on in the world of analog semiconductors.
  - Reuters Markets via Google News RSS | 2026-07-23T04:58:21+00:00 | EXCLUSIVE: Intel, AMD sign long-term server CPU deals with Chinese clients as prices surge, sources say - Reuters
- image_slots:
...
- 주요 참고 소스: CoinDesk RSS, Financial Times YouTube, Reuters Markets via Google News RSS
