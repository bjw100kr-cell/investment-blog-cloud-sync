...
- keyword `bitcoin` / publish `2026-07-18` / priority `124.0`
...
- recent_evidence:
  - Cointelegraph | 2026-07-17T07:23:02+00:00 | Bitcoin ETFs add $368M in three-day buying streak
  - Cointelegraph | 2026-07-17T05:54:04+00:00 | Ordinals advocate Leonidas proposes new Bitcoin client: ‘$DOG Mode’
  - CoinDesk RSS | 2026-07-17T05:32:00+00:00 | Bitcoin’s anti-spam fight gets a 'DOG Mode' reply
  - CoinDesk RSS | 2026-07-17T04:10:09+00:00 | Bitcoin under $63,000 after new U.S. strike on Iran. Trump's China comment adds to uncertainty
- image_slots:
...
2026년 7월 17일 기준, 이 이슈를 그냥 뉴스 하나로 넘기기엔 아깝습니다.
...
예를 들어 `Bitcoin’s anti-spam fight gets a 'DOG Mode' reply` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Bitcoin’s anti-spam fight gets a 'DOG Mode' reply`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- keyword `ai_semiconductors` / publish `2026-07-19` / priority `118.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
- intent: 당일 이슈가 내 투자에 어떤 영향을 주는지 빠르게 이해하고 싶은 독자
- CTA focus: 실적·공급망·대표 종목 글로 연결
- reason: 복수 소스 교차 확인 가능 (4개), 섹터/세계 흐름 연결 해설 가능
- evidence score: demand `3200` / fallback `source_snapshot_rank` / format `sector_analysis`
- source_names: Financial Times Home, Financial Times World, Financial Times YouTube, Reuters Markets via Google News RSS
- sample_headlines:
  - Chinese AI start-up Moonshot launches model challenging Anthropic’s lead
  - Stocks sink as chip rout deepens, oil set for weekly gain - Reuters
  - Trading Day: Sinking chips - Reuters
  - Wall Street ends lower as chip weakness offsets solid earnings, economic data - Reuters
- recent_evidence:
  - Financial Times YouTube | 33K views | Silicon shadows: inside the black market for AI chips | FT Film
  - Financial Times World | 2026-07-17T05:35:37+00:00 | Chip and memory stocks slide in fresh bout of Wall Street tumult
  - Reuters Markets via Google News RSS | 2026-07-17T01:16:00+00:00 | Stocks sink as chip rout deepens, oil set for weekly gain - Reuters
  - Financial Times Home | 2026-07-17T00:58:59+00:00 | Chinese AI start-up Moonshot launches model challenging Anthropic’s lead
- image_slots:
...
예를 들어 `Chinese AI start-up Moonshot launches model challenging Anthropic’s lead` 같은 제목은 출발점일 뿐입니다. 중요한 건 이 뉴스가 실제로 어떤 자산을 먼저 움직였는지입니다.

## 본문

## 1. 지금 무슨 일이 있었나

이번 글의 출발점은 `Chinese AI start-up Moonshot launches model challenging Anthropic’s lead`입니다. 다만 제목만 읽고 끝내면 가장 중요한 부분을 놓치기 쉽습니다.
...
- 주요 참고 소스: Financial Times Home, Financial Times World, Financial Times YouTube, Reuters Markets via Google News RSS
...
- keyword `fomc` / publish `2026-07-21` / priority `117.0`
- review `approve` score `100` / quality `pass` / ready_now `True`
