...
- `1` `fomc`: FOMC 이후 시장 해설 / 목표 당일 검색/소셜 유입 최대화 / CTA 환율·금리·미국증시 evergreen 글로 연결
- `2` `bitcoin`: 비트코인 핵심 흐름 해설 / 목표 메인 이슈 보완 유입 확보 / CTA ETF·규제·초보 가이드 글로 연결
- `3` `cpi`: CPI 발표 이후 시장 해설 / 목표 누적 검색 유입과 장기 페이지뷰 확보 / CTA 환율·금리·미국증시 evergreen 글로 연결

## 다음 액션

- publishing_engine: Blogger 업로드 자격값을 연결해서 draft 업로드를 자동 검증합니다.
