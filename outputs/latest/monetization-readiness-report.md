...
- `2` `ai_semiconductors`: AI 반도체 주가를 볼 때 실적보다 먼저 확인할 3가지 / 목표 페이지뷰와 체류시간 균형 확보 / CTA 실적·공급망·대표 종목 글로 연결
- `3` `tariffs_trade`: 관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 / 목표 페이지뷰와 체류시간 균형 확보 / CTA 실적·공급망·대표 종목 글로 연결
