...
운영자가 매일 가장 먼저 열면 되는 단일 시작 화면 요약입니다.

## Publish Safety Promise

- 1단계: 제가 먼저 `user-review-checkpoint`와 검토 보드로 초안과 미리보기를 보여드립니다.
- 2단계: 사용자가 확인한 keyword만 업로드 후보가 됩니다.
...
- link: `file:///home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/user-review-checkpoint.html`
- one-command after approval: `python3 /home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/scripts/run_user_approval_reply_flow.py --reply "treasury_yields 글 먼저 진행" --apply`
- why: 지금은 shortlist 글 초안과 미리보기를 먼저 읽고, 괜찮은 글만 사용자 최종 확인으로 넘기는 단계입니다. 확인 전에는 실제 업로드가 계속 차단됩니다.

## Main Links

- review shortlist: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/user-review-shortlist.md`
...
- crypto market signal: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/crypto-market-signal.md`
...
- runbook: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/start-here-runbook.md`
- launch bundle: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/launch-bundle-report.md`
- cross platform publish pack: `/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/cross-platform-publish-pack.md`

## Manual Publish Pattern

- 네이버 블로그 (수동) (`https://blog.naver.com`)
...
- 티스토리 (수동) (`https://www.tistory.com/manage`)
...
- OpenAI 키는 선택 사항입니다. 지금도 fallback 초안으로 발행 루프를 검증할 수 있습니다.
- WordPress는 2차 확장 채널입니다. Blogger 루프를 먼저 검증한 뒤 붙이면 됩니다.

## User Confirmation Commands

- single: `python3 /home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/scripts/set_review_approvals.py --keywords treasury_yields`
- batch: `python3 /home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/scripts/set_review_approvals.py --keywords treasury_yields bitcoin`
- reply preview: `python3 /home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/scripts/run_user_approval_reply_flow.py --reply "treasury_yields 글 먼저 진행"`
- reply apply: `python3 /home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/scripts/run_user_approval_reply_flow.py --reply "treasury_yields 글 먼저 진행" --apply`
