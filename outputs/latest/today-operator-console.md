...
- `FOMC 이후 시장, 주식과 코인이 같이 흔들리는 이유와 확인할 3가지` / keyword `fomc` / verdict `approve` / publish `2026-07-08`
- `비트코인 가격보다 먼저 봐야 할 것: ETF 자금, 달러, 규제 체크포인트` / keyword `bitcoin` / verdict `approve` / publish `2026-07-09`
- `AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담` / keyword `ai_growth_stocks` / verdict `approve` / publish `2026-07-10`
