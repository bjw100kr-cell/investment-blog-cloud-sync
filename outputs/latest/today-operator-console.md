...
- `미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유` / keyword `treasury_yields` / verdict `approve` / publish `2026-08-08`
- `비트코인 가격보다 먼저 봐야 할 것: ETF 자금, 달러, 규제 체크포인트` / keyword `bitcoin` / verdict `approve` / publish `2026-08-09`
- `미국 증시 지수 흐름: 나스닥, 금리, 빅테크 실적을 같이 봐야 하는 이유` / keyword `us_index_flow` / verdict `approve` / publish `2026-08-10`
...
- `treasury_yields` 예상 `81`명: 미국채 금리 상승이 나스닥과 코인에 부담이 되는 이유
- `us_index_flow` 예상 `61`명: 미국 증시 지수 흐름: 나스닥, 금리, 빅테크 실적을 같이 봐야 하는 이유
- actual_verified: `0`
