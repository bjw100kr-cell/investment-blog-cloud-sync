...
- `FOMC 이후 시장 해설` / keyword `fomc` / verdict `approve` / publish `2026-06-30`
- `비트코인 핵심 흐름 해설` / keyword `bitcoin` / verdict `approve` / publish `2026-07-01`
- `미국 증시 지수 흐름 해설` / keyword `us_index_flow` / verdict `approve` / publish `2026-07-02`
...
- `us_index_flow` 예상 `90`명: 미국 증시 지수 흐름 해설
- `china` 예상 `55`명: 중국 변수와 시장 영향 해설
...
- `main_post` / `FOMC 이후 시장 해설` / 페이지뷰와 체류시간 균형 확보
- `seo_followup` / `FOMC 이후 시장이 주식과 코인에 미치는 영향` / 검색 유입 누적과 첫 방문 독자 확보
- `next_slot` / `비트코인 핵심 흐름 해설` / 페이지뷰와 체류시간 균형 확보
