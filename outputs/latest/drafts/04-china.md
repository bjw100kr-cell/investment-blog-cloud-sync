...
여기서 먼저 봐야 할 건 `Investors dig into India's stock market as China flounders, discount risks - Reuters` 같은 제목 자체보다, 그 발표가 자금 흐름에 어떤 해석을 붙였는지입니다.

## 본문

## 1. 왜 지금 이 이슈가 중요한가

이 파트가 중요한 이유는 복수 소스 교차 확인 가능 (3개), 섹터/세계 흐름 연결 해설 가능라는 점입니다. 해외 주요 매체 보도, 유튜브 해설에서 같은 성격의 움직임이 반복되면 소음일 가능성보다 흐름이 붙어 있을 확률이 더 높아집니다.
...
실제 확인된 정보 중 하나는 `Investors dig into India's stock market as China flounders, discount risks - Reuters` 입니다. 여기서 먼저 봐야 할 건 제목 자체보다 발표 시점, 숫자, 그리고 반응 축이 어떻게 읽히는지입니다. 핵심 해석 포인트는 이 숫자가 시장 기대를 얼마나 바꾸는지입니다.
