...
```json
{
  "keyword": "seo_ai_semiconductors_4",
  "source_keyword": "ai_semiconductors",
  "recommended_title": "AI·반도체 섹터 흐름 관련 대표 종목 한눈에 보기",
  "alternate_titles": [
    "AI·반도체 섹터 흐름 관련 대표 종목 한눈에 보기: 초보 투자자 기준으로 다시 보기",
    "AI·반도체 섹터 흐름 관련 대표 종목 한눈에 보기: 지금 읽어야 하는 이유"
  ],
  "summary_angle": "AI·반도체 섹터 흐름 해설에서 이어지는 후속 글로, 섹터 뉴스는 봤지만 실제 어떤 기업을 같이 봐야 하는지 알고 싶은 독자",
  "outline": [
    "왜 이 섹터를 따로 봐야 하나",
    "대표 기업과 지수/ETF 먼저 정리",
    "실적과 공급망에서 핵심 포인트 보기",
  ...
  "internal_link_plan": {
    "primary": "/Users/bjw100kr/Documents/Codex/2026-06-25/https-youtu-be-bec7hkseki-si-ehsln/work/investment-blog-cloud-sync/outputs/latest/publish-ready/02-ai-반도체-섹터-흐름-해설.html",
    "secondary": [
