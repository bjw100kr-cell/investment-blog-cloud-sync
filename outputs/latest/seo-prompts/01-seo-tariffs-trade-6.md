...
```json
{
  ...
  "alternate_titles": [
    "관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 관련 대표 종목 한눈에 보기: 초보 투자자 기준으로 다시 보기",
    "관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 관련 대표 종목 한눈에 보기: 지금 읽어야 하는 이유"
  ],
  "summary_angle": "관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기에서 이어지는 후속 글로, 섹터 뉴스는 봤지만 실제 어떤 기업을 같이 봐야 하는지 알고 싶은 독자",
  "outline": [
    "왜 이 섹터를 따로 봐야 하나",
    "대표 기업과 지수/ETF 먼저 정리",
    "실적과 공급망에서 핵심 포인트 보기",
  ...
  "reference_takeaways": [
    ...
    "수익화 목표: 섹터형 검색 유입 누적",
    "검색어 후보: 관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 관련 대표 종목 한눈에 보기",
