...
```json
{
  ...
  "recommended_title": "비트코인 현물 ETF 자금 유입: 지금 투자자가 확인할 체크포인트 5가지",
  "alternate_titles": [
    "비트코인 현물 ETF 자금 유입: 지금 투자자가 확인할 체크포인트 5가지: 초보 투자자 기준으로 다시 보기",
    "비트코인 현물 ETF 자금 유입: 지금 투자자가 확인할 체크포인트 5가지: 지금 읽어야 하는 이유"
  ],
  "summary_angle": "비트코인 현물 ETF 자금 유입에서 이어지는 후속 글로, `비트코인 현물 ETF 자금 유입`를 검색한 독자가 시장 영향과 확인 지표를 빠르게 이해하려는 의도",
  "outline": [
  ...
  "reference_takeaways": [
    ...
    "검색어 후보: 비트코인 현물 ETF 자금 유입, 이더리움 ETF 승인 영향, 코인 ETF란, ETF 자금 유출 비트코인 영향",
