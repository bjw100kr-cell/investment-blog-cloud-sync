...
```json
{
  ...
  "recommended_title": "관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 공급망 정리: 누가 수혜를 보나",
  "alternate_titles": [
    "관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 공급망 정리: 누가 수혜를 보나: 초보 투자자 기준으로 다시 보기",
    "관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 공급망 정리: 누가 수혜를 보나: 지금 읽어야 하는 이유"
  ],
  "summary_angle": "관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기에서 이어지는 후속 글로, 테마가 실제 공급망과 실적에 어떻게 연결되는지 알고 싶은 독자",
  "outline": [
  ...
  "reference_takeaways": [
    ...
    "검색어 후보: 관세와 무역 갈등이 증시에 미치는 영향: 환율과 공급망까지 보기 공급망 정리: 누가 수혜를 보나",
  ...
  "internal_link_plan": {
    "primary": "/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/04-관세와-무역-갈등이-증시에-미치는-영향-환율과-공급망까지-보기.html",
    "secondary": [
