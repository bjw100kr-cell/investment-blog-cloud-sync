...
```json
{
  "keyword": "seo_oil_12",
  "source_keyword": "oil",
  "recommended_title": "국제유가 전망: 지금 투자자가 확인할 체크포인트 5가지",
  "alternate_titles": [
    "국제유가 전망: 지금 투자자가 확인할 체크포인트 5가지: 초보 투자자 기준으로 다시 보기",
    "국제유가 전망: 지금 투자자가 확인할 체크포인트 5가지: 지금 읽어야 하는 이유"
  ],
  "summary_angle": "국제유가 전망에서 이어지는 후속 글로, `국제유가 전망`를 검색한 독자가 시장 영향과 확인 지표를 빠르게 이해하려는 의도",
  "outline": [
  ...
  "reference_takeaways": [
    ...
    "검색어 후보: 국제유가 전망, 유가 상승 주식 영향, WTI 유가 보는법, 원유 가격 인플레이션 영향",
