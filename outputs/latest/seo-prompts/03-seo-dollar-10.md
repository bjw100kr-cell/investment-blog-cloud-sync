...
```json
{
  ...
  "recommended_title": "달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법 초보자 가이드: 용어부터 시장 반응까지",
  "alternate_titles": [
    "달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법 초보자 가이드: 용어부터 시장 반응까지: 초보 투자자 기준으로 다시 보기",
    "달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법 초보자 가이드: 용어부터 시장 반응까지: 지금 읽어야 하는 이유"
  ],
  "summary_angle": "달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법에서 이어지는 후속 글로, 기초 개념을 처음부터 이해하고 싶은 초보 독자",
  "outline": [
    "먼저 이 개념을 왜 알아야 하나",
    "핵심 구조를 가장 쉽게 풀어보기",
  ...
  "reference_takeaways": [
    ...
    "검색어 후보: 달러 강세가 주식과 비트코인에 주는 영향: 환율부터 보는 법 초보자 가이드: 용어부터 시장 반응까지",
  ...
  "internal_link_plan": {
    "primary": "/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/04-달러-강세가-주식과-비트코인에-주는-영향-환율부터-보는-법.html",
    "secondary": [
