...
```json
{
  ...
  "recommended_title": "AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담 공급망 정리: 누가 수혜를 보나",
  "alternate_titles": [
    "AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담 공급망 정리: 누가 수혜를 보나: 초보 투자자 기준으로 다시 보기",
    "AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담 공급망 정리: 누가 수혜를 보나: 지금 읽어야 하는 이유"
  ],
  "summary_angle": "AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담에서 이어지는 후속 글로, 테마가 실제 공급망과 실적에 어떻게 연결되는지 알고 싶은 독자",
  "outline": [
  ...
  "reference_takeaways": [
    ...
    "검색어 후보: AI 성장주를 볼 때 놓치기 쉬운 리스크: 매출 성장과 금리 부담 공급망 정리: 누가 수혜를 보나",
