...
```json
{
  ...
  "recommended_title": "AI·반도체 섹터 흐름 공급망 정리: 누가 수혜를 보나",
  "alternate_titles": [
    "AI·반도체 섹터 흐름 공급망 정리: 누가 수혜를 보나: 초보 투자자 기준으로 다시 보기",
    "AI·반도체 섹터 흐름 공급망 정리: 누가 수혜를 보나: 지금 읽어야 하는 이유"
  ],
  "summary_angle": "AI·반도체 섹터 흐름 해설에서 이어지는 후속 글로, 테마가 실제 공급망과 실적에 어떻게 연결되는지 알고 싶은 독자",
  "outline": [
