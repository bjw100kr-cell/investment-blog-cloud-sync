...
```json
{
  "keyword": "seo_cpi_9",
  "source_keyword": "cpi",
  "recommended_title": "CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유가 주식과 코인에 미치는 영향",
  "alternate_titles": [
    "CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유가 주식과 코인에 미치는 영향: 초보 투자자 기준으로 다시 보기",
    "CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유가 주식과 코인에 미치는 영향: 지금 읽어야 하는 이유"
  ],
  "summary_angle": "CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유에서 이어지는 후속 글로, 뉴스를 봤지만 내 투자에 어떻게 연결되는지 쉽게 이해하고 싶은 독자",
  "outline": [
    "먼저 이 개념을 왜 알아야 하나",
    "핵심 구조를 가장 쉽게 풀어보기",
  ...
  "reference_takeaways": [
    ...
    "검색어 후보: CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유가 주식과 코인에 미치는 영향",
