...
```json
{
  "keyword": "seo_fomc_8",
  "source_keyword": "fomc",
  "recommended_title": "FOMC 일정: 지금 투자자가 확인할 체크포인트 5가지",
  "alternate_titles": [
    "FOMC 일정: 지금 투자자가 확인할 체크포인트 5가지: 초보 투자자 기준으로 다시 보기",
    "FOMC 일정: 지금 투자자가 확인할 체크포인트 5가지: 지금 읽어야 하는 이유"
  ],
  "summary_angle": "FOMC 일정에서 이어지는 후속 글로, `FOMC 일정`를 검색한 독자가 시장 영향과 확인 지표를 빠르게 이해하려는 의도",
  "outline": [
  ...
  "reference_takeaways": [
    ...
    "검색어 후보: FOMC 일정, FOMC 발표 시간, FOMC 이후 주식 영향, 연준 금리 발표 비트코인 영향",
