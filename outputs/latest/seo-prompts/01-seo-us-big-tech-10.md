...
```json
{
  ...
  "recommended_title": "미국 빅테크 주식: 지금 투자자가 확인할 체크포인트 5가지",
  "alternate_titles": [
    "미국 빅테크 주식: 지금 투자자가 확인할 체크포인트 5가지: 초보 투자자 기준으로 다시 보기",
    "미국 빅테크 주식: 지금 투자자가 확인할 체크포인트 5가지: 지금 읽어야 하는 이유"
  ],
  "summary_angle": "미국 빅테크 주식에서 이어지는 후속 글로, `미국 빅테크 주식`를 검색한 독자가 시장 영향과 확인 지표를 빠르게 이해하려는 의도",
  "outline": [
  ...
  "reference_takeaways": [
    ...
    "검색어 후보: 미국 빅테크 주식, 애플 주가 영향, 테슬라 주가 전망, 마이크로소프트 AI 투자",
