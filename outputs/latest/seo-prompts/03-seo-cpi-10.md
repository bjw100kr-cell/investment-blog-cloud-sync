...
```json
{
  "keyword": "seo_cpi_10",
  "source_keyword": "cpi",
  "recommended_title": "CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유에서 다음으로 봐야 할 체크포인트 5가지",
  "alternate_titles": [
    "CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유에서 다음으로 봐야 할 체크포인트 5가지: 초보 투자자 기준으로 다시 보기",
    "CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유에서 다음으로 봐야 할 체크포인트 5가지: 지금 읽어야 하는 이유"
  ],
  "summary_angle": "CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유에서 이어지는 후속 글로, 발표 이후 다음 일정과 후속 확인 포인트를 빠르게 정리하고 싶은 독자",
  "outline": [
  ...
  "reference_takeaways": [
    ...
    "검색어 후보: CPI 발표 후 금리와 나스닥, 비트코인이 같이 움직이는 이유에서 다음으로 봐야 할 체크포인트 5가지",
  ...
  "internal_link_plan": {
    "primary": "/home/runner/work/investment-blog-cloud-sync/investment-blog-cloud-sync/outputs/latest/publish-ready/04-cpi-발표-후-금리와-나스닥-비트코인이-같이-움직이는-이유.html",
    "secondary": [
