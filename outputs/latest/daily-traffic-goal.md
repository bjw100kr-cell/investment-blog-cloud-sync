...
2. `bitcoin` 비트코인 가격보다 먼저 봐야 할 것: ETF 자금, 달러, 규제 체크포인트 / 예상 `91`명 / 수요 `3400` / 품질 `pass`
   - action: 코인 시장 신호와 ETF/규제 후속 글을 내부링크로 묶어 발행

## 병목

- 상위 4개 글 예상 합계가 186명으로 목표보다 14명 부족합니다.
...
- `bitcoin` lane `crypto` / 예상 `91`명 / ready `True` / quality `pass`
  - crypto signal: BTCUSDT 24h change 3.95%; Fear/Greed 22: Extreme Fear zone
