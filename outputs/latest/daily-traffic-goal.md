...
3. `us_big_tech` 미국 빅테크 주가가 흔들릴 때 확인할 것: 실적, 금리, AI 투자 / 예상 `77`명 / 수요 `2200` / 품질 `pass`
   - action: 대표 종목/실적/지수 흐름 후속 글로 페이지뷰 확장
4. `china` 중국 변수와 시장 영향: 환율, 경기부양, 원자재를 같이 봐야 하는 이유 / 예상 `58`명 / 수요 `700` / 품질 `pass`
...
- `us_big_tech` lane `us-stocks` / 예상 `77`명 / ready `True` / quality `pass`
