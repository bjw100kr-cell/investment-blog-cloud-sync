...
1. `bitcoin` 비트코인 가격보다 먼저 봐야 할 것: ETF 자금, 달러, 규제 체크포인트 / 예상 `95`명 / 수요 `5700` / 품질 `pass`
...
3. `us_big_tech` 미국 빅테크 주가가 흔들릴 때 확인할 것: 실적, 금리, AI 투자 / 예상 `80`명 / 수요 `2300` / 품질 `pass`
...
- `us_big_tech` lane `us-stocks` / 예상 `80`명 / ready `True` / quality `pass`
